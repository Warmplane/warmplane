class z{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],capabilities:[],approvals:[],auditEvents:[],auditStats:null,auditVerification:null,selectedCapabilityId:null,activeTab:"overview",eventLogs:[],executionResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,o,r){let a=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:o,latency:r},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:a})}}var l=new z;class O{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(){return(await fetch(`${this.baseUrl}/v1/capabilities`)).json()}async callCapability(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),r=performance.now()-t,i=await o.json();return{status:o.status,durationMs:r,data:i}}async batchCallCapabilities(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({steps:e})}),r=performance.now()-t,i=await o.json();return{status:o.status,durationMs:r,data:i}}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:o})})).json()}async rejectTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:o})})).json()}async updateAlias(e,t,o){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:o})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type)t.set("event_type",e.event_type);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset)t.set("offset",String(e.offset));let o=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${o?`?${o}`:""}`)).json()}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}}var v=new O;function j(){let e=l.getState(),t=e.config.mcpServers||{},o=Object.keys(t),r=o.length,i="";if(o.length===0)i=`
    ...
    `;else i=o.map((y)=>{let A=t[y],K=A.command?"stdio":"http / sse",T=A.command?`${A.command} ${(A.args||[]).join(" ")}`:A.url,P=e.serverStatuses[y]||{status:"connected",protocol_version:"2026-07-28"};return`
        <div class="bento-card">
          ...
          <div style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--text-dim); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin-bottom: 12px;" title="${S(T||"")}">
            ${S(T||"")}
          </div>
          <div style="display: flex; justify-content: space-between; font-size: 11px; color: var(--text-muted); border-top: 1px solid var(--border); padding-top: 8px;">
            <span>Status: <strong style="color: var(--green-400);">${P.status}</strong></span>
  ...
  `:e.eventLogs.map((y)=>`
    <div class="feed-row" style="grid-template-columns: 80px 100px 1fr 100px 80px;">
      <span style="color: var(--text-dim);">${S(y.time)}</span>
      <span style="color: var(--cyan-400); font-weight: 600;">${S(y.method)}</span>
      <span style="color: var(--text-main); font-family: var(--ff-mono);">${S(y.target)}</span>
      <span style="color: var(--green-400);">${S(y.status)}</span>
      <span style="color: var(--amber-300); text-align: right;">${S(y.latency)}</span>
    </div>
  `).join(""),s=e.metrics,n=s.totalCatalogRequests,d=s.totalEtagHits,u=n>0?`${(d/n*100).toFixed(1)}%`:"0.0%",p=n>0?`${d} of ${n} requests served via HTTP 304`:"Waiting for client requests",c=s.totalToolCalls,f=c>0?`${(s.totalToolDurationUs/c/1000).toFixed(1)}ms`:"0.0ms",_=c>0?`${c} tool executions processed`:"Local worker task queues warm",w=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,U=w>0?`${w*18}B / call`:"0B",M=w>0?`${w} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size";return`
    <div class="bento-grid">
      <div class="bento-card col-3">
        <div class="stat-label">Token Savings Rate</div>
        <div class="stat-value" style="color: var(--amber-300);">${U}</div>
  ...
  `}function S(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function L(){let e=l.getState(),t=e.config.mcpServers||{},o=Object.keys(t),r="";if(o.length===0)r=`
      <div style="padding: 40px; text-align: center; color: var(--text-dim); background: var(--surface-card); border-radius: var(--radius-md); border: 1px dashed var(--border);">
        <div style="font-size: 15px; color: var(--text-main); font-weight: 600; margin-bottom: 8px;">No Servers Configured in ${k(e.configPath)}</div>
    ...
    `;else r=o.map((i)=>{let a=t[i],s=a.command?"stdio":"http / sse",n=a.command?`${a.command} ${(a.args||[]).join(" ")}`:a.url,d=e.serverStatuses[i]||{status:"connected",protocol_version:"2026-07-28"},u=a.env?Object.keys(a.env).map((w)=>`${w}=***`).join(", "):"None",p=(e.circuitBreakers||[]).find((w)=>w.server_id===i),c='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(p){if(p.state==="open")c=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${p.consecutive_failures} failures)</span>`;else if(p.state==="half_open")c=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${p.consecutive_successes} probe)</span>`}let f=a.resilience||e.config.resilience,_=f?`FT: ${f.failureThreshold||3} · Cooldown: ${(f.cooldownMs||30000)/1000}s · AutoRestart: ${f.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience";return`
        <div class="bento-card" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
          <div>
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
              <span style="width: 8px; height: 8px; border-radius: 50%; background: var(--green-400); display: inline-block;"></span>
              <span style="font-size: 15px; font-weight: 700; color: var(--text-main);">${k(i)}</span>
            ...
            <div style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted); margin-top: 4px;">
              ${a.command?"Command: ":"URL: "}<code>${k(n||"")}</code>
            </div>
            <div style="display: flex; gap: 14px; font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim); margin-top: 4px;">
              <span>\uD83D\uDEE1️ ${k(_)}</span>
              ${a.env&&Object.keys(a.env).length>0?`<span>Env: ${k(u)}</span>`:""}
            </div>
          </div>
          <div style="display: flex; gap: 8px;">
            <button class="btn btn-danger" onclick="window.app.deleteServer('${k(i)}')">Remove</button>
          </div>
        </div>
      `}).join("");return`
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 18px;">
      <div>
        ...
        <div style="font-size: 11px; color: var(--text-dim);">Active configuration file: <code>${k(e.configPath)}</code></div>
      </div>
      <div style="display: flex; gap: 8px;">
    ...
    ${r}
  `}function k(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function R(){let e=l.getState(),t=e.capabilities,o=e.selectedCapabilityId||(t.length>0?t[0].id:null),r=t.find((s)=>s.id===o),i="";if(t.length===0)i=`
    ...
    `;else i=t.map((s)=>{return`
        <div class="cap-item ${s.id===o?"active":""}" onclick="window.app.selectCapability('${x(s.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${x(s.id)}</span>
            <span style="font-size: 10px; color: var(--green-400);">${x(s.mode||"read")}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">server: ${x(s.server||"local")}</div>
        </div>
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
          ...
          <div style="padding: 16px; border-right: 1px solid var(--border); overflow-y: auto;">
            ...
            <textarea class="form-textarea" rows="7" id="pg-args-input">${x(a)}</textarea>
  ...
  `}function x(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function I(e){let t=e.approvals.filter((a)=>a.status==="pending"),o=e.approvals.filter((a)=>a.status!=="pending"),r=t.length===0?`
  ...
  `:t.map((a)=>`
    <div class="bento-card" style="border: 1px solid rgba(245, 158, 11, 0.35); background: var(--surface-card); margin-bottom: 14px; padding: 18px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
        <div>
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted);">${m(a.id)}</span>
          </div>
          <div style="margin-top: 6px; display: flex; align-items: center; gap: 8px;">
            <span style="font-size: 14.5px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${m(a.capability_id)}</span>
            <span style="font-size: 11px; color: var(--text-dim);">via <span style="color: var(--cyan-400); font-family: var(--ff-mono);">${m(a.server_id)}</span></span>
          </div>
        </div>

        <div style="text-align: right; font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim);">
          <div>Created: <span style="color: var(--text-muted);">${new Date(a.created_at*1000).toLocaleTimeString()}</span></div>
          <div style="color: var(--amber-400); margin-top: 2px;">Expires: ${new Date(a.expires_at*1000).toLocaleTimeString()}</div>
        </div>
      </div>

      <!-- Caller Context -->
      ${a.context||a.request_id?`
        <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; font-family: var(--ff-mono); font-size: 11px; display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px; color: var(--text-muted);">
          ${a.request_id?`<div><span style="color: var(--text-dim);">Request:</span> <span style="color: var(--text-main);">${m(a.request_id)}</span></div>`:""}
          ${a.context?.actor_id?`<div><span style="color: var(--text-dim);">Actor:</span> <span style="color: var(--cyan-400);">${m(a.context.actor_id)}</span></div>`:""}
          ${a.context?.operation_id?`<div><span style="color: var(--text-dim);">Operation:</span> <span style="color: var(--text-main);">${m(a.context.operation_id)}</span></div>`:""}
          ${a.context?.work_item_id?`<div><span style="color: var(--text-dim);">Work Item:</span> <span style="color: var(--text-main);">${m(a.context.work_item_id)}</span></div>`:""}
        </div>
      `:""}
      ...
      <div style="margin-bottom: 14px;">
        ...
        <textarea id="appr-args-${a.id}" class="form-textarea" rows="4" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px; line-height: 1.4;">${m(JSON.stringify(a.sanitized_args,null,2))}</textarea>
      </div>

      <!-- Action Footer -->
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 12px;">
        <div style="display: flex; align-items: center; gap: 8px;">
          <input id="appr-operator-${a.id}" type="text" class="form-input" placeholder="Operator ID" value="security-operator" style="width: 200px; padding: 5px 10px; font-size: 11px;">
        </div>

        <div style="display: flex; align-items: center; gap: 8px;">
          <button class="btn btn-danger" onclick="window.app.promptReject('${m(a.id)}')">
            ✕ Reject
          </button>
          <button class="btn btn-primary" onclick="window.app.submitApproval('${m(a.id)}')">
            ✓ Approve &amp; Execute
          </button>
        </div>
      </div>
        ...
        ${o.map((a)=>`
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 14px; border-bottom: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 10px;">
              <span class="brand-badge" style="${a.status==="approved"?"background: rgba(52, 211, 153, 0.12); color: var(--green-400); border-color: rgba(52, 211, 153, 0.3);":a.status==="rejected"?"background: rgba(248, 113, 113, 0.12); color: var(--red-400); border-color: rgba(248, 113, 113, 0.3);":"background: var(--surface-hover); color: var(--text-dim);"}">
                ${a.status.toUpperCase()}
              </span>
              <span style="font-weight: 600; color: var(--text-main);">${m(a.capability_id)}</span>
              <span style="color: var(--text-dim); font-size: 10.5px;">${m(a.id)}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 16px; color: var(--text-dim);">
              ${a.operator?`<span>Operator: <span style="color: var(--text-muted);">${m(a.operator)}</span></span>`:""}
              ${a.reason?`<span style="color: var(--red-400); font-style: italic;">"${m(a.reason)}"</span>`:""}
  ...
  `;return`
    ...
    ${i}
  `}function m(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(){let e=l.getState(),t=e.auditEvents||[],o=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},r=e.auditVerification,i=r?r.is_valid?`
  ...
  `,a="";if(t.length===0)a=`
    ...
    `;else a=t.map((s)=>{let n=new Date(Math.floor(s.timestamp_ns/1e6)).toLocaleString(),d='<span class="badge" style="background: rgba(34, 197, 94, 0.15); color: var(--green-400); font-weight: 600;">SUCCESS</span>';if(s.status==="denied")d='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">DENIED</span>';else if(s.status==="intercepted")d='<span class="badge" style="background: rgba(234, 179, 8, 0.15); color: var(--amber-300); font-weight: 600;">HITL INTERCEPT</span>';else if(s.status==="failed")d='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">FAILED</span>';let u=s.sanitized_args?JSON.stringify(s.sanitized_args):"-",p=s.actor_id||s.operator_id||"anonymous",c=s.capability_id||s.event_type,f=s.execution_latency_us?`${(s.execution_latency_us/1000).toFixed(1)}ms`:"-";return`
        <div class="bento-card" style="margin-bottom: 12px; padding: 16px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span style="font-family: var(--ff-mono); font-size: 11px; font-weight: 700; color: var(--text-dim);">${h(s.id)}</span>
              ${d}
              <span style="font-size: 12px; font-weight: 600; color: var(--text-main);">${h(c)}</span>
            </div>
            <div style="font-family: var(--ff-mono); font-size: 11px; color: var(--text-muted);">${h(n)}</div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; font-size: 11.5px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 8px;">
            <div><span style="color: var(--text-muted);">Actor:</span> <strong style="color: var(--text-main);">${h(p)}</strong></div>
            <div><span style="color: var(--text-muted);">Trace:</span> <code style="color: var(--cyan-400); font-size: 10.5px;">${h(s.trace_id)}</code></div>
            <div><span style="color: var(--text-muted);">Latency:</span> <span style="color: var(--amber-300);">${f}</span></div>
            <div><span style="color: var(--text-muted);">Type:</span> <span style="color: var(--text-main); font-weight: 500;">${h(s.event_type)}</span></div>
          </div>
          ...
          <div style="font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim); margin-bottom: 8px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
            <span style="color: var(--text-muted);">Args:</span> ${h(u)}
          </div>
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 6px; font-size: 10.5px; font-family: var(--ff-mono); color: var(--text-muted);">
            <div><span style="color: var(--text-dim);">prev_hash:</span> ${h(s.prev_hash.slice(0,16))}...</div>
            <div><span style="color: var(--text-dim);">hash:</span> <span style="color: var(--green-400);">${h(s.hash.slice(0,16))}...</span></div>
          </div>
        </div>
      `}).join("");return`
  ...
  `}function h(e){if(!e)return"";return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function N(){let t=l.getState().config.policy||{},o=t.allow||[],r=t.deny||[],i=t.redact_keys||t.redactKeys||[],a=t.require_approval||t.requireApproval||[],s=o.length===0?`
  ...
  `:o.map((p,c)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--green-400);">✔ ${$(p)}</span>
  ...
  `:r.map((p,c)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--red-400);">✖ ${$(p)}</span>
  ...
  `:a.map((p,c)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--amber-400);">\uD83D\uDEE1️ ${$(p)}</span>
  ...
  `}function $(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function D(){let e=l.getState(),t=e.config,o=Object.entries(t.capabilityAliases||{}),r=Object.entries(t.resourceAliases||{}),i=Object.entries(t.promptAliases||{}),a="";if(o.length===0&&r.length===0&&i.length===0)a=`
      <div style="padding: 24px; text-align: center; color: var(--text-dim);">
        No facade aliases configured in ${b(e.configPath)}. Add short names to prune token payload sizes.
      </div>
    `;else{for(let[s,n]of o)a+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${b(n)}</span>
  ...
  `}function b(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var C=[{id:"github",name:"GitHub",category:"devtools",description:"Explore repositories, issues, pull requests, branches, and commit histories.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-github"],envFields:[{key:"GITHUB_PERSONAL_ACCESS_TOKEN",label:"GitHub Personal Access Token",placeholder:"ghp_...",required:!0,description:"Classic or fine-grained token with repo scope."}]},{id:"git",name:"Git (Local)",category:"devtools",description:"Read local Git repository status, diffs, log histories, and commit changes.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-git","--repository","."],argsPlaceholder:"mcp-server-git --repository /path/to/repo",envFields:[]},{id:"filesystem",name:"Filesystem",category:"devtools",description:"Secure, sandboxed access to local files and directories for AI workflows.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-filesystem","."],argsPlaceholder:"-y @modelcontextprotocol/server-filesystem /allowed/dir1 /allowed/dir2",envFields:[]},{id:"memory",name:"Memory Graph",category:"devtools",description:"Persistent knowledge-graph based memory for multi-turn agent learning.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-memory"],envFields:[]},{id:"chrome-devtools",name:"Chrome DevTools",category:"devtools",description:"Inspect live DOM, execute scripts, read console logs, and capture network traces in Chrome.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-puppeteer"],envFields:[]},{id:"sentry",name:"Sentry",category:"devtools",description:"Query production error events, stack traces, and issue frequencies directly from Sentry.",badge:"uvx / Telemetry",command:"uvx",defaultArgs:["mcp-server-sentry"],envFields:[{key:"SENTRY_AUTH_TOKEN",label:"Sentry Auth Token",placeholder:"sntrys_...",required:!0}]},{id:"playwright",name:"Playwright Browser",category:"browser",description:"Headless / headed browser automation for scraping, form filling, and UI interaction.",badge:"Popular #1 / npx",command:"npx",defaultArgs:["-y","@executeautomation/playwright-mcp-server"],envFields:[]},{id:"puppeteer",name:"Puppeteer",category:"browser",description:"Official browser automation server for web page scraping and screenshot capture.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-puppeteer"],envFields:[]},{id:"brave-search",name:"Brave Search",category:"browser",description:"Real-time privacy-preserving web search and local point-of-interest query engine.",badge:"Official / Search",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-brave-search"],envFields:[{key:"BRAVE_API_KEY",label:"Brave Search API Key",placeholder:"BSA...",required:!0}]},{id:"tavily",name:"Tavily Search",category:"browser",description:"AI-optimized web search engine structured specifically for LLM context injection.",badge:"Community / Stdio",command:"npx",defaultArgs:["-y","@tavily/mcp-server"],envFields:[{key:"TAVILY_API_KEY",label:"Tavily API Key",placeholder:"tvly-...",required:!0}]},{id:"fetch",name:"Fetch / Web Markdown",category:"browser",description:"Download web pages, strip clutter, and convert raw HTML to clean markdown text.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-fetch"],envFields:[]},{id:"postgres",name:"PostgreSQL",category:"database",description:"Read schemas, inspect tables, and execute SQL queries against PostgreSQL databases.",badge:"Official / Database",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-postgres","postgresql://user:pass@localhost:5432/mydb"],argsPlaceholder:"-y @modelcontextprotocol/server-postgres postgresql://user:pass@localhost:5432/dbname",envFields:[]},{id:"sqlite",name:"SQLite",category:"database",description:"Local embedded SQLite query runner and schema inspector.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-sqlite","--db-path","./app.db"],argsPlaceholder:"mcp-server-sqlite --db-path /path/to/database.sqlite",envFields:[]},{id:"supabase",name:"Supabase",category:"database",description:"Query database tables, manage auth policies, and inspect storage in Supabase.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@supabase/mcp-server"],envFields:[{key:"SUPABASE_ACCESS_TOKEN",label:"Supabase Personal Access Token",placeholder:"sbp_...",required:!0},{key:"SUPABASE_PROJECT_REF",label:"Supabase Project Reference ID",placeholder:"abcdefghijklmnop",required:!1}]},{id:"redis",name:"Redis",category:"database",description:"Inspect cached keys, hash sets, lists, TTLs, and pub/sub channels in Redis.",badge:"uvx / Key-Value",command:"uvx",defaultArgs:["mcp-server-redis","--url","redis://localhost:6379"],argsPlaceholder:"mcp-server-redis --url redis://localhost:6379",envFields:[]},{id:"s3",name:"AWS S3 / Cloud Storage",category:"database",description:"Browse S3 buckets, fetch object metadata, and download files from cloud storage.",badge:"uvx / Cloud Storage",command:"uvx",defaultArgs:["mcp-server-s3","--bucket","my-bucket-name"],argsPlaceholder:"mcp-server-s3 --bucket bucket-name --region us-east-1",envFields:[{key:"AWS_ACCESS_KEY_ID",label:"AWS Access Key ID",placeholder:"AKIA...",required:!0},{key:"AWS_SECRET_ACCESS_KEY",label:"AWS Secret Access Key",placeholder:"...",required:!0},{key:"AWS_REGION",label:"AWS Region",placeholder:"us-east-1",required:!1}]},{id:"linear",name:"Linear",category:"productivity",description:"Search, create, and triage Linear issues, cycles, teams, and project roadmaps.",badge:"Productivity / Stdio",command:"npx",defaultArgs:["-y","mcp-linear"],envFields:[{key:"LINEAR_API_KEY",label:"Linear API Key",placeholder:"lin_api_...",required:!0}]},{id:"slack",name:"Slack",category:"productivity",description:"Read channels, post messages, inspect threads, and search team discussions.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-slack"],envFields:[{key:"SLACK_BOT_TOKEN",label:"Slack Bot User Token",placeholder:"xoxb-...",required:!0},{key:"SLACK_TEAM_ID",label:"Slack Team ID",placeholder:"T01234567",required:!0}]},{id:"notion",name:"Notion",category:"productivity",description:"Search Notion workspace pages, read nested blocks, and query database entries.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-notion"],envFields:[{key:"NOTION_API_KEY",label:"Notion Internal Integration Token",placeholder:"secret_...",required:!0}]},{id:"jira",name:"Jira / Atlassian",category:"productivity",description:"Manage Jira issues, search JQL, read sprint statuses, and inspect boards.",badge:"uvx / Atlassian",command:"uvx",defaultArgs:["mcp-server-jira","--url","https://your-domain.atlassian.net","--email","user@example.com"],argsPlaceholder:"mcp-server-jira --url https://org.atlassian.net --email me@org.com",envFields:[{key:"JIRA_API_TOKEN",label:"Atlassian API Token",placeholder:"ATATT3...",required:!0}]},{id:"google-drive",name:"Google Drive",category:"productivity",description:"Search, list, and read documents, spreadsheets, and drive files.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-gdrive"],envFields:[{key:"GOOGLE_APPLICATION_CREDENTIALS",label:"Google Credentials JSON Path",placeholder:"/path/to/credentials.json",required:!0}]},{id:"docker",name:"Docker",category:"cloud",description:"Inspect running containers, tail container logs, list images, and manage compose services.",badge:"uvx / DevOps",command:"uvx",defaultArgs:["mcp-server-docker"],envFields:[]},{id:"kubernetes",name:"Kubernetes (K8s)",category:"cloud",description:"Query cluster pods, services, deployment status, and inspect Kubernetes logs.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-kubernetes"],envFields:[{key:"KUBECONFIG",label:"Kubeconfig File Path (Optional)",placeholder:"~/.kube/config",required:!1}]},{id:"cloudflare",name:"Cloudflare",category:"cloud",description:"Manage Cloudflare Workers, KV namespaces, D1 databases, Vectorize indexes, and DNS.",badge:"Official / Cloudflare",command:"npx",defaultArgs:["-y","@cloudflare/mcp-server-cloudflare"],envFields:[{key:"CLOUDFLARE_API_TOKEN",label:"Cloudflare API Token",placeholder:"...",required:!0},{key:"CLOUDFLARE_ACCOUNT_ID",label:"Cloudflare Account ID",placeholder:"...",required:!0}]},{id:"terraform",name:"Terraform",category:"cloud",description:"Inspect Terraform state files, resource dependency graphs, and plan previews.",badge:"uvx / IaC",command:"uvx",defaultArgs:["mcp-server-terraform"],envFields:[]}];class q{activeTemplateCategory="all";activeTemplateFilter="";selectedTemplate=null;async init(){let e=window.location.port?`:${window.location.port}`:"",t=document.getElementById("daemon-port-label");if(t)t.textContent=`Daemon ${e}`;await this.refreshData(),this.initSSE(),this.render(),l.subscribe(()=>{this.render()})}async refreshData(){try{let[e,t,o,r,i]=await Promise.all([v.getConfig(),v.listCapabilities(),v.listApprovals(),v.listAuditEvents({limit:50}),v.getAuditStats()]);if(e.ok)l.setState({configPath:e.config_path,config:e.config,serverStatuses:e.server_statuses||{},circuitBreakers:e.circuit_breakers||[],metrics:{totalCatalogRequests:e.metrics?.total_catalog_requests||0,totalEtagHits:e.metrics?.total_etag_hits||0,totalToolCalls:e.metrics?.total_tool_calls||0,totalToolDurationUs:e.metrics?.total_tool_duration_us||0}});if(t&&Array.isArray(t.capabilities))l.setState({capabilities:t.capabilities});if(o&&Array.isArray(o.approvals))l.setState({approvals:o.approvals});if(r&&Array.isArray(r.events))l.setState({auditEvents:r.events});if(i&&i.ok)l.setState({auditStats:i})}catch(e){console.error("Failed to fetch daemon state:",e)}}async refreshAuditEvents(){try{let[e,t]=await Promise.all([v.listAuditEvents({limit:50}),v.getAuditStats()]);if(e&&Array.isArray(e.events))l.setState({auditEvents:e.events});if(t&&t.ok)l.setState({auditStats:t})}catch(e){console.error("Failed to refresh audit events:",e)}}async verifyAuditChain(){try{let e=await v.verifyAuditChain();if(e&&e.report)l.setState({auditVerification:e.report})}catch(e){console.error("Failed to verify audit chain:",e)}}async refreshApprovals(){try{let e=await v.listApprovals();if(e&&Array.isArray(e.approvals))l.setState({approvals:e.approvals})}catch(e){console.error("Failed to refresh approvals:",e)}}initSSE(){try{let e=new EventSource("/v1/resources/updates");e.onmessage=(t)=>{l.addEventLog("SSE","/v1/resources/updates","UPDATED","0.1ms"),this.refreshData()}}catch(e){console.warn("SSE connection unavailable")}}switchTab(e){l.setState({activeTab:e}),this.refreshData()}render(){let e=l.getState(),t=document.getElementById("app-main");if(!t)return;let o=e.approvals.filter((s)=>s.status==="pending").length,r=document.getElementById("nav-approvals-badge");if(r)r.textContent=o>0?`${o}`:"",r.style.display=o>0?"inline-block":"none";document.querySelectorAll(".nav-item").forEach((s)=>{if(s.getAttribute("data-tab")===e.activeTab)s.classList.add("active");else s.classList.remove("active")});let i=document.getElementById("top-title"),a={overview:"Overview Cockpit",servers:"Server Hub & Connections",playground:"MCP Capability Playground",approvals:"Human-in-the-Loop Review Queue",audit:"WORM Audit & Compliance Ledger",policy:"Security Governance & Redaction",aliases:"Facade & Alias Studio"};if(i)i.textContent=a[e.activeTab];switch(e.activeTab){case"overview":t.innerHTML=j();break;case"servers":t.innerHTML=L();break;case"playground":t.innerHTML=R();break;case"approvals":t.innerHTML=I(e);break;case"audit":t.innerHTML=E();break;case"policy":t.innerHTML=N();break;case"aliases":t.innerHTML=D();break}}async submitApproval(e){let t=document.getElementById(`appr-operator-${e}`),o=document.getElementById(`appr-args-${e}`),r=t?.value.trim()||"security-operator",i=void 0;if(o&&o.value.trim())try{i=JSON.parse(o.value.trim())}catch{alert("Invalid JSON in arguments editor");return}let a=await v.approveTicket(e,r,i);if(a.ok)await this.refreshApprovals();else alert(`Approval failed: ${a.error||"Unknown error"}`)}async promptReject(e){let t=prompt("Reason for rejection (will be returned to the calling agent):");if(t===null)return;let r=document.getElementById(`appr-operator-${e}`)?.value.trim()||"security-operator",i=await v.rejectTicket(e,r,t);if(i.ok)await this.refreshApprovals();else alert(`Rejection failed: ${i.error||"Unknown error"}`)}selectCapability(e){l.setState({selectedCapabilityId:e})}filterCapabilities(e){let t=e.toLowerCase().trim(),r=l.getState().capabilities.filter((a)=>a.id.toLowerCase().includes(t)||a.summary&&a.summary.toLowerCase().includes(t)||a.server&&a.server.toLowerCase().includes(t)),i=document.getElementById("pg-cap-list");if(i)if(r.length===0)i.innerHTML=`
      ...
      `}).join("")}selectTemplate(e){let t=C.find((s)=>s.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let o=document.getElementById("modal-configure-template");if(o)o.classList.add("active");let r=document.getElementById("cfg-tmpl-title"),i=document.getElementById("cfg-tmpl-desc"),a=document.getElementById("cfg-tmpl-form");if(r)r.textContent=`Configure ${t.name} Server`;if(i)i.textContent=t.description;if(a){let s="";if(t.envFields.length>0)s=`
        ...
        ${s}
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),o=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}let r=o?o.split(/\s+/).filter(Boolean):[],i={},a=document.querySelectorAll(".tmpl-env-input");for(let d of Array.from(a)){let u=d.getAttribute("data-key"),p=d.value.trim(),c=e.envFields.find((f)=>f.key===u);if(c?.required&&!p){alert(`Required field '${c.label}' is missing.`);return}if(u&&p)i[u]=p}let s={command:e.command,args:r};if(Object.keys(i).length>0)s.env=i;let n=await v.upsertServer(t,s);if(n.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${n.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let o=await v.getEcosystemSources();if(o.sources&&o.sources.length>0)t.innerHTML=o.sources.map((r)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await v.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let o=(e||"").trim().toLowerCase();if(o.length<2){t.style.display="none";return}let i=l.getState().capabilities.filter((a)=>a.id.toLowerCase().includes(o)||a.summary&&a.summary.toLowerCase().includes(o)||a.description&&a.description.toLowerCase().includes(o)||a.server&&a.server.toLowerCase().includes(o)).slice(0,8);if(i.length===0){t.style.display="none";return}t.innerHTML=i.map((a)=>`
