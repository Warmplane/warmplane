class N{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],clients:[],capabilities:[],resources:[],prompts:[],catalogEvents:[],tasks:[],selectedTaskId:null,taskFilterStatus:"all",approvals:[],auditEvents:[],auditTotal:0,auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:25,offset:0},auditSelectedEvent:null,auditStats:null,auditVerification:null,selectedCapabilityId:null,selectedResourceId:null,selectedPromptId:null,playgroundMode:"tools",playgroundArgs:{},isExecuting:!1,playgroundAsyncTask:!1,activeRequestId:null,isBatchModalOpen:!1,batchSteps:[{id:"step_1",capability_id:"",argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],activeTab:"overview",activeProfile:null,eventLogs:[],executionResult:null,resourceReadResult:null,promptGetResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,r,n){let a=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:r,latency:n},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:a})}}var l=new N;class D{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/capabilities`,{headers:t})).json()}async listResources(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/resources`,{headers:t})).json()}async readResource(e,t){let r=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let s=await fetch(`${this.baseUrl}/v1/resources/read`,{method:"POST",headers:n,body:JSON.stringify(e)}),a=performance.now()-r,i=await s.json();return{status:s.status,durationMs:a,data:i}}async listPrompts(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/prompts`,{headers:t})).json()}async getPrompt(e,t){let r=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let s=await fetch(`${this.baseUrl}/v1/prompts/get`,{method:"POST",headers:n,body:JSON.stringify(e)}),a=performance.now()-r,i=await s.json();return{status:s.status,durationMs:a,data:i}}async getCatalogEvents(e){let t=e?`?after=${encodeURIComponent(e)}`:"";return(await fetch(`${this.baseUrl}/v1/catalog/events${t}`)).json()}async callCapability(e,t){let r=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let s=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:n,body:JSON.stringify(e)}),a=performance.now()-r,i=await s.json();return{status:s.status,durationMs:a,data:i}}async batchCallCapabilities(e,t){let r=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let s=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:n,body:JSON.stringify({steps:e})}),a=performance.now()-r,i=await s.json();return{status:s.status,durationMs:a,data:i}}async cancelOperation(e){return(await fetch(`${this.baseUrl}/v1/operations/${encodeURIComponent(e)}/cancel`,{method:"POST"})).json()}async completeArgument(e){return(await fetch(`${this.baseUrl}/v1/completion/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async upsertProfile(e,t,r){return(await fetch(`${this.baseUrl}/v1/config/profiles`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,servers:t,description:r})})).json()}async deleteProfile(e){return(await fetch(`${this.baseUrl}/v1/config/profiles/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listTasks(){return(await fetch(`${this.baseUrl}/v1/tasks`)).json()}async getTask(e){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}`)).json()}async updateTask(e,t){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}/update`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({inputResponses:t})})).json()}async cancelTask(e,t){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}/cancel`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:t})})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,r){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:r})})).json()}async rejectTicket(e,t,r){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:r})})).json()}async updateAlias(e,t,r){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:r})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")t.set("server_id",e.server_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")t.set("event_type",e.event_type);if(e?.status&&e.status!=="all")t.set("status",e.status);if(e?.trace_id)t.set("trace_id",e.trace_id);if(e?.request_id)t.set("request_id",e.request_id);if(e?.search)t.set("search",e.search);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset!==void 0)t.set("offset",String(e.offset));let r=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${r?`?${r}`:""}`)).json()}getAuditExportUrl(e,t="csv"){let r=new URLSearchParams;if(r.set("format",t),e?.actor_id)r.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")r.set("server_id",e.server_id);if(e?.capability_id)r.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")r.set("event_type",e.event_type);if(e?.status&&e.status!=="all")r.set("status",e.status);if(e?.trace_id)r.set("trace_id",e.trace_id);if(e?.request_id)r.set("request_id",e.request_id);if(e?.search)r.set("search",e.search);return`${this.baseUrl}/v1/audit/export?${r.toString()}`}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}async getClients(){return(await fetch(`${this.baseUrl}/v1/clients`)).json()}async attachClient(e,t){return(await fetch(`${this.baseUrl}/v1/clients/${encodeURIComponent(e)}/attach`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({profile:t||void 0})})).json()}async detachClient(e){return(await fetch(`${this.baseUrl}/v1/clients/${encodeURIComponent(e)}/detach`,{method:"POST",headers:{"Content-Type":"application/json"}})).json()}}var f=new D;function U(){let e=l.getState(),t=e.config.mcpServers||{},r=Object.keys(t),n=r.length,s="";if(r.length===0)s=`
    ...
    `;else s=r.map((x)=>{let P=t[x],b=P.command?"stdio":"http / sse",L=P.command?`${P.command} ${(P.args||[]).join(" ")}`:P.url,C=e.serverStatuses[x]||{status:"connected",protocol_version:"2026-07-28"},H=C.status==="degraded",q=C.status==="error"||C.status==="disconnected",j=H?"var(--amber-400)":q?"var(--red-400)":"var(--green-400)";return`
        <div class="bento-card col-4" style="background: var(--surface); border: 1px solid var(--border);">
          ...
          <div style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--text-dim); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin-bottom: 12px;" title="${z(L||"")}">
            ${z(L||"")}
          </div>
          <div style="display: flex; justify-content: space-between; font-size: 11px; color: var(--text-muted); border-top: 1px solid var(--border); padding-top: 8px;">
            <span>Status: <strong style="color: ${j};">${z(C.status)}</strong></span>
  ...
  `:e.eventLogs.map((x)=>`
    <div class="feed-row" style="grid-template-columns: 80px 100px 1fr 100px 80px;">
      <span style="color: var(--text-dim);">${z(x.time)}</span>
      <span style="color: var(--cyan-400); font-weight: 600;">${z(x.method)}</span>
      <span style="color: var(--text-main); font-family: var(--ff-mono);">${z(x.target)}</span>
      <span style="color: var(--green-400);">${z(x.status)}</span>
      <span style="color: var(--amber-300); text-align: right;">${z(x.latency)}</span>
    </div>
  `).join(""),i=e.metrics,o=i.totalCatalogRequests,d=i.totalEtagHits,p=o>0?`${(d/o*100).toFixed(1)}%`:"0.0%",g=o>0?`${d} of ${o} requests served via HTTP 304`:"Waiting for client requests",u=i.totalToolCalls,m=u>0?`${(i.totalToolDurationUs/u/1000).toFixed(1)}ms`:"0.0ms",c=u>0?`${u} tool executions processed`:"Local worker task queues warm",h=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,k=h>0?`${h*18}B / call`:"0B",T=h>0?`${h} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size",E=e.tasks||[],I=E.filter((x)=>x.status==="input_required").length,A=E.filter((x)=>x.status==="working"||x.status==="input_required").length;return`
    <div class="bento-grid">
      ...
      <div class="bento-card col-3">
        ...
        <div class="stat-sub">${I>0?"Awaiting Human-in-the-Loop decision":`${E.length} total registered tasks`}</div>
      </div>
      <div class="bento-card col-3">
  ...
  `}function z(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function J(){let e=l.getState(),t=e.config.mcpServers||{},r=Object.keys(t),n="";if(r.length===0)n=`
    ...
    `;else n=r.map((s)=>{let a=t[s],i=a.command?"stdio":"http / sse",o=a.command?`${a.command} ${(a.args||[]).join(" ")}`:a.url,d=e.serverStatuses[s]||{status:"connected",protocol_version:"2026-07-28"},p=a.env?Object.keys(a.env).map((E)=>`${E}=***`).join(", "):"None",g=(e.circuitBreakers||[]).find((E)=>E.server_id===s),u='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(g){if(g.state==="open")u=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${g.consecutive_failures} failures)</span>`;else if(g.state==="half_open")u=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${g.consecutive_successes} probe)</span>`}let m=a.resilience||e.config.resilience,c=m?`FT: ${m.failureThreshold||3} · Cooldown: ${(m.cooldownMs||30000)/1000}s · AutoRestart: ${m.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience",h=d.status==="degraded",k=d.status==="error"||d.status==="disconnected",T=h?"var(--amber-400)":k?"var(--red-400)":"var(--green-400)";return`
        <div class="bento-card" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
          <div>
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
              ...
              <span class="brand-badge" style="color: ${T}; border-color: rgba(245, 158, 11, 0.3);">Status: ${_(d.status)}</span>
    ...
    ${n}
  `}function se(){let e=l.getState(),t=e.clients||[],r=Object.keys(e.config.profiles||{});if(t.length===0)return"";return`
    <div class="bento-card" style="margin-bottom: 20px; padding: 16px 18px; border-color: rgba(245, 158, 11, 0.2);">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 10px;">
        ${t.map((s)=>{let{is_attached:a,config_exists:i,app_installed:o}=s,d='<span class="brand-badge" style="color: var(--text-dim); border-color: rgba(255, 255, 255, 0.1);">Not Found</span>';if(a){let u=s.attached_profile?` · Profile: ${s.attached_profile}`:"";d=`<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.3); background: rgba(52, 211, 153, 0.1);">⚡ Connected${_(u)}</span>`}else if(i)d='<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.3); background: rgba(251, 191, 36, 0.08);">○ Ready to Connect</span>';else if(o)d='<span class="brand-badge" style="color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.25);">○ App Installed</span>';let p=r.map((u)=>`
  ...
  `}function _(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function K(){let e=l.getState(),t=e.playgroundMode||"tools",r=e.capabilities||[],n=e.resources||[],s=e.prompts||[],a=`
  ...
  `}function O(e,t=!1){if(!e||!e.properties)return{};let r=e.properties||{},n=Array.isArray(e.required)?e.required:[],s={};for(let[a,i]of Object.entries(r)){let o=n.includes(a);if(t&&!o)continue;if(i.default!==void 0)s[a]=i.default;else if(Array.isArray(i.enum)&&i.enum.length>0)s[a]=i.enum[0];else if(i.examples&&Array.isArray(i.examples)&&i.examples.length>0)s[a]=i.examples[0];else if(i.example!==void 0)s[a]=i.example;else switch(i.type||"string"){case"string":s[a]=o?`sample_${a}`:"";break;case"number":case"integer":s[a]=0;break;case"boolean":s[a]=!0;break;case"array":s[a]=[];break;case"object":s[a]={};break;default:s[a]=`sample_${a}`}}return s}function ae(e){let t=e.capabilities||[],r=e.selectedCapabilityId||(t.length>0?t[0].id:null),n=t.find((m)=>m.id===r),s=!!e.isExecuting,a="";if(t.length===0)a=`
    ...
    `;else a=t.map((m)=>`
        <div class="cap-item ${m.id===r?"active":""}" onclick="window.app.selectCapability('${v(m.id)}')">
      ...
      `).join("");let i=n?.input_schema,o=i?.properties||{},d=Array.isArray(i?.required)?i.required:[],p=Object.entries(o),g="";if(p.length>0)g=`
      <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 8px; align-items: center;">
        ...
        ${p.map(([m,c])=>{let h=d.includes(m),k=c.type||(c.enum?"enum":"any"),T=h?"rgba(239, 68, 68, 0.15)":"rgba(148, 163, 184, 0.1)",E=h?"var(--red-400)":"var(--text-muted)",I=h?"rgba(239, 68, 68, 0.3)":"var(--border)",A=c.description?` - ${c.description}`:"";return`
            <button 
              type="button" 
              class="btn" 
              style="padding: 2px 7px; font-size: 10.5px; font-family: var(--ff-mono); background: ${T}; color: ${E}; border: 1px solid ${I}; border-radius: var(--radius-sm);" 
    ...
    `;let u="{}";if(r&&e.playgroundArgs&&e.playgroundArgs[r]!==void 0)u=e.playgroundArgs[r];else{let m=O(i,!1);u=JSON.stringify(m,null,2)}return`
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);" id="pg-selected-title">
              ${v(n?n.id:"No Capability Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);" id="pg-selected-desc">
              ${v(n?n.summary||n.description:"Connect servers to inspect and execute tools")}
            </div>
          </div>
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
          ...
          <div style="padding: 16px; border-right: 1px solid var(--border); overflow-y: auto;">
            ...
            <textarea class="form-textarea" rows="7" id="pg-args-input" oninput="window.app.updatePlaygroundArgs(this.value)">${v(u)}</textarea>
            ...
            ${n&&n.input_schema?`
              <div style="margin-top: 14px;">
                ...
                <pre style="background: var(--surface); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-size: 11px; color: var(--text-muted); max-height: 140px; overflow-y: auto;">${v(JSON.stringify(n.input_schema,null,2))}</pre>
              </div>
            `:""}
          </div>
  ...
  `}function re(e){let t=e.resources||[],r=e.selectedResourceId||(t.length>0?t[0].id:null),n=t.find((i)=>i.id===r),s=e.resourceReadResult,a="";if(t.length===0)a=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No resources exposed by connected MCP servers.
      </div>
    `;else a=t.map((i)=>{let o=i.id===r?"active":"",d=i.uri?i.uri.split(":")[0]:"res";return`
        <div class="cap-item ${o}" onclick="window.app.selectResource('${v(i.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${v(i.name||i.id)}</span>
            <span class="badge" style="font-size: 9.5px; background: rgba(56, 189, 248, 0.15); color: var(--cyan-400);">${v(d)}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${v(i.uri)}</div>
          <div style="display: flex; justify-content: space-between; font-size: 10px; color: var(--text-muted); margin-top: 4px;">
            <span>server: ${v(i.server||"local")}</span>
            <span>${v(i.mime_type||"text/plain")}</span>
          </div>
        </div>
      `}).join("");return`
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${v(n?n.name||n.id:"No Resource Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--cyan-400); font-family: var(--ff-mono);">
              ${v(n?n.uri:"Select a resource from the list to read live content")}
            </div>
          </div>
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
            ...
            ${n?`
              <div style="background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border); margin-bottom: 14px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 11.5px;">
                  <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--text-main);">${v(n.server)}</strong></div>
                  <div><span style="color: var(--text-muted);">MIME Type:</span> <strong style="color: var(--text-main);">${v(n.mime_type||"text/plain")}</strong></div>
                </div>
                ${n.description?`
          ...
          <div style="padding: 16px; background: var(--bg-app); display: flex; flex-direction: column; overflow: hidden;">
            ...
            <pre style="flex: 1; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; color: var(--cyan-400); font-size: 11.5px; overflow-y: auto; margin: 0; white-space: pre-wrap; word-break: break-word;">${s?v(JSON.stringify(s.data,null,2)):'// Click "Read Resource Content" to inspect live payload'}</pre>
          </div>
        </div>
      </div>
    </div>
  `}function ne(e){let t=e.prompts||[],r=e.selectedPromptId||(t.length>0?t[0].id:null),n=t.find((o)=>o.id===r),s=e.promptGetResult,a="";if(t.length===0)a=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No prompt templates registered by connected MCP servers.
      </div>
    `;else a=t.map((o)=>{let d=o.id===r?"active":"",p=o.arguments?o.arguments.length:0;return`
      ...
      `}).join("");let i="";if(n&&n.arguments&&n.arguments.length>0)i=n.arguments.map((o)=>`
    ...
    <div style="display: grid; grid-template-columns: 340px 1fr; gap: 16px; height: calc(100vh - 165px);">
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${v(n?n.name||n.id:"No Prompt Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);">
              ${v(n?n.description||n.title||"Bind variables and render messages":"Select a prompt from the list to test")}
            </div>
          </div>
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 24px;" onclick="if(event.target === this) window.app.closeBatchModal()">
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); width: 840px; max-width: 95vw; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <div style="flex: 1; overflow-y: auto; padding: 20px;">
          ${r.map((s,a)=>{let i=t.find((c)=>c.id===s.capability_id),o=i?.input_schema,d=o?.properties||{},p=Array.isArray(o?.required)?o.required:[],g=Object.entries(d),u=t.map((c)=>`
      <option value="${v(c.id)}" ${c.id===s.capability_id?"selected":""}>
        ${v(c.id)} (${v(c.server||"local")})
      </option>
    `).join(""),m="";if(g.length>0)m=`
        <div style="display: flex; flex-wrap: wrap; gap: 4px; margin-top: 6px; margin-bottom: 6px; align-items: center;">
          ...
          ${g.map(([c,h])=>{let k=p.includes(c),T=h.type||(h.enum?"enum":"any");return`
      ...
      <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-size: 11px; font-family: var(--ff-mono); color: var(--text-dim);">id: ${v(s.id)}</span>
          </div>
  ...
  `}function v(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function G(e){let t=e.tasks||[],r=e.taskFilterStatus||"all",n=t.filter((c)=>c.status==="input_required"),s=t.filter((c)=>c.status==="working"),a=t.filter((c)=>c.status==="completed"),i=t.filter((c)=>c.status==="cancelled"),o=t.filter((c)=>c.status==="failed"),d=r==="all"?t:t.filter((c)=>c.status===r),p=e.config.policy?.require_approval||e.config.policy?.requireApproval||[],g=n.length===0?`
  ...
  `:n.map((c)=>{let h=c.inputRequests||{},k=Object.keys(h),T=k.length>0,E=Math.floor(Date.now()/1000),I=c.expiresAtEpochSecs?Math.max(0,c.expiresAtEpochSecs-E):c.ttlSeconds||300;return`
  ...
  `:d.map((c)=>{let h=c.status==="completed"?"background: rgba(52, 211, 153, 0.12); color: var(--green-400); border-color: rgba(52, 211, 153, 0.3);":c.status==="working"?"background: rgba(56, 189, 248, 0.15); color: var(--cyan-400); border-color: rgba(56, 189, 248, 0.4);":c.status==="input_required"?"background: rgba(245, 158, 11, 0.2); color: var(--amber-300); border-color: rgba(245, 158, 11, 0.5);":c.status==="cancelled"?"background: rgba(148, 163, 184, 0.15); color: var(--text-muted); border-color: rgba(148, 163, 184, 0.3);":"background: rgba(248, 113, 113, 0.12); color: var(--red-400); border-color: rgba(248, 113, 113, 0.3);",k=c.progress!==void 0?Math.round(c.progress*100):c.status==="completed"?100:c.status==="working"?50:0,T=c.createdAtEpochSecs?new Date(c.createdAtEpochSecs*1000).toLocaleTimeString():"—";return`
    ...
    <div class="bento-grid">
      ...
      <div class="bento-card col-3">
        ...
        <div class="stat-value" style="color: ${o.length>0?"var(--red-400)":"var(--text-muted)"};">${i.length+o.length}</div>
  ...
  `}function S(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function V(){let e=l.getState(),t=e.auditEvents||[],r=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},n=e.auditVerification,s=e.auditFilters,a=e.auditTotal??t.length,i=e.auditSelectedEvent,o=Object.keys(e.config?.mcpServers||{}),d=s.limit||25,p=s.offset||0,g=Math.floor(p/d)+1,u=Math.max(1,Math.ceil(a/d)),m=a===0?0:p+1,c=Math.min(p+d,a),h=f.getAuditExportUrl({actor_id:s.search?void 0:void 0,server_id:s.serverId!=="all"?s.serverId:void 0,event_type:s.eventType!=="all"?s.eventType:void 0,status:s.status!=="all"?s.status:void 0,search:s.search.trim()?s.search.trim():void 0},"csv"),k=f.getAuditExportUrl({server_id:s.serverId!=="all"?s.serverId:void 0,event_type:s.eventType!=="all"?s.eventType:void 0,status:s.status!=="all"?s.status:void 0,search:s.search.trim()?s.search.trim():void 0},"jsonl"),T=n?n.is_valid?`
  ...
  `,E=o.map((b)=>`<option value="${w(b)}" ${s.serverId===b?"selected":""}>${w(b)}</option>`).join(""),I=`
  ...
  `,A=`
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: rgba(18, 24, 38, 0.5); border-radius: var(--radius-md); border: 1px solid var(--border); margin-top: 16px;">
      <div style="font-size: 12px; color: var(--text-dim); display: flex; align-items: center; gap: 8px;">
        <span>Showing <strong style="color: var(--text-main);">${m}–${c}</strong> of <strong style="color: var(--text-main);">${a}</strong> events</span>
  ...
  `,x="";if(t.length===0)x=`
    ...
    `;else x=t.map((b)=>{let L=new Date(Math.floor(b.timestamp_ns/1e6)).toLocaleString(),C='<span class="badge" style="background: rgba(34, 197, 94, 0.15); color: var(--green-400); font-weight: 600;">SUCCESS</span>';if(b.status==="denied")C='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">DENIED</span>';else if(b.status==="intercepted")C='<span class="badge" style="background: rgba(234, 179, 8, 0.15); color: var(--amber-300); font-weight: 600;">HITL INTERCEPT</span>';else if(b.status==="failed")C='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">FAILED</span>';else if(b.status==="cancelled")C='<span class="badge" style="background: rgba(148, 163, 184, 0.15); color: var(--text-muted); font-weight: 600;">CANCELLED</span>';let H=b.sanitized_args?JSON.stringify(b.sanitized_args):"-",q=b.actor_id||b.operator_id||"anonymous",j=b.server_id||"system",ee=b.capability_id||b.event_type,te=b.execution_latency_us?`${(b.execution_latency_us/1000).toFixed(1)}ms`:"-";return`
      ...
      `}).join("");let P="";if(i){let b=new Date(Math.floor(i.timestamp_ns/1e6)).toISOString();P=`
        ...
        <div class="bento-card" style="width: 100%; max-width: 720px; max-height: 85vh; display: flex; flex-direction: column; overflow: hidden; background: #0f172a; border: 1px solid var(--border); box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <h2 style="font-size: 15px; font-weight: 700; color: var(--text-main); margin: 0;">Audit Event Details (${w(i.id)})</h2>
            </div>
          ...
          <div style="padding: 20px; overflow-y: auto; display: flex; flex-direction: column; gap: 14px; font-size: 12px;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm);">
              ...
              <div><span style="color: var(--text-muted);">Status:</span> <strong style="color: var(--text-main);">${w(i.status.toUpperCase())}</strong></div>
              <div><span style="color: var(--text-muted);">Event Type:</span> <strong style="color: var(--text-main);">${w(i.event_type)}</strong></div>
              <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--cyan-400);">${w(i.server_id||"system")}</strong></div>
              <div><span style="color: var(--text-muted);">Capability:</span> <strong style="color: var(--text-main);">${w(i.capability_id||"-")}</strong></div>
              <div><span style="color: var(--text-muted);">Actor / Operator:</span> <strong style="color: var(--text-main);">${w(i.actor_id||i.operator_id||"anonymous")}</strong></div>
              <div><span style="color: var(--text-muted);">Trace ID:</span> <code style="color: var(--cyan-400);">${w(i.trace_id)}</code></div>
              <div><span style="color: var(--text-muted);">Request ID:</span> <code style="color: var(--cyan-400);">${w(i.request_id||"-")}</code></div>
              <div><span style="color: var(--text-muted);">Client IP:</span> <span style="color: var(--text-main);">${w(i.client_ip||"-")}</span></div>
            ...
            ${i.error_message?`
              <div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: var(--radius-sm); padding: 10px 12px; color: var(--red-400);">
                <div style="font-weight: 700; margin-bottom: 2px;">Error (${w(i.error_code||"ERROR")}):</div>
                <div style="font-family: var(--ff-mono); font-size: 11px;">${w(i.error_message)}</div>
              </div>
            `:""}
            ...
            <div>
              ...
              <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${w(JSON.stringify(i.sanitized_args||{},null,2))}</pre>
            </div>
            ...
            ${i.sanitized_response?`
              <div>
                ...
                <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${w(JSON.stringify(i.sanitized_response,null,2))}</pre>
              </div>
            `:""}
            ...
            <div style="background: rgba(0,0,0,0.3); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
              ...
              <div style="margin-bottom: 6px;">
                ...
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--text-dim); word-break: break-all;">${w(i.prev_hash)}</div>
              </div>
              <div>
                <span style="color: var(--text-muted); font-size: 10.5px;">Record Hash Signature (hash):</span>
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--green-400); word-break: break-all;">${w(i.hash)}</div>
              </div>
            </div>
          </div>
    ...
    ${P}
  `}function w(e){if(!e)return"";return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function W(){let t=l.getState().config.policy||{},r=t.allow||[],n=t.deny||[],s=t.redact_keys||t.redactKeys||[],a=t.require_approval||t.requireApproval||[],i=r.length===0?`
  ...
  `:r.map((g,u)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--green-400);">✔ ${B(g)}</span>
  ...
  `:n.map((g,u)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--red-400);">✖ ${B(g)}</span>
  ...
  `:a.map((g,u)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--amber-400);">\uD83D\uDEE1️ ${B(g)}</span>
  ...
  `}function B(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Q(){let e=l.getState(),t=e.config,r=Object.entries(t.capabilityAliases||{}),n=Object.entries(t.resourceAliases||{}),s=Object.entries(t.promptAliases||{}),a="";if(r.length===0&&n.length===0&&s.length===0)a=`
    ...
    `;else{for(let[i,o]of r)a+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          <span style="color: var(--cyan-400);">Tool</span>
          <span style="font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${R(i)}</span>
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${R(o)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('tool', '${R(i)}')">✕</button>
          </div>
        </div>
      `;for(let[i,o]of n)a+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${R(o)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('resource', '${R(i)}')">✕</button>
          </div>
        </div>
      `;for(let[i,o]of s)a+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${R(o)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('prompt', '${R(i)}')">✕</button>
          </div>
        </div>
      `}return`
    <!-- Sub-header -->
  ...
  `}function R(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Y(){let e=l.getState(),t=e.config,r=t.profiles||{},n=Object.entries(r),s=t.mcpServers||{},a=e.activeProfile,i="";if(n.length===0)i=`
      <div style="padding: 40px; text-align: center; color: var(--text-dim); background: var(--surface-card); border-radius: var(--radius-md); border: 1px dashed var(--border);">
    ...
    `;else i=n.map(([o,d])=>{let p=a===o,g=d.servers.map((m)=>`<span class="brand-badge" style="${s[m]?"color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.25); background: rgba(34, 211, 238, 0.05);":"color: var(--red-400); border-color: rgba(248, 113, 113, 0.3); background: rgba(248, 113, 113, 0.05);"}">${M(m)}</span>`).join(" "),u=(e.capabilities||[]).filter((m)=>d.servers.includes(m.server)).length;return`
...
Payload: ${JSON.stringify(t.task.result||t.task.error||t.task.inputRequests||{},null,2)}`)}catch(t){alert(`Failed to fetch task: ${t.message}`)}}async submitApproval(e){let t=document.getElementById(`appr-operator-${e}`),r=document.getElementById(`appr-args-${e}`),n=t?.value.trim()||"security-operator",s=void 0;if(r&&r.value.trim())try{s=JSON.parse(r.value.trim())}catch{alert("Invalid JSON in arguments editor");return}let a=await f.approveTicket(e,n,s);if(a.ok)await this.refreshApprovals(),await this.refreshTasks();else alert(`Approval failed: ${a.error||"Unknown error"}`)}async promptReject(e){let t=prompt("Reason for rejection (will be returned to the calling agent):");if(t===null)return;let n=document.getElementById(`appr-operator-${e}`)?.value.trim()||"security-operator",s=await f.rejectTicket(e,n,t);if(s.ok)await this.refreshApprovals(),await this.refreshTasks();else alert(`Rejection failed: ${s.error||"Unknown error"}`)}setPlaygroundMode(e){l.setState({playgroundMode:e})}selectCapability(e){l.setState({selectedCapabilityId:e});let t=l.getState().capabilities.find((n)=>n.id===e),r=document.getElementById("pg-args-input");if(t){let n=O(t.input_schema,!1),s=JSON.stringify(n,null,2);if(r)r.value=s;let a={...l.getState().playgroundArgs||{}};a[e]=s,l.getState().playgroundArgs=a}}selectResource(e){l.setState({selectedResourceId:e})}selectPrompt(e){l.setState({selectedPromptId:e})}filterResources(e){let t=e.toLowerCase().trim(),n=(l.getState().resources||[]).filter((a)=>a.id.toLowerCase().includes(t)||a.name&&a.name.toLowerCase().includes(t)||a.uri&&a.uri.toLowerCase().includes(t)||a.server&&a.server.toLowerCase().includes(t)),s=document.getElementById("pg-res-list");if(s)if(n.length===0)s.innerHTML=`
        ...
        `;else s.innerHTML=n.map((a)=>{let i=a.id===l.getState().selectedResourceId?"active":"",o=a.uri?a.uri.split(":")[0]:"res";return`
          ...
          `}).join("")}filterPrompts(e){let t=e.toLowerCase().trim(),n=(l.getState().prompts||[]).filter((a)=>a.id.toLowerCase().includes(t)||a.name&&a.name.toLowerCase().includes(t)||a.description&&a.description.toLowerCase().includes(t)||a.server&&a.server.toLowerCase().includes(t)),s=document.getElementById("pg-prompt-list");if(s)if(n.length===0)s.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No prompts match "${y(e)}"
          </div>
        `;else s.innerHTML=n.map((a)=>{let i=a.id===l.getState().selectedPromptId?"active":"",o=a.arguments?a.arguments.length:0;return`
            <div class="cap-item ${i}" onclick="window.app.selectPrompt('${y(a.id)}')">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${y(a.name||a.id)}</span>
          ...
          `}).join("")}updatePlaygroundArgs(e){let t=l.getState(),r=t.selectedCapabilityId||(t.capabilities[0]?t.capabilities[0].id:null);if(!r)return;let n={...t.playgroundArgs||{}};n[r]=e,t.playgroundArgs=n}fillPlaygroundSampleArgs(e=!1){let t=l.getState(),r=t.selectedCapabilityId||(t.capabilities[0]?t.capabilities[0].id:null),n=t.capabilities.find((o)=>o.id===r),s=document.getElementById("pg-args-input");if(!s)return;if(!n||!n.input_schema){if(s.value="{}",r){let o={...t.playgroundArgs||{}};o[r]="{}",t.playgroundArgs=o}return}let a=O(n.input_schema,e),i=JSON.stringify(a,null,2);if(s.value=i,r){let o={...t.playgroundArgs||{}};o[r]=i,t.playgroundArgs=o}}formatPlaygroundArgs(){let e=l.getState(),t=e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:null),r=document.getElementById("pg-args-input");if(r)try{let n=JSON.parse(r.value||"{}"),s=JSON.stringify(n,null,2);if(r.value=s,t){let a={...e.playgroundArgs||{}};a[t]=s,e.playgroundArgs=a}}catch(n){alert(`Cannot format JSON: ${n.message}`)}}insertPlaygroundArgKey(e,t,r){let n=l.getState(),s=n.selectedCapabilityId||(n.capabilities[0]?n.capabilities[0].id:null),a=document.getElementById("pg-args-input");if(a){let i={};try{i=JSON.parse(a.value||"{}")}catch{i={}}if(i[e]===void 0)if(r!==null&&r!==void 0)i[e]=r;else switch(t){case"string":i[e]=`sample_${e}`;break;case"number":case"integer":i[e]=0;break;case"boolean":i[e]=!0;break;case"array":i[e]=[];break;case"object":i[e]={};break;default:i[e]=`sample_${e}`}let o=JSON.stringify(i,null,2);if(a.value=o,s){let d={...n.playgroundArgs||{}};d[s]=o,n.playgroundArgs=d}}}fillBatchStepSampleArgs(e){let t=l.getState(),r=[...t.batchSteps||[]],n=r[e];if(!n||!n.capability_id)return;let s=t.capabilities.find((d)=>d.id===n.capability_id);if(!s||!s.input_schema)return;let a=s.input_schema.properties||{},i={};for(let[d,p]of Object.entries(a))if(p.default!==void 0)i[d]=p.default;else if(Array.isArray(p.enum)&&p.enum.length>0)i[d]=p.enum[0];else switch(p.type||"string"){case"string":i[d]=`sample_${d}`;break;case"number":case"integer":i[d]=0;break;case"boolean":i[d]=!0;break;case"array":i[d]=[];break;case"object":i[d]={};break;default:i[d]=`sample_${d}`}let o=JSON.stringify(i,null,2);r[e]={...r[e],argsJson:o},l.setState({batchSteps:r})}filterCapabilities(e){let t=e.toLowerCase().trim(),n=l.getState().capabilities.filter((a)=>a.id.toLowerCase().includes(t)||a.summary&&a.summary.toLowerCase().includes(t)||a.server&&a.server.toLowerCase().includes(t)),s=document.getElementById("pg-cap-list");if(s)if(n.length===0)s.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No capabilities match "${y(e)}"
          </div>
        `;else s.innerHTML=n.map((a)=>`
          <div class="cap-item ${a.id===l.getState().selectedCapabilityId?"active":""}" onclick="window.app.selectCapability('${y(a.id)}')">
            <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        `).join("")}async executePlaygroundTool(){let e=l.getState(),t=e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:null);if(!t)return;let r=document.getElementById("pg-args-input")?.value||"{}",n=document.getElementById("pg-context-input")?.value||void 0,s=document.getElementById("pg-jsonpath-input")?.value.trim()||void 0,a=document.getElementById("pg-limit-lines-input")?.value.trim()||void 0,i=document.getElementById("pg-truncate-bytes-input")?.value.trim()||void 0,o={};try{o=JSON.parse(r)}catch{alert("Invalid arguments JSON object");return}if(s)o._jsonpath=s;if(a&&!isNaN(Number(a)))o._limit_lines=Number(a);if(i&&!isNaN(Number(i)))o._truncate_bytes=Number(i);let d=`op-${Date.now()}`;l.setState({isExecuting:!0,activeRequestId:d});let p=e.activeProfile||void 0,g=e.playgroundAsyncTask||!1;try{let u=await f.callCapability({capability_id:t,args:o,request_id:d,async_task:g?!0:void 0,context:{operation_id:n||d}},p);if(l.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:u.status,durationMs:u.durationMs,data:u.data}}),u.status===202||u.data?.resultType==="task")this.refreshTasks();l.addEventLog("POST",`/v1/tools/call → ${t}`,u.status===200?"200 OK":`HTTP ${u.status}`,`${u.durationMs.toFixed(1)}ms`),f.getConfig().then((m)=>{if(m.ok&&m.circuit_breakers)l.setState({circuitBreakers:m.circuit_breakers})})}catch(u){l.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:500,durationMs:0,data:{error:u.toString()}}})}}openBatchModal(){let e=l.getState(),t=e.batchSteps;if(!t||t.length===0)t=[{id:"step_1",capability_id:e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:""),argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],l.setState({batchSteps:t});l.setState({isBatchModalOpen:!0})}closeBatchModal(){l.setState({isBatchModalOpen:!1})}addBatchStep(){let t=[...l.getState().batchSteps||[]],r=t.length+1;t.push({id:`step_${r}`,capability_id:"",argsJson:"{}",continue_on_error:!1}),l.setState({batchSteps:t})}removeBatchStep(e){let r=[...l.getState().batchSteps||[]];if(r.length<=1){alert("Pipeline must contain at least one execution step.");return}r.splice(e,1);let n=r.map((s,a)=>({...s,id:`step_${a+1}`}));l.setState({batchSteps:n})}updateBatchStepCapability(e,t){let n=[...l.getState().batchSteps||[]];if(n[e])n[e]={...n[e],capability_id:t},l.setState({batchSteps:n})}updateBatchStepContinueOnError(e,t){let n=[...l.getState().batchSteps||[]];if(n[e])n[e]={...n[e],continue_on_error:t},l.setState({batchSteps:n})}updateBatchStepArgs(e,t){let r=l.getState(),n=[...r.batchSteps||[]];if(n[e])n[e]={...n[e],argsJson:t},r.batchSteps[e].argsJson=t}appendBatchVariable(e,t){let n=[...l.getState().batchSteps||[]],s=document.getElementById(`batch-step-args-${e}`);if(s){let a=s.value,i=s.selectionStart||a.length,o=s.selectionEnd||a.length,d=a.substring(0,i)+t+a.substring(o);if(s.value=d,n[e])n[e]={...n[e],argsJson:d},l.setState({batchSteps:n})}}async executeBatchPipeline(){let e=l.getState(),t=e.batchSteps||[],r=[];for(let s=0;s<t.length;s++){let a=t[s];if(!a.capability_id){alert(`Please select a capability for Step ${s+1}`);return}let i={};try{i=JSON.parse(a.argsJson||"{}")}catch{alert(`Invalid JSON in Step ${s+1} arguments`);return}r.push({id:a.id||`step_${s+1}`,capability_id:a.capability_id,args:i,continue_on_error:a.continue_on_error})}l.setState({isBatchModalOpen:!1});let n=e.activeProfile||void 0;try{let s=await f.batchCallCapabilities(r,n);l.setState({executionResult:{status:s.status,durationMs:s.durationMs,data:s.data}}),l.addEventLog("POST",`/v1/tools/batch_call (${t.length} steps)`,s.status===200?"200 OK":`HTTP ${s.status}`,`${s.durationMs.toFixed(1)}ms`)}catch(s){l.setState({executionResult:{status:500,durationMs:0,data:{error:s.toString()}}})}}async executeReadResource(){let e=l.getState(),t=e.selectedResourceId||(e.resources[0]?e.resources[0].id:null);if(!t)return;let r=document.getElementById("pg-res-jsonpath-input")?.value.trim()||void 0,n=document.getElementById("pg-res-lines-input")?.value.trim()||void 0,s=document.getElementById("pg-res-bytes-input")?.value.trim()||void 0,a={resource_id:t};if(r)a._jsonpath=r;if(n&&!isNaN(Number(n)))a._limit_lines=Number(n);if(s&&!isNaN(Number(s)))a._truncate_bytes=Number(s);let i=e.activeProfile||void 0;try{let o=await f.readResource({resource_id:t,input_responses:a},i);l.setState({resourceReadResult:{status:o.status,durationMs:o.durationMs,data:o.data}}),l.addEventLog("POST",`/v1/resources/read → ${t}`,o.status===200?"200 OK":`HTTP ${o.status}`,`${o.durationMs.toFixed(1)}ms`)}catch(o){l.setState({resourceReadResult:{status:500,durationMs:0,data:{error:o.toString()}}})}}async executeGetPrompt(){let e=l.getState(),t=e.selectedPromptId||(e.prompts[0]?e.prompts[0].id:null);if(!t)return;let r=document.querySelectorAll(".prompt-arg-input"),n={};r.forEach((a)=>{let i=a,o=i.getAttribute("data-arg-name");if(o&&i.value.trim())n[o]=i.value.trim()});let s=e.activeProfile||void 0;try{let a=await f.getPrompt({prompt_id:t,arguments:n},s);l.setState({promptGetResult:{status:a.status,durationMs:a.durationMs,data:a.data}}),l.addEventLog("POST",`/v1/prompts/get → ${t}`,a.status===200?"200 OK":`HTTP ${a.status}`,`${a.durationMs.toFixed(1)}ms`)}catch(a){l.setState({promptGetResult:{status:500,durationMs:0,data:{error:a.toString()}}})}}toggleBatchPlayground(){let e=document.getElementById("pg-args-input");if(!e)return;let t=[{id:"step_1",capability_id:"sqlite.read_query",args:{query:"SELECT * FROM users LIMIT 2"}},{id:"step_2",capability_id:"github.issues.search",args:{query:"label:bug"},continue_on_error:!0}];e.value=JSON.stringify(t,null,2)}async submitPolicyRule(e){let t=e==="allow"?"policy-new-allow":e==="deny"?"policy-new-deny":"policy-new-redact",r=document.getElementById(t);if(!r)return;let n=r.value.trim();if(!n)return;await this.addPolicyRule(e,n),r.value=""}async addPolicyRule(e,t){let r=(t||"").trim();if(!r)return;let s=l.getState().config.policy||{},a=[...s.allow||[]],i=[...s.deny||[]],o=[...s.redact_keys||s.redactKeys||[]];if(e==="allow"&&!a.includes(r))a.push(r);if(e==="deny"&&!i.includes(r))i.push(r);if(e==="redact"&&!o.includes(r))o.push(r);let d=await f.savePolicy({allow:a,deny:i,redact_keys:o,redactKeys:o});if(!d.ok)alert(`Failed to save policy rule: ${d.error||"Unknown error"}`);await this.refreshData()}async removePolicyRule(e,t){let n=l.getState().config.policy||{},s=[...n.allow||[]],a=[...n.deny||[]],i=[...n.redact_keys||n.redactKeys||[]];if(e==="allow")s.splice(t,1);if(e==="deny")a.splice(t,1);if(e==="redact")i.splice(t,1);let o=await f.savePolicy({allow:s,deny:a,redact_keys:i,redactKeys:i});if(!o.ok)alert(`Failed to update policy: ${o.error||"Unknown error"}`);await this.refreshData()}testPolicySandbox(e){let t=document.getElementById("policy-test-verdict");if(!t)return;let r=e.trim();if(!r){t.textContent="ENTER ID",t.style.color="var(--text-dim)";return}let s=l.getState().config.policy||{},a=s.deny||[],i=s.allow||[],o=(d,p)=>{if(d==="*")return!0;if(d.endsWith("*"))return p.startsWith(d.slice(0,-1));return d===p};if(a.some((d)=>o(d,r))){t.textContent="DENIED (Strict Block)",t.style.color="var(--red-400)";return}if(i.length>0&&!i.some((d)=>o(d,r))){t.textContent="DENIED (Not in Allow List)",t.style.color="var(--red-400)";return}t.textContent="ALLOWED",t.style.color="var(--green-400)"}async deleteServer(e){if(!confirm(`Are you sure you want to remove server '${e}' from config?`))return;await f.deleteServer(e),await this.refreshData()}openAddServerModal(){this.closeModals();let e=document.getElementById("modal-srv-title"),t=document.getElementById("modal-srv-template-banner"),r=document.getElementById("modal-srv-name"),n=document.getElementById("modal-srv-transport"),s=document.getElementById("modal-srv-command"),a=document.getElementById("modal-srv-url"),i=document.getElementById("modal-srv-ft"),o=document.getElementById("modal-srv-cd"),d=document.getElementById("modal-srv-autorestart"),p=document.getElementById("modal-srv-maxrestarts");if(e)e.textContent="Add Upstream MCP Server";if(t)t.style.display="flex";if(r)r.value="",r.disabled=!1;if(n)n.value="stdio";if(s)s.value="";if(a)a.value="";let g=document.getElementById("modal-group-cmd"),u=document.getElementById("modal-group-url");if(g)g.style.display="block";if(u)u.style.display="none";if(i)i.value="3";if(o)o.value="30000";if(d)d.value="true";if(p)p.value="5";let m=document.getElementById("modal-add-server");if(m)m.classList.add("active")}openEditServerModal(e){this.closeModals();let t=l.getState(),r=t.config.mcpServers?.[e];if(!r){alert(`Server '${e}' not found in configuration.`);return}let n=document.getElementById("modal-srv-title"),s=document.getElementById("modal-srv-template-banner"),a=document.getElementById("modal-srv-name"),i=document.getElementById("modal-srv-transport"),o=document.getElementById("modal-srv-command"),d=document.getElementById("modal-srv-url"),p=document.getElementById("modal-srv-ft"),g=document.getElementById("modal-srv-cd"),u=document.getElementById("modal-srv-autorestart"),m=document.getElementById("modal-srv-maxrestarts");if(n)n.textContent=`Edit Server '${e}'`;if(s)s.style.display="none";if(a)a.value=e,a.disabled=!0;let c=!!r.command;if(i)i.value=c?"stdio":"http";let h=document.getElementById("modal-group-cmd"),k=document.getElementById("modal-group-url");if(h)h.style.display=c?"block":"none";if(k)k.style.display=c?"none":"block";if(o)o.value=c?`${r.command} ${(r.args||[]).join(" ")}`.trim():"";if(d)d.value=r.url||"";let T=r.resilience||t.config.resilience;if(p)p.value=String(T?.failureThreshold??3);if(g)g.value=String(T?.cooldownMs??30000);if(u)u.value=T?.autoRestart===!1?"false":"true";if(m)m.value=String(T?.maxRestarts??5);let E=document.getElementById("modal-add-server");if(E)E.classList.add("active")}async submitAddServer(){let e=document.getElementById("modal-srv-name"),t=e?.value.trim(),r=document.getElementById("modal-srv-transport")?.value;if(!t){alert("Server name is required");return}if(e&&!e.disabled){if((l.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists in configuration. Do you want to overwrite it?`))return}}let n={};if(r==="stdio"){let g=(document.getElementById("modal-srv-command")?.value.trim()).split(/\s+/).filter(Boolean);if(g.length===0){alert("Command is required");return}n.command=g[0],n.args=g.slice(1)}else{let p=document.getElementById("modal-srv-url")?.value.trim();if(!p){alert("URL is required");return}n.url=p}let s=document.getElementById("modal-srv-ft")?.value.trim(),a=document.getElementById("modal-srv-cd")?.value.trim(),i=document.getElementById("modal-srv-autorestart")?.value,o=document.getElementById("modal-srv-maxrestarts")?.value.trim();if(s||a||i||o)n.resilience={failureThreshold:s?Number(s):3,cooldownMs:a?Number(a):30000,autoRestart:i!=="false",maxRestarts:o?Number(o):5};let d=await f.upsertServer(t,n);if(d.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${d.error}`)}openTemplateCatalog(){this.closeModals();let e=document.getElementById("modal-templates");if(e)e.classList.add("active");this.renderTemplateGrid()}setTemplateCategory(e){this.activeTemplateCategory=e,document.querySelectorAll(".tmpl-cat-btn").forEach((t)=>{if(t.getAttribute("data-category")===e)t.classList.add("active"),t.style.background="var(--surface-elevated)",t.style.color="var(--amber-400)";else t.classList.remove("active"),t.style.background="var(--surface-card)",t.style.color="var(--text-main)"}),this.renderTemplateGrid()}filterTemplates(e){this.activeTemplateFilter=e.toLowerCase().trim(),this.renderTemplateGrid()}renderTemplateGrid(){let e=document.getElementById("tmpl-grid");if(!e)return;let t=F.filter((s)=>{let a=this.activeTemplateCategory==="all"||s.category===this.activeTemplateCategory,i=!this.activeTemplateFilter||s.name.toLowerCase().includes(this.activeTemplateFilter)||s.id.toLowerCase().includes(this.activeTemplateFilter)||s.description.toLowerCase().includes(this.activeTemplateFilter)||s.command.toLowerCase().includes(this.activeTemplateFilter)||s.envFields.some((o)=>o.key.toLowerCase().includes(this.activeTemplateFilter));return a&&i});if(t.length===0){e.innerHTML=`
        <div style="grid-column: span 2; padding: 32px; text-align: center; color: var(--text-dim);">
          No matching MCP server templates found.
        </div>
      `;return}let n=l.getState().config.mcpServers||{};e.innerHTML=t.map((s)=>{let a=!!n[s.id],i=`${s.command} ${s.defaultArgs.join(" ")}`;return`
          ...
          <div>
            ...
            ${s.envFields.length>0?`
              <div style="font-size: 10.5px; color: var(--amber-400); margin-top: 6px; display: flex; align-items: center; gap: 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                <span>⚡ Needs:</span>
                <code style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${s.envFields.map((o)=>y(o.key)).join(", ")}</code>
              </div>
            `:""}
          </div>
      ...
      `}).join("")}selectTemplate(e){let t=F.find((d)=>d.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let r=document.getElementById("modal-configure-template");if(r)r.classList.add("active");let n=document.getElementById("cfg-tmpl-title"),s=document.getElementById("cfg-tmpl-desc"),a=document.getElementById("cfg-tmpl-form");if(n)n.textContent=`Configure ${t.name} Server`;if(s)s.textContent=t.description;let i=l.getState().config.mcpServers||{},o=t.id;if(i[o]){let d=2;while(i[`${t.id}-${d}`])d++;o=`${t.id}-${d}`}if(a){let d="";if(t.envFields.length>0)d=`
      ...
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),r=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}if((l.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists. Do you want to overwrite its configuration?`))return}let a=r?r.split(/\s+/).filter(Boolean):[],i={},o=document.querySelectorAll(".tmpl-env-input");for(let h of Array.from(o)){let k=h.getAttribute("data-key"),T=h.value.trim(),E=e.envFields.find((I)=>I.key===k);if(E?.required&&!T){alert(`Required field '${E.label}' is missing.`);return}if(k&&T)i[k]=T}let d={command:e.command,args:a};if(Object.keys(i).length>0)d.env=i;let p=document.getElementById("cfg-srv-ft")?.value.trim(),g=document.getElementById("cfg-srv-cd")?.value.trim(),u=document.getElementById("cfg-srv-autorestart")?.value,m=document.getElementById("cfg-srv-maxrestarts")?.value.trim();if(p||g||u||m)d.resilience={failureThreshold:p?Number(p):3,cooldownMs:g?Number(g):30000,autoRestart:u!=="false",maxRestarts:m?Number(m):5};let c=await f.upsertServer(t,d);if(c.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${c.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let r=await f.getEcosystemSources();if(r.sources&&r.sources.length>0)t.innerHTML=r.sources.map((n)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await f.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}async refreshClients(){try{let e=await f.getClients();if(e.ok&&Array.isArray(e.clients))l.setState({clients:e.clients})}catch(e){console.error("Failed to scan clients:",e)}}async attachClient(e){let t=document.getElementById(`client-prof-${e}`),r=t?t.value:void 0,n=await f.attachClient(e,r);if(!n.ok)alert(`Failed to attach client: ${n.error||n.message||"Unknown error"}`);else await this.refreshData()}async detachClient(e){if(!confirm("Disconnect Warmplane from this client?"))return;let t=await f.detachClient(e);if(!t.ok)alert(`Failed to detach client: ${t.error||t.message||"Unknown error"}`);else await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let r=(e||"").trim().toLowerCase();if(r.length<2){t.style.display="none";return}let s=l.getState().capabilities.filter((a)=>a.id.toLowerCase().includes(r)||a.summary&&a.summary.toLowerCase().includes(r)||a.description&&a.description.toLowerCase().includes(r)||a.server&&a.server.toLowerCase().includes(r)).slice(0,8);if(s.length===0){t.style.display="none";return}t.innerHTML=s.map((a)=>`
...
Warnings:
${e.warnings.join(`
`)}`;alert(t)}else alert(`Hot-reload failed: ${e.error||"Unknown error"}`)}catch(e){alert(`Error reaching daemon: ${e.message}`)}await this.refreshData()}renderTopProfileSelector(){let e=document.getElementById("top-profile-selector");if(!e)return;let t=l.getState(),r=t.config.profiles||{},n=Object.keys(r),s=t.activeProfile,a='<option value="">All Servers (Unrestricted)</option>';for(let i of n){let o=s===i?"selected":"";a+=`<option value="${y(i)}" ${o}>Profile: ${y(i)}</option>`}e.innerHTML=a}async setActiveProfile(e){l.setState({activeProfile:e||null}),await this.refreshData()}openAddProfileModal(){let e=document.getElementById("modal-prof-title");if(e)e.textContent="Create Server Constellation Profile";let t=document.getElementById("modal-prof-name"),r=document.getElementById("modal-prof-desc"),n=document.getElementById("modal-prof-mode");if(t)t.value="",t.disabled=!1;if(r)r.value="";if(n)n.value="create";this.renderProfileServerCheckboxes([]);let s=document.getElementById("modal-add-profile");if(s)s.classList.add("active")}openEditProfileModal(e){let r=l.getState().config.profiles?.[e];if(!r)return;let n=document.getElementById("modal-prof-title");if(n)n.textContent=`Edit Profile: ${e}`;let s=document.getElementById("modal-prof-name"),a=document.getElementById("modal-prof-desc"),i=document.getElementById("modal-prof-mode");if(s)s.value=e,s.disabled=!0;if(a)a.value=r.description||"";if(i)i.value="edit";this.renderProfileServerCheckboxes(r.servers||[]);let o=document.getElementById("modal-add-profile");if(o)o.classList.add("active")}renderProfileServerCheckboxes(e){let t=document.getElementById("modal-prof-servers-list");if(!t)return;let r=l.getState(),n=Object.keys(r.config.mcpServers||{});if(n.length===0){t.innerHTML='<div style="font-size: 11.5px; color: var(--text-dim);">No MCP servers configured yet. Add servers first.</div>';return}t.innerHTML=n.map((s)=>{let a=e.includes(s)?"checked":"";return`
