class N{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],capabilities:[],resources:[],prompts:[],catalogEvents:[],approvals:[],auditEvents:[],auditTotal:0,auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:25,offset:0},auditSelectedEvent:null,auditStats:null,auditVerification:null,selectedCapabilityId:null,selectedResourceId:null,selectedPromptId:null,playgroundMode:"tools",isExecuting:!1,activeRequestId:null,isBatchModalOpen:!1,batchSteps:[{id:"step_1",capability_id:"",argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],activeTab:"overview",eventLogs:[],executionResult:null,resourceReadResult:null,promptGetResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,o,n){let i=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:o,latency:n},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:i})}}var s=new N;class D{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(){return(await fetch(`${this.baseUrl}/v1/capabilities`)).json()}async listResources(){return(await fetch(`${this.baseUrl}/v1/resources`)).json()}async readResource(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/resources/read`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),n=performance.now()-t,r=await o.json();return{status:o.status,durationMs:n,data:r}}async listPrompts(){return(await fetch(`${this.baseUrl}/v1/prompts`)).json()}async getPrompt(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/prompts/get`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),n=performance.now()-t,r=await o.json();return{status:o.status,durationMs:n,data:r}}async getCatalogEvents(e){let t=e?`?after=${encodeURIComponent(e)}`:"";return(await fetch(`${this.baseUrl}/v1/catalog/events${t}`)).json()}async callCapability(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),n=performance.now()-t,r=await o.json();return{status:o.status,durationMs:n,data:r}}async batchCallCapabilities(e){let t=performance.now(),o=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({steps:e})}),n=performance.now()-t,r=await o.json();return{status:o.status,durationMs:n,data:r}}async cancelOperation(e){return(await fetch(`${this.baseUrl}/v1/operations/${encodeURIComponent(e)}/cancel`,{method:"POST"})).json()}async completeArgument(e){return(await fetch(`${this.baseUrl}/v1/completion/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:o})})).json()}async rejectTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:o})})).json()}async updateAlias(e,t,o){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:o})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")t.set("server_id",e.server_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")t.set("event_type",e.event_type);if(e?.status&&e.status!=="all")t.set("status",e.status);if(e?.trace_id)t.set("trace_id",e.trace_id);if(e?.request_id)t.set("request_id",e.request_id);if(e?.search)t.set("search",e.search);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset!==void 0)t.set("offset",String(e.offset));let o=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${o?`?${o}`:""}`)).json()}getAuditExportUrl(e,t="csv"){let o=new URLSearchParams;if(o.set("format",t),e?.actor_id)o.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")o.set("server_id",e.server_id);if(e?.capability_id)o.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")o.set("event_type",e.event_type);if(e?.status&&e.status!=="all")o.set("status",e.status);if(e?.trace_id)o.set("trace_id",e.trace_id);if(e?.request_id)o.set("request_id",e.request_id);if(e?.search)o.set("search",e.search);return`${this.baseUrl}/v1/audit/export?${o.toString()}`}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}}var u=new D;function q(){let e=s.getState(),t=e.config.mcpServers||{},o=Object.keys(t),n=o.length,r="";if(o.length===0)r=`
    ...
    `;else r=o.map((f)=>{let z=t[f],j=z.command?"stdio":"http / sse",R=z.command?`${z.command} ${(z.args||[]).join(" ")}`:z.url,P=e.serverStatuses[f]||{status:"connected",protocol_version:"2026-07-28"},y=P.status==="degraded",L=P.status==="error"||P.status==="disconnected",T=y?"var(--amber-400)":L?"var(--red-400)":"var(--green-400)";return`
      ...
      `}).join("");let i=e.eventLogs.length===0?`
  ...
  `).join(""),a=e.metrics,d=a.totalCatalogRequests,l=a.totalEtagHits,p=d>0?`${(l/d*100).toFixed(1)}%`:"0.0%",g=d>0?`${l} of ${d} requests served via HTTP 304`:"Waiting for client requests",m=a.totalToolCalls,x=m>0?`${(a.totalToolDurationUs/m/1000).toFixed(1)}ms`:"0.0ms",w=m>0?`${m} tool executions processed`:"Local worker task queues warm",h=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,k=h>0?`${h*18}B / call`:"0B",$=h>0?`${h} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size";return`
  ...
  `}function A(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function U(){let e=s.getState(),t=e.config.mcpServers||{},o=Object.keys(t),n="";if(o.length===0)n=`
    ...
    `;else n=o.map((r)=>{let i=t[r],a=i.command?"stdio":"http / sse",d=i.command?`${i.command} ${(i.args||[]).join(" ")}`:i.url,l=e.serverStatuses[r]||{status:"connected",protocol_version:"2026-07-28"},p=i.env?Object.keys(i.env).map((f)=>`${f}=***`).join(", "):"None",g=(e.circuitBreakers||[]).find((f)=>f.server_id===r),m='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(g){if(g.state==="open")m=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${g.consecutive_failures} failures)</span>`;else if(g.state==="half_open")m=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${g.consecutive_successes} probe)</span>`}let x=i.resilience||e.config.resilience,w=x?`FT: ${x.failureThreshold||3} · Cooldown: ${(x.cooldownMs||30000)/1000}s · AutoRestart: ${x.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience",h=l.status==="degraded",k=l.status==="error"||l.status==="disconnected",$=h?"var(--amber-400)":k?"var(--red-400)":"var(--green-400)";return`
    ...
    ${n}
  `}function C(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(){let e=s.getState(),t=e.playgroundMode||"tools",o=e.capabilities||[],n=e.resources||[],r=e.prompts||[],i=`
  ...
  `}function V(e){let t=e.capabilities||[],o=e.selectedCapabilityId||(t.length>0?t[0].id:null),n=t.find((d)=>d.id===o),r=!!e.isExecuting,i="";if(t.length===0)i=`
    ...
    `;else i=t.map((d)=>{return`
        <div class="cap-item ${d.id===o?"active":""}" onclick="window.app.selectCapability('${c(d.id)}')">
      ...
      `}).join("");let a=n&&n.input_schema?JSON.stringify(n.input_schema.properties||{},null,2):"{}";return`
        ...
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);" id="pg-selected-title">
              ${c(n?n.id:"No Capability Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);" id="pg-selected-desc">
              ${c(n?n.summary||n.description:"Connect servers to inspect and execute tools")}
            </div>
          </div>
          ...
          <div style="padding: 16px; border-right: 1px solid var(--border); overflow-y: auto;">
            ...
            ${n&&n.input_schema?`
              <div style="margin-top: 14px;">
                ...
                <pre style="background: var(--surface); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-size: 11px; color: var(--text-muted); max-height: 140px; overflow-y: auto;">${c(JSON.stringify(n.input_schema,null,2))}</pre>
              </div>
            `:""}
          </div>
  ...
  `}function H(e){let t=e.resources||[],o=e.selectedResourceId||(t.length>0?t[0].id:null),n=t.find((a)=>a.id===o),r=e.resourceReadResult,i="";if(t.length===0)i=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No resources exposed by connected MCP servers.
      </div>
    `;else i=t.map((a)=>{let d=a.id===o?"active":"",l=a.uri?a.uri.split(":")[0]:"res";return`
        <div class="cap-item ${d}" onclick="window.app.selectResource('${c(a.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <span class="badge" style="font-size: 9.5px; background: rgba(56, 189, 248, 0.15); color: var(--cyan-400);">${c(l)}</span>
          </div>
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${c(n?n.name||n.id:"No Resource Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--cyan-400); font-family: var(--ff-mono);">
              ${c(n?n.uri:"Select a resource from the list to read live content")}
            </div>
          </div>
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
            ...
            ${n?`
              <div style="background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border); margin-bottom: 14px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 11.5px;">
                  <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--text-main);">${c(n.server)}</strong></div>
                  <div><span style="color: var(--text-muted);">MIME Type:</span> <strong style="color: var(--text-main);">${c(n.mime_type||"text/plain")}</strong></div>
                </div>
                ${n.description?`
          ...
          <div style="padding: 16px; background: var(--bg-app); display: flex; flex-direction: column; overflow: hidden;">
            ...
            <pre style="flex: 1; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; color: var(--cyan-400); font-size: 11.5px; overflow-y: auto; margin: 0; white-space: pre-wrap; word-break: break-word;">${r?c(JSON.stringify(r.data,null,2)):'// Click "Read Resource Content" to inspect live payload'}</pre>
          </div>
        </div>
      </div>
    </div>
  `}function ee(e){let t=e.prompts||[],o=e.selectedPromptId||(t.length>0?t[0].id:null),n=t.find((d)=>d.id===o),r=e.promptGetResult,i="";if(t.length===0)i=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No prompt templates registered by connected MCP servers.
      </div>
    `;else i=t.map((d)=>{let l=d.id===o?"active":"",p=d.arguments?d.arguments.length:0;return`
        <div class="cap-item ${l}" onclick="window.app.selectPrompt('${c(d.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
      ...
      `}).join("");let a="";if(n&&n.arguments&&n.arguments.length>0)a=n.arguments.map((d)=>`
    ...
    <div style="display: grid; grid-template-columns: 340px 1fr; gap: 16px; height: calc(100vh - 165px);">
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${c(n?n.name||n.id:"No Prompt Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);">
              ${c(n?n.description||n.title||"Bind variables and render messages":"Select a prompt from the list to test")}
            </div>
          </div>
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 24px;">
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); width: 840px; max-width: 95vw; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <div style="flex: 1; overflow-y: auto; padding: 20px;">
          ${o.map((r,i)=>{let a=t.map((d)=>`
      <option value="${c(d.id)}" ${d.id===r.capability_id?"selected":""}>
      ...
      <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-size: 11px; font-family: var(--ff-mono); color: var(--text-dim);">id: ${c(r.id)}</span>
          </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 10px;">
          ...
          <div style="display: flex; align-items: flex-end; padding-bottom: 6px;">
            <label style="display: flex; align-items: center; gap: 6px; font-size: 11.5px; color: var(--text-muted); cursor: pointer;">
              <input type="checkbox" ${r.continue_on_error?"checked":""} onchange="window.app.updateBatchStepContinueOnError(${i}, this.checked)" />
  ...
  `}function c(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function F(e){let t=e.approvals.filter((i)=>i.status==="pending"),o=e.approvals.filter((i)=>i.status!=="pending"),n=t.length===0?`
  ...
  `:t.map((i)=>`
    <div class="bento-card" style="border: 1px solid rgba(245, 158, 11, 0.35); background: var(--surface-card); margin-bottom: 14px; padding: 18px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
        <div>
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted);">${_(i.id)}</span>
          </div>
          <div style="margin-top: 6px; display: flex; align-items: center; gap: 8px;">
            <span style="font-size: 14.5px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${_(i.capability_id)}</span>
            <span style="font-size: 11px; color: var(--text-dim);">via <span style="color: var(--cyan-400); font-family: var(--ff-mono);">${_(i.server_id)}</span></span>
          </div>
        </div>

        <div style="text-align: right; font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim);">
          <div>Created: <span style="color: var(--text-muted);">${new Date(i.created_at*1000).toLocaleTimeString()}</span></div>
          <div style="color: var(--amber-400); margin-top: 2px;">Expires: ${new Date(i.expires_at*1000).toLocaleTimeString()}</div>
        </div>
      </div>

      <!-- Caller Context -->
      ${i.context||i.request_id?`
        <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; font-family: var(--ff-mono); font-size: 11px; display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px; color: var(--text-muted);">
          ${i.request_id?`<div><span style="color: var(--text-dim);">Request:</span> <span style="color: var(--text-main);">${_(i.request_id)}</span></div>`:""}
          ${i.context?.actor_id?`<div><span style="color: var(--text-dim);">Actor:</span> <span style="color: var(--cyan-400);">${_(i.context.actor_id)}</span></div>`:""}
          ${i.context?.operation_id?`<div><span style="color: var(--text-dim);">Operation:</span> <span style="color: var(--text-main);">${_(i.context.operation_id)}</span></div>`:""}
          ${i.context?.work_item_id?`<div><span style="color: var(--text-dim);">Work Item:</span> <span style="color: var(--text-main);">${_(i.context.work_item_id)}</span></div>`:""}
        </div>
      `:""}
      ...
      <div style="margin-bottom: 14px;">
        ...
        <textarea id="appr-args-${i.id}" class="form-textarea" rows="4" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px; line-height: 1.4;">${_(JSON.stringify(i.sanitized_args,null,2))}</textarea>
      </div>

      <!-- Action Footer -->
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 12px;">
        <div style="display: flex; align-items: center; gap: 8px;">
          <input id="appr-operator-${i.id}" type="text" class="form-input" placeholder="Operator ID" value="security-operator" style="width: 200px; padding: 5px 10px; font-size: 11px;">
        </div>

        <div style="display: flex; align-items: center; gap: 8px;">
          <button class="btn btn-danger" onclick="window.app.promptReject('${_(i.id)}')">
            ✕ Reject
          </button>
          <button class="btn btn-primary" onclick="window.app.submitApproval('${_(i.id)}')">
            ✓ Approve &amp; Execute
          </button>
        </div>
      </div>
  ...
  `).join(""),r=o.length===0?"":`
    <div style="margin-top: 32px; border-top: 1px solid var(--border); padding-top: 18px;">
      <div style="font-size: 11px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 12px;">
        Recent History (${o.length})
      </div>
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); overflow: hidden; font-family: var(--ff-mono); font-size: 11.5px;">
        ${o.map((i)=>`
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px 14px; border-bottom: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 10px;">
              <span class="brand-badge" style="${i.status==="approved"?"background: rgba(52, 211, 153, 0.12); color: var(--green-400); border-color: rgba(52, 211, 153, 0.3);":i.status==="rejected"?"background: rgba(248, 113, 113, 0.12); color: var(--red-400); border-color: rgba(248, 113, 113, 0.3);":"background: var(--surface-hover); color: var(--text-dim);"}">
                ${i.status.toUpperCase()}
              </span>
              <span style="font-weight: 600; color: var(--text-main);">${_(i.capability_id)}</span>
              <span style="color: var(--text-dim); font-size: 10.5px;">${_(i.id)}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 16px; color: var(--text-dim);">
              ${i.operator?`<span>Operator: <span style="color: var(--text-muted);">${_(i.operator)}</span></span>`:""}
              ${i.reason?`<span style="color: var(--red-400); font-style: italic;">"${_(i.reason)}"</span>`:""}
              <span>${new Date(i.created_at*1000).toLocaleTimeString()}</span>
            </div>
          </div>
        `).join("")}
      </div>
  ...
  `;return`
    ...
    ${r}
  `}function _(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function I(){let e=s.getState(),t=e.auditEvents||[],o=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},n=e.auditVerification,r=e.auditFilters,i=e.auditTotal??t.length,a=e.auditSelectedEvent,d=Object.keys(e.config?.mcpServers||{}),l=r.limit||25,p=r.offset||0,g=Math.floor(p/l)+1,m=Math.max(1,Math.ceil(i/l)),x=i===0?0:p+1,w=Math.min(p+l,i),h=u.getAuditExportUrl({actor_id:r.search?void 0:void 0,server_id:r.serverId!=="all"?r.serverId:void 0,event_type:r.eventType!=="all"?r.eventType:void 0,status:r.status!=="all"?r.status:void 0,search:r.search.trim()?r.search.trim():void 0},"csv"),k=u.getAuditExportUrl({server_id:r.serverId!=="all"?r.serverId:void 0,event_type:r.eventType!=="all"?r.eventType:void 0,status:r.status!=="all"?r.status:void 0,search:r.search.trim()?r.search.trim():void 0},"jsonl"),$=n?n.is_valid?`
  ...
  `,j=`
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: rgba(18, 24, 38, 0.5); border-radius: var(--radius-md); border: 1px solid var(--border); margin-top: 16px;">
      <div style="font-size: 12px; color: var(--text-dim); display: flex; align-items: center; gap: 8px;">
        <span>Showing <strong style="color: var(--text-main);">${x}–${w}</strong> of <strong style="color: var(--text-main);">${i}</strong> events</span>
      ...
      <div style="display: flex; align-items: center; gap: 6px;">
        ...
        <button 
          class="btn btn-ghost" 
          style="padding: 4px 8px; font-size: 11px; height: 28px;"
          ${g>=m?'disabled style="opacity: 0.4; cursor: not-allowed;"':""}
  ...
  `,R="";if(t.length===0)R=`
    ...
    ${P}
  `}function b(e){if(!e)return"";return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function B(){let t=s.getState().config.policy||{},o=t.allow||[],n=t.deny||[],r=t.redact_keys||t.redactKeys||[],i=t.require_approval||t.requireApproval||[],a=o.length===0?`
  ...
  `:o.map((g,m)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--green-400);">✔ ${O(g)}</span>
      <button class="btn btn-ghost" style="padding: 2px 6px; font-size: 11px; color: var(--red-400);" onclick="window.app.removePolicyRule('allow', ${m})">✕</button>
    </div>
  `).join(""),d=n.length===0?`
    <div style="color: var(--text-dim); font-size: 12px;">No deny rules configured</div>
  `:n.map((g,m)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--red-400);">✖ ${O(g)}</span>
      <button class="btn btn-ghost" style="padding: 2px 6px; font-size: 11px; color: var(--red-400);" onclick="window.app.removePolicyRule('deny', ${m})">✕</button>
    </div>
  `).join(""),l=i.length===0?`
    <div style="color: var(--text-dim); font-size: 12px;">No human-in-the-loop approval rules configured</div>
  `:i.map((g,m)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--amber-400);">\uD83D\uDEE1️ ${O(g)}</span>
      <button class="btn btn-ghost" style="padding: 2px 6px; font-size: 11px; color: var(--red-400);" onclick="window.app.removePolicyRule('requireApproval', ${m})">✕</button>
    </div>
  `).join(""),p=r.length===0?`
  ...
  `:r.map((g,m)=>`
    <span class="brand-badge" style="color: var(--amber-300); padding: 5px 10px; font-size: 11px; display: inline-flex; align-items: center; gap: 6px;">
      ${O(g)}
      <span style="cursor: pointer; color: var(--red-400); font-weight: bold;" onclick="window.app.removePolicyRule('redact', ${m})">✕</span>
    </span>
  `).join("");return`
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 18px;">
      <div>
  ...
  `}function O(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function K(){let e=s.getState(),t=e.config,o=Object.entries(t.capabilityAliases||{}),n=Object.entries(t.resourceAliases||{}),r=Object.entries(t.promptAliases||{}),i="";if(o.length===0&&n.length===0&&r.length===0)i=`
  ...
  "ref_id": "\${steps[0].result.id}"
        ...
        `;else r.innerHTML=n.map((i)=>{let a=i.uri?i.uri.split(":")[0]:"res";return`
          ...
          `}).join("")}async executeReadResource(){let e=s.getState(),t=e.selectedResourceId||(e.resources[0]?e.resources[0].id:null);if(!t)return;let o=document.getElementById("pg-res-jsonpath-input")?.value.trim()||void 0,n=document.getElementById("pg-res-lines-input")?.value.trim()||void 0,r=document.getElementById("pg-res-bytes-input")?.value.trim()||void 0,i={resource_id:t};if(o)i._jsonpath=o;if(n&&!isNaN(Number(n)))i._limit_lines=Number(n);if(r&&!isNaN(Number(r)))i._truncate_bytes=Number(r);try{let a=await u.readResource(i);s.setState({resourceReadResult:{status:a.status,durationMs:a.durationMs,data:a.data}}),s.addEventLog("POST",`/v1/resources/read → ${t}`,a.status===200?"200 OK":`HTTP ${a.status}`,`${a.durationMs.toFixed(1)}ms`)}catch(a){s.setState({resourceReadResult:{status:500,durationMs:0,data:{error:a.toString()}}})}}selectPrompt(e){s.setState({selectedPromptId:e,promptGetResult:null})}filterPrompts(e){let t=e.toLowerCase().trim(),n=(s.getState().prompts||[]).filter((i)=>i.id.toLowerCase().includes(t)||i.name&&i.name.toLowerCase().includes(t)||i.description&&i.description.toLowerCase().includes(t)||i.server&&i.server.toLowerCase().includes(t)),r=document.getElementById("pg-prompt-list");if(r)if(n.length===0)r.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No prompts match "${v(e)}"
          </div>
        `;else r.innerHTML=n.map((i)=>{let a=i.arguments?i.arguments.length:0;return`
            <div class="cap-item ${i.id===s.getState().selectedPromptId?"active":""}" onclick="window.app.selectPrompt('${v(i.id)}')">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${v(i.name||i.id)}</span>
                <span class="badge" style="font-size: 9.5px; background: rgba(168, 85, 247, 0.15); color: var(--purple-400);">${a} args</span>
              </div>
              <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">${v(i.description||i.title||"Prompt template")}</div>
              <div style="font-size: 10px; color: var(--text-muted); margin-top: 4px;">server: ${v(i.server||"local")}</div>
            </div>
          `}).join("")}async executeGetPrompt(){let e=s.getState(),t=e.selectedPromptId||(e.prompts[0]?e.prompts[0].id:null);if(!t)return;let o=document.querySelectorAll(".prompt-arg-input"),n={};o.forEach((r)=>{let i=r,a=i.getAttribute("data-arg-name");if(a&&i.value.trim())n[a]=i.value.trim()});try{let r=await u.getPrompt({prompt_id:t,arguments:n});s.setState({promptGetResult:{status:r.status,durationMs:r.durationMs,data:r.data}}),s.addEventLog("POST",`/v1/prompts/get → ${t}`,r.status===200?"200 OK":`HTTP ${r.status}`,`${r.durationMs.toFixed(1)}ms`)}catch(r){s.setState({promptGetResult:{status:500,durationMs:0,data:{error:r.toString()}}})}}toggleBatchPlayground(){let e=document.getElementById("pg-args-input");if(!e)return;let t=[{id:"step_1",capability_id:"sqlite.read_query",args:{query:"SELECT * FROM users LIMIT 2"}},{id:"step_2",capability_id:"github.issues.search",args:{query:"label:bug"},continue_on_error:!0}];e.value=JSON.stringify(t,null,2)}async submitPolicyRule(e){let t=e==="allow"?"policy-new-allow":e==="deny"?"policy-new-deny":"policy-new-redact",o=document.getElementById(t);if(!o)return;let n=o.value.trim();if(!n)return;await this.addPolicyRule(e,n),o.value=""}async addPolicyRule(e,t){let o=(t||"").trim();if(!o)return;let r=s.getState().config.policy||{},i=[...r.allow||[]],a=[...r.deny||[]],d=[...r.redact_keys||r.redactKeys||[]];if(e==="allow"&&!i.includes(o))i.push(o);if(e==="deny"&&!a.includes(o))a.push(o);if(e==="redact"&&!d.includes(o))d.push(o);let l=await u.savePolicy({allow:i,deny:a,redact_keys:d,redactKeys:d});if(!l.ok)alert(`Failed to save policy rule: ${l.error||"Unknown error"}`);await this.refreshData()}async removePolicyRule(e,t){let n=s.getState().config.policy||{},r=[...n.allow||[]],i=[...n.deny||[]],a=[...n.redact_keys||n.redactKeys||[]];if(e==="allow")r.splice(t,1);if(e==="deny")i.splice(t,1);if(e==="redact")a.splice(t,1);let d=await u.savePolicy({allow:r,deny:i,redact_keys:a,redactKeys:a});if(!d.ok)alert(`Failed to update policy: ${d.error||"Unknown error"}`);await this.refreshData()}testPolicySandbox(e){let t=document.getElementById("policy-test-verdict");if(!t)return;let o=e.trim();if(!o){t.textContent="ENTER ID",t.style.color="var(--text-dim)";return}let r=s.getState().config.policy||{},i=r.deny||[],a=r.allow||[],d=(l,p)=>{if(l==="*")return!0;if(l.endsWith("*"))return p.startsWith(l.slice(0,-1));return l===p};if(i.some((l)=>d(l,o))){t.textContent="DENIED (Strict Block)",t.style.color="var(--red-400)";return}if(a.length>0&&!a.some((l)=>d(l,o))){t.textContent="DENIED (Not in Allow List)",t.style.color="var(--red-400)";return}t.textContent="ALLOWED",t.style.color="var(--green-400)"}async deleteServer(e){if(!confirm(`Are you sure you want to remove server '${e}' from config?`))return;await u.deleteServer(e),await this.refreshData()}openAddServerModal(){this.closeModals();let e=document.getElementById("modal-srv-title"),t=document.getElementById("modal-srv-template-banner"),o=document.getElementById("modal-srv-name"),n=document.getElementById("modal-srv-transport"),r=document.getElementById("modal-srv-command"),i=document.getElementById("modal-srv-url"),a=document.getElementById("modal-srv-ft"),d=document.getElementById("modal-srv-cd"),l=document.getElementById("modal-srv-autorestart"),p=document.getElementById("modal-srv-maxrestarts");if(e)e.textContent="Add Upstream MCP Server";if(t)t.style.display="flex";if(o)o.value="",o.disabled=!1;if(n)n.value="stdio";if(r)r.value="";if(i)i.value="";let g=document.getElementById("modal-group-cmd"),m=document.getElementById("modal-group-url");if(g)g.style.display="block";if(m)m.style.display="none";if(a)a.value="3";if(d)d.value="30000";if(l)l.value="true";if(p)p.value="5";let x=document.getElementById("modal-add-server");if(x)x.classList.add("active")}openEditServerModal(e){this.closeModals();let t=s.getState(),o=t.config.mcpServers?.[e];if(!o){alert(`Server '${e}' not found in configuration.`);return}let n=document.getElementById("modal-srv-title"),r=document.getElementById("modal-srv-template-banner"),i=document.getElementById("modal-srv-name"),a=document.getElementById("modal-srv-transport"),d=document.getElementById("modal-srv-command"),l=document.getElementById("modal-srv-url"),p=document.getElementById("modal-srv-ft"),g=document.getElementById("modal-srv-cd"),m=document.getElementById("modal-srv-autorestart"),x=document.getElementById("modal-srv-maxrestarts");if(n)n.textContent=`Edit Server '${e}'`;if(r)r.style.display="none";if(i)i.value=e,i.disabled=!0;let w=!!o.command;if(a)a.value=w?"stdio":"http";let h=document.getElementById("modal-group-cmd"),k=document.getElementById("modal-group-url");if(h)h.style.display=w?"block":"none";if(k)k.style.display=w?"none":"block";if(d)d.value=w?`${o.command} ${(o.args||[]).join(" ")}`.trim():"";if(l)l.value=o.url||"";let $=o.resilience||t.config.resilience;if(p)p.value=String($?.failureThreshold??3);if(g)g.value=String($?.cooldownMs??30000);if(m)m.value=$?.autoRestart===!1?"false":"true";if(x)x.value=String($?.maxRestarts??5);let f=document.getElementById("modal-add-server");if(f)f.classList.add("active")}async submitAddServer(){let e=document.getElementById("modal-srv-name")?.value.trim(),t=document.getElementById("modal-srv-transport")?.value;if(!e){alert("Server name is required");return}let o={};if(t==="stdio"){let p=(document.getElementById("modal-srv-command")?.value.trim()).split(/\s+/).filter(Boolean);if(p.length===0){alert("Command is required");return}o.command=p[0],o.args=p.slice(1)}else{let l=document.getElementById("modal-srv-url")?.value.trim();if(!l){alert("URL is required");return}o.url=l}let n=document.getElementById("modal-srv-ft")?.value.trim(),r=document.getElementById("modal-srv-cd")?.value.trim(),i=document.getElementById("modal-srv-autorestart")?.value,a=document.getElementById("modal-srv-maxrestarts")?.value.trim();if(n||r||i||a)o.resilience={failureThreshold:n?Number(n):3,cooldownMs:r?Number(r):30000,autoRestart:i!=="false",maxRestarts:a?Number(a):5};let d=await u.upsertServer(e,o);if(d.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${d.error}`)}openTemplateCatalog(){this.closeModals();let e=document.getElementById("modal-templates");if(e)e.classList.add("active");this.renderTemplateGrid()}setTemplateCategory(e){this.activeTemplateCategory=e,document.querySelectorAll(".tmpl-cat-btn").forEach((t)=>{if(t.getAttribute("data-category")===e)t.classList.add("active"),t.style.background="var(--surface-elevated)",t.style.color="var(--amber-400)";else t.classList.remove("active"),t.style.background="var(--surface-card)",t.style.color="var(--text-main)"}),this.renderTemplateGrid()}filterTemplates(e){this.activeTemplateFilter=e.toLowerCase().trim(),this.renderTemplateGrid()}renderTemplateGrid(){let e=document.getElementById("tmpl-grid");if(!e)return;let t=M.filter((r)=>{let i=this.activeTemplateCategory==="all"||r.category===this.activeTemplateCategory,a=!this.activeTemplateFilter||r.name.toLowerCase().includes(this.activeTemplateFilter)||r.id.toLowerCase().includes(this.activeTemplateFilter)||r.description.toLowerCase().includes(this.activeTemplateFilter)||r.command.toLowerCase().includes(this.activeTemplateFilter)||r.envFields.some((d)=>d.key.toLowerCase().includes(this.activeTemplateFilter));return i&&a});if(t.length===0){e.innerHTML=`
        <div style="grid-column: span 2; padding: 32px; text-align: center; color: var(--text-dim);">
          No matching MCP server templates found.
        </div>
      `;return}let n=s.getState().config.mcpServers||{};e.innerHTML=t.map((r)=>{let i=!!n[r.id],a=`${r.command} ${r.defaultArgs.join(" ")}`;return`
        <div class="bento-card" style="display: flex; flex-direction: column; justify-content: space-between; padding: 14px; background: var(--surface); border: 1px solid var(--border); transition: transform 0.15s, border-color 0.15s;">
          <div>
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px;">
              <div style="display: flex; align-items: center; gap: 8px;">
                <span style="font-weight: 700; font-size: 13.5px; color: var(--text-main);">${v(r.name)}</span>
                <span class="brand-badge" style="font-size: 9.5px; padding: 1px 6px;">${v(r.badge)}</span>
              </div>
              ${i?'<span style="font-size: 10px; color: var(--green-400); font-weight: 600;">CONNECTED</span>':""}
            </div>
            ...
            ${r.envFields.length>0?`
              <div style="font-size: 10.5px; color: var(--amber-400); margin-top: 6px; display: flex; align-items: center; gap: 4px;">
                <span>⚡ Needs:</span>
                <code>${r.envFields.map((d)=>v(d.key)).join(", ")}</code>
              </div>
            `:""}
          </div>

          <div style="display: flex; justify-content: flex-end; margin-top: 12px; gap: 6px;">
            <button class="btn btn-primary" style="font-size: 11.5px; padding: 4px 10px;" onclick="window.app.selectTemplate('${v(r.id)}')">
              ${i?"Configure Another":"✨ 1-Click Setup"}
            </button>
          </div>
        </div>
      `}).join("")}selectTemplate(e){let t=M.find((a)=>a.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let o=document.getElementById("modal-configure-template");if(o)o.classList.add("active");let n=document.getElementById("cfg-tmpl-title"),r=document.getElementById("cfg-tmpl-desc"),i=document.getElementById("cfg-tmpl-form");if(n)n.textContent=`Configure ${t.name} Server`;if(r)r.textContent=t.description;if(i){let a="";if(t.envFields.length>0)a=`
      ...
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),o=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}let n=o?o.split(/\s+/).filter(Boolean):[],r={},i=document.querySelectorAll(".tmpl-env-input");for(let x of Array.from(i)){let w=x.getAttribute("data-key"),h=x.value.trim(),k=e.envFields.find(($)=>$.key===w);if(k?.required&&!h){alert(`Required field '${k.label}' is missing.`);return}if(w&&h)r[w]=h}let a={command:e.command,args:n};if(Object.keys(r).length>0)a.env=r;let d=document.getElementById("cfg-srv-ft")?.value.trim(),l=document.getElementById("cfg-srv-cd")?.value.trim(),p=document.getElementById("cfg-srv-autorestart")?.value,g=document.getElementById("cfg-srv-maxrestarts")?.value.trim();if(d||l||p||g)a.resilience={failureThreshold:d?Number(d):3,cooldownMs:l?Number(l):30000,autoRestart:p!=="false",maxRestarts:g?Number(g):5};let m=await u.upsertServer(t,a);if(m.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${m.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let o=await u.getEcosystemSources();if(o.sources&&o.sources.length>0)t.innerHTML=o.sources.map((n)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await u.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let o=(e||"").trim().toLowerCase();if(o.length<2){t.style.display="none";return}let r=s.getState().capabilities.filter((i)=>i.id.toLowerCase().includes(o)||i.summary&&i.summary.toLowerCase().includes(o)||i.description&&i.description.toLowerCase().includes(o)||i.server&&i.server.toLowerCase().includes(o)).slice(0,8);if(r.length===0){t.style.display="none";return}t.innerHTML=r.map((i)=>`
