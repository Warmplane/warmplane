class N{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],capabilities:[],resources:[],prompts:[],catalogEvents:[],approvals:[],auditEvents:[],auditTotal:0,auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:25,offset:0},auditSelectedEvent:null,auditStats:null,auditVerification:null,selectedCapabilityId:null,selectedResourceId:null,selectedPromptId:null,playgroundMode:"tools",isExecuting:!1,activeRequestId:null,isBatchModalOpen:!1,batchSteps:[{id:"step_1",capability_id:"",argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],activeTab:"overview",activeProfile:null,eventLogs:[],executionResult:null,resourceReadResult:null,promptGetResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,r,o){let n=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:r,latency:o},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:n})}}var l=new N;class D{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/capabilities`,{headers:t})).json()}async listResources(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/resources`,{headers:t})).json()}async readResource(e,t){let r=performance.now(),o={"Content-Type":"application/json"};if(t)o["X-Warmplane-Profile"]=t;let i=await fetch(`${this.baseUrl}/v1/resources/read`,{method:"POST",headers:o,body:JSON.stringify(e)}),n=performance.now()-r,a=await i.json();return{status:i.status,durationMs:n,data:a}}async listPrompts(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/prompts`,{headers:t})).json()}async getPrompt(e,t){let r=performance.now(),o={"Content-Type":"application/json"};if(t)o["X-Warmplane-Profile"]=t;let i=await fetch(`${this.baseUrl}/v1/prompts/get`,{method:"POST",headers:o,body:JSON.stringify(e)}),n=performance.now()-r,a=await i.json();return{status:i.status,durationMs:n,data:a}}async getCatalogEvents(e){let t=e?`?after=${encodeURIComponent(e)}`:"";return(await fetch(`${this.baseUrl}/v1/catalog/events${t}`)).json()}async callCapability(e,t){let r=performance.now(),o={"Content-Type":"application/json"};if(t)o["X-Warmplane-Profile"]=t;let i=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:o,body:JSON.stringify(e)}),n=performance.now()-r,a=await i.json();return{status:i.status,durationMs:n,data:a}}async batchCallCapabilities(e,t){let r=performance.now(),o={"Content-Type":"application/json"};if(t)o["X-Warmplane-Profile"]=t;let i=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:o,body:JSON.stringify({steps:e})}),n=performance.now()-r,a=await i.json();return{status:i.status,durationMs:n,data:a}}async cancelOperation(e){return(await fetch(`${this.baseUrl}/v1/operations/${encodeURIComponent(e)}/cancel`,{method:"POST"})).json()}async completeArgument(e){return(await fetch(`${this.baseUrl}/v1/completion/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async upsertProfile(e,t,r){return(await fetch(`${this.baseUrl}/v1/config/profiles`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,servers:t,description:r})})).json()}async deleteProfile(e){return(await fetch(`${this.baseUrl}/v1/config/profiles/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,r){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:r})})).json()}async rejectTicket(e,t,r){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:r})})).json()}async updateAlias(e,t,r){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:r})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")t.set("server_id",e.server_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")t.set("event_type",e.event_type);if(e?.status&&e.status!=="all")t.set("status",e.status);if(e?.trace_id)t.set("trace_id",e.trace_id);if(e?.request_id)t.set("request_id",e.request_id);if(e?.search)t.set("search",e.search);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset!==void 0)t.set("offset",String(e.offset));let r=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${r?`?${r}`:""}`)).json()}getAuditExportUrl(e,t="csv"){let r=new URLSearchParams;if(r.set("format",t),e?.actor_id)r.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")r.set("server_id",e.server_id);if(e?.capability_id)r.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")r.set("event_type",e.event_type);if(e?.status&&e.status!=="all")r.set("status",e.status);if(e?.trace_id)r.set("trace_id",e.trace_id);if(e?.request_id)r.set("request_id",e.request_id);if(e?.search)r.set("search",e.search);return`${this.baseUrl}/v1/audit/export?${r.toString()}`}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}}var u=new D;function E(){let e=l.getState(),t=e.config.mcpServers||{},r=Object.keys(t),o=r.length,i="";if(r.length===0)i=`
    ...
    `;else i=r.map((f)=>{let A=t[f],q=A.command?"stdio":"http / sse",R=A.command?`${A.command} ${(A.args||[]).join(" ")}`:A.url,z=e.serverStatuses[f]||{status:"connected",protocol_version:"2026-07-28"},m=z.status==="degraded",M=z.status==="error"||z.status==="disconnected",T=m?"var(--amber-400)":M?"var(--red-400)":"var(--green-400)";return`
        <div class="bento-card col-4" style="background: var(--surface); border: 1px solid var(--border);">
          ...
          <div style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--text-dim); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; margin-bottom: 12px;" title="${P(R||"")}">
            ${P(R||"")}
          </div>
          <div style="display: flex; justify-content: space-between; font-size: 11px; color: var(--text-muted); border-top: 1px solid var(--border); padding-top: 8px;">
            <span>Status: <strong style="color: ${T};">${P(z.status)}</strong></span>
  ...
  `:e.eventLogs.map((f)=>`
    <div class="feed-row" style="grid-template-columns: 80px 100px 1fr 100px 80px;">
      <span style="color: var(--text-dim);">${P(f.time)}</span>
      <span style="color: var(--cyan-400); font-weight: 600;">${P(f.method)}</span>
      <span style="color: var(--text-main); font-family: var(--ff-mono);">${P(f.target)}</span>
      <span style="color: var(--green-400);">${P(f.status)}</span>
      <span style="color: var(--amber-300); text-align: right;">${P(f.latency)}</span>
    </div>
  `).join(""),a=e.metrics,s=a.totalCatalogRequests,p=a.totalEtagHits,d=s>0?`${(p/s*100).toFixed(1)}%`:"0.0%",c=s>0?`${p} of ${s} requests served via HTTP 304`:"Waiting for client requests",v=a.totalToolCalls,y=v>0?`${(a.totalToolDurationUs/v/1000).toFixed(1)}ms`:"0.0ms",_=v>0?`${v} tool executions processed`:"Local worker task queues warm",h=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,k=h>0?`${h*18}B / call`:"0B",w=h>0?`${h} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size";return`
  ...
  `}function P(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function U(){let e=l.getState(),t=e.config.mcpServers||{},r=Object.keys(t),o="";if(r.length===0)o=`
    ...
    `;else o=r.map((i)=>{let n=t[i],a=n.command?"stdio":"http / sse",s=n.command?`${n.command} ${(n.args||[]).join(" ")}`:n.url,p=e.serverStatuses[i]||{status:"connected",protocol_version:"2026-07-28"},d=n.env?Object.keys(n.env).map((f)=>`${f}=***`).join(", "):"None",c=(e.circuitBreakers||[]).find((f)=>f.server_id===i),v='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(c){if(c.state==="open")v=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${c.consecutive_failures} failures)</span>`;else if(c.state==="half_open")v=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${c.consecutive_successes} probe)</span>`}let y=n.resilience||e.config.resilience,_=y?`FT: ${y.failureThreshold||3} · Cooldown: ${(y.cooldownMs||30000)/1000}s · AutoRestart: ${y.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience",h=p.status==="degraded",k=p.status==="error"||p.status==="disconnected",w=h?"var(--amber-400)":k?"var(--red-400)":"var(--green-400)";return`
        <div class="bento-card" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
          <div>
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
              ...
              <span style="font-size: 15px; font-weight: 700; color: var(--text-main);">${C(i)}</span>
              <span class="brand-badge">${a}</span>
              <span class="brand-badge" style="color: ${w}; border-color: rgba(245, 158, 11, 0.3);">Status: ${C(p.status)}</span>
            ...
            <div style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted); margin-top: 4px;">
              ${n.command?"Command: ":"URL: "}<code>${C(s||"")}</code>
            </div>
            <div style="display: flex; gap: 14px; font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim); margin-top: 4px;">
              <span>\uD83D\uDEE1️ ${C(_)}</span>
              ${n.env&&Object.keys(n.env).length>0?`<span>Env: ${C(d)}</span>`:""}
            </div>
          </div>
          <div style="display: flex; gap: 8px;">
            <button class="btn btn-ghost" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.openEditServerModal('${C(i)}')">✏️ Edit</button>
            <button class="btn btn-danger" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.deleteServer('${C(i)}')">Remove</button>
          </div>
        </div>
      `}).join("");return`
    ...
    ${o}
  `}function C(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function F(){let e=l.getState(),t=e.playgroundMode||"tools",r=e.capabilities||[],o=e.resources||[],i=e.prompts||[],n=`
  ...
  `;if(t==="resources")return`
    ...
    ${n}
    ${ee(e)}
    ${e.isBatchModalOpen?re(e):""}
  `}function ee(e){let t=e.capabilities||[],r=e.selectedCapabilityId||(t.length>0?t[0].id:null),o=t.find((s)=>s.id===r),i=!!e.isExecuting,n="";if(t.length===0)n=`
    ...
    `;else n=t.map((s)=>{return`
        <div class="cap-item ${s.id===r?"active":""}" onclick="window.app.selectCapability('${g(s.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${g(s.id)}</span>
            <span style="font-size: 10px; color: var(--green-400);">${g(s.mode||"read")}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">server: ${g(s.server||"local")}</div>
        </div>
      `}).join("");let a=o&&o.input_schema?JSON.stringify(o.input_schema.properties||{},null,2):"{}";return`
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);" id="pg-selected-title">
              ${g(o?o.id:"No Capability Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);" id="pg-selected-desc">
              ${g(o?o.summary||o.description:"Connect servers to inspect and execute tools")}
            </div>
          </div>
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
          ...
          <div style="padding: 16px; border-right: 1px solid var(--border); overflow-y: auto;">
            ...
            <textarea class="form-textarea" rows="7" id="pg-args-input">${g(a)}</textarea>
            ...
            ${o&&o.input_schema?`
              <div style="margin-top: 14px;">
                ...
                <pre style="background: var(--surface); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-size: 11px; color: var(--text-muted); max-height: 140px; overflow-y: auto;">${g(JSON.stringify(o.input_schema,null,2))}</pre>
              </div>
            `:""}
          </div>
          ...
          <div style="padding: 16px; background: var(--bg-app); display: flex; flex-direction: column; overflow: hidden;">
            ...
            <pre id="pg-response-json" style="flex: 1; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; color: var(--amber-300); font-size: 11.5px; overflow-y: auto; margin: 0; white-space: pre-wrap; word-break: break-word;">${e.executionResult?g(JSON.stringify(e.executionResult.data,null,2)):"// Response envelope output will be formatted here"}</pre>
          </div>
        </div>
      </div>
    </div>
  `}function te(e){let t=e.resources||[],r=e.selectedResourceId||(t.length>0?t[0].id:null),o=t.find((a)=>a.id===r),i=e.resourceReadResult,n="";if(t.length===0)n=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No resources exposed by connected MCP servers.
      </div>
    `;else n=t.map((a)=>{let s=a.id===r?"active":"",p=a.uri?a.uri.split(":")[0]:"res";return`
        <div class="cap-item ${s}" onclick="window.app.selectResource('${g(a.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${g(a.name||a.id)}</span>
            <span class="badge" style="font-size: 9.5px; background: rgba(56, 189, 248, 0.15); color: var(--cyan-400);">${g(p)}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${g(a.uri)}</div>
          <div style="display: flex; justify-content: space-between; font-size: 10px; color: var(--text-muted); margin-top: 4px;">
            <span>server: ${g(a.server||"local")}</span>
            <span>${g(a.mime_type||"text/plain")}</span>
          </div>
        </div>
      `}).join("");return`
        ...
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${g(o?o.name||o.id:"No Resource Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--cyan-400); font-family: var(--ff-mono);">
              ${g(o?o.uri:"Select a resource from the list to read live content")}
            </div>
          </div>
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
            ...
            ${o?`
              <div style="background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border); margin-bottom: 14px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; font-size: 11.5px;">
                  <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--text-main);">${g(o.server)}</strong></div>
                  <div><span style="color: var(--text-muted);">MIME Type:</span> <strong style="color: var(--text-main);">${g(o.mime_type||"text/plain")}</strong></div>
                </div>
                ${o.description?`
          ...
          <div style="padding: 16px; background: var(--bg-app); display: flex; flex-direction: column; overflow: hidden;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
              ...
              <span style="font-size: 11px; font-weight: 600; color: ${i?i.status===200?"var(--green-400)":"var(--red-400)":"var(--text-dim)"}; font-family: var(--ff-mono);">
                ${i?`HTTP ${i.status} · ${i.durationMs.toFixed(1)}ms`:"READY"}
              </span>
            </div>
            <pre style="flex: 1; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; color: var(--cyan-400); font-size: 11.5px; overflow-y: auto; margin: 0; white-space: pre-wrap; word-break: break-word;">${i?g(JSON.stringify(i.data,null,2)):'// Click "Read Resource Content" to inspect live payload'}</pre>
          </div>
        </div>
      </div>
    </div>
  `}function ie(e){let t=e.prompts||[],r=e.selectedPromptId||(t.length>0?t[0].id:null),o=t.find((s)=>s.id===r),i=e.promptGetResult,n="";if(t.length===0)n=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No prompt templates registered by connected MCP servers.
      </div>
    `;else n=t.map((s)=>{let p=s.id===r?"active":"",d=s.arguments?s.arguments.length:0;return`
        <div class="cap-item ${p}" onclick="window.app.selectPrompt('${g(s.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${g(s.name||s.id)}</span>
            <span class="badge" style="font-size: 9.5px; background: rgba(168, 85, 247, 0.15); color: var(--purple-400);">${d} args</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">${g(s.description||s.title||"Prompt template")}</div>
          <div style="font-size: 10px; color: var(--text-muted); margin-top: 4px;">server: ${g(s.server||"local")}</div>
        </div>
      `}).join("");let a="";if(o&&o.arguments&&o.arguments.length>0)a=o.arguments.map((s)=>`
      <div class="form-group" style="margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
          <label class="form-label" style="margin: 0; font-family: var(--ff-mono);">${g(s.name)}</label>
        ...
        ${s.description?`<div style="font-size: 11px; color: var(--text-dim); margin-bottom: 4px;">${g(s.description)}</div>`:""}
        <input type="text" class="form-input prompt-arg-input" data-arg-name="${g(s.name)}" placeholder="Enter ${g(s.name)}..." />
      </div>
    `).join("");else if(o)a=`
    ...
    <div style="display: grid; grid-template-columns: 340px 1fr; gap: 16px; height: calc(100vh - 165px);">
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        <div style="padding: 14px 18px; border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center;">
          <div>
            <div style="font-size: 15px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">
              ${g(o?o.name||o.id:"No Prompt Selected")}
            </div>
            <div style="font-size: 11.5px; color: var(--text-dim);">
              ${g(o?o.description||o.title||"Bind variables and render messages":"Select a prompt from the list to test")}
            </div>
          </div>
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 24px;">
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); width: 840px; max-width: 95vw; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <div style="flex: 1; overflow-y: auto; padding: 20px;">
          ${r.map((i,n)=>{let a=t.map((s)=>`
      <option value="${g(s.id)}" ${s.id===i.capability_id?"selected":""}>
        ${g(s.id)} (${g(s.server||"local")})
      </option>
    `).join("");return`
      <div style="background: rgba(0,0,0,0.3); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-size: 11px; font-family: var(--ff-mono); color: var(--text-dim);">id: ${g(i.id)}</span>
          </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 10px;">
          ...
          <div style="display: flex; align-items: flex-end; padding-bottom: 6px;">
            <label style="display: flex; align-items: center; gap: 6px; font-size: 11.5px; color: var(--text-muted); cursor: pointer;">
              <input type="checkbox" ${i.continue_on_error?"checked":""} onchange="window.app.updateBatchStepContinueOnError(${n}, this.checked)" />
  ...
  `}function g(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function B(e){let t=e.approvals.filter((d)=>d.status==="pending"),r=e.approvals.filter((d)=>d.status!=="pending"),o=e.approvals.filter((d)=>d.status==="approved").length,i=e.approvals.filter((d)=>d.status==="rejected").length,n=e.config.policy?.require_approval||e.config.policy?.requireApproval||[],a=t.length===0?`
    ...
    <div class="bento-card" style="border: 1px solid rgba(245, 158, 11, 0.35); background: var(--surface-card); margin-bottom: 14px; padding: 18px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
        <div>
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted);">${$(d.id)}</span>
          </div>
          <div style="margin-top: 6px; display: flex; align-items: center; gap: 8px;">
            <span style="font-size: 14.5px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${$(d.capability_id)}</span>
            <span style="font-size: 11px; color: var(--text-dim);">via <span style="color: var(--cyan-400); font-family: var(--ff-mono);">${$(d.server_id)}</span></span>
          </div>
        </div>
      ...
      ${d.context||d.request_id?`
        <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; font-family: var(--ff-mono); font-size: 11px; display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px; color: var(--text-muted);">
          ${d.request_id?`<div><span style="color: var(--text-dim);">Request:</span> <span style="color: var(--text-main);">${$(d.request_id)}</span></div>`:""}
          ${d.context?.actor_id?`<div><span style="color: var(--text-dim);">Actor:</span> <span style="color: var(--cyan-400);">${$(d.context.actor_id)}</span></div>`:""}
          ${d.context?.operation_id?`<div><span style="color: var(--text-dim);">Operation:</span> <span style="color: var(--text-main);">${$(d.context.operation_id)}</span></div>`:""}
          ${d.context?.work_item_id?`<div><span style="color: var(--text-dim);">Work Item:</span> <span style="color: var(--text-main);">${$(d.context.work_item_id)}</span></div>`:""}
        </div>
      `:""}
      ...
      <div style="margin-bottom: 14px;">
        ...
        <textarea id="appr-args-${d.id}" class="form-textarea" rows="4" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px; line-height: 1.4;">${$(JSON.stringify(d.sanitized_args,null,2))}</textarea>
      </div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 12px;">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          <button class="btn btn-danger" onclick="window.app.promptReject('${$(d.id)}')">
            ✕ Reject
          </button>
          <button class="btn btn-primary" onclick="window.app.submitApproval('${$(d.id)}')">
            ✓ Approve &amp; Execute
          </button>
        </div>
      </div>
  ...
  `:n.map((d)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); margin-bottom: 6px;">
      <span style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--amber-300); font-weight: 500;">\uD83D\uDEE1️ ${$(d)}</span>
        ...
        <tbody>
          ${r.map((d)=>`
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.03); transition: background 0.15s;" onmouseover="this.style.background='var(--surface-hover)'" onmouseout="this.style.background='transparent'">
              ...
              <td style="padding: 10px 14px; font-weight: 600; color: var(--text-main);">${$(d.capability_id)}</td>
              <td style="padding: 10px 14px; color: var(--text-dim); font-size: 10.5px;">${$(d.id)}</td>
              <td style="padding: 10px 14px; color: var(--text-muted);">${$(d.operator||"system")}</td>
              <td style="padding: 10px 14px; color: ${d.reason?"var(--red-400)":"var(--text-dim)"};">${d.reason?`"${$(d.reason)}"`:"—"}</td>
  ...
  `;return`
    ...
    <div class="bento-grid">
      ...
      <div class="bento-card col-3">
        ...
        <div class="stat-value" style="color: var(--red-400);">${i}</div>
    ...
    <div class="bento-card col-12" style="margin-top: 10px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
        <div style="font-size: 11px; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.5px;">
          \uD83D\uDCDC Recent Decision History (${r.length})
        </div>
      </div>
      ${p}
    </div>
  `}function $(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function I(){let e=l.getState(),t=e.auditEvents||[],r=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},o=e.auditVerification,i=e.auditFilters,n=e.auditTotal??t.length,a=e.auditSelectedEvent,s=Object.keys(e.config?.mcpServers||{}),p=i.limit||25,d=i.offset||0,c=Math.floor(d/p)+1,v=Math.max(1,Math.ceil(n/p)),y=n===0?0:d+1,_=Math.min(d+p,n),h=u.getAuditExportUrl({actor_id:i.search?void 0:void 0,server_id:i.serverId!=="all"?i.serverId:void 0,event_type:i.eventType!=="all"?i.eventType:void 0,status:i.status!=="all"?i.status:void 0,search:i.search.trim()?i.search.trim():void 0},"csv"),k=u.getAuditExportUrl({server_id:i.serverId!=="all"?i.serverId:void 0,event_type:i.eventType!=="all"?i.eventType:void 0,status:i.status!=="all"?i.status:void 0,search:i.search.trim()?i.search.trim():void 0},"jsonl"),w=o?o.is_valid?`
  ...
  `,f=s.map((m)=>`<option value="${b(m)}" ${i.serverId===m?"selected":""}>${b(m)}</option>`).join(""),A=`
    <div class="bento-card" style="padding: 14px 16px; margin-bottom: 16px; background: rgba(18, 24, 38, 0.7); border: 1px solid var(--border);">
      <div style="display: grid; grid-template-columns: 2fr 1fr 1.2fr 1.2fr auto auto; gap: 10px; align-items: center;">
        ...
        <div>
          ...
          >
            <option value="all" ${i.status==="all"?"selected":""}>All Statuses</option>
            <option value="success" ${i.status==="success"?"selected":""}>\uD83D\uDFE2 Success</option>
            <option value="denied" ${i.status==="denied"?"selected":""}>\uD83D\uDD34 Denied</option>
            <option value="intercepted" ${i.status==="intercepted"?"selected":""}>\uD83D\uDFE1 HITL Intercept</option>
            <option value="failed" ${i.status==="failed"?"selected":""}>❌ Failed</option>
        ...
        <div>
          ...
          >
            <option value="all" ${i.eventType==="all"?"selected":""}>All Event Types</option>
            <option value="tool_execution" ${i.eventType==="tool_execution"?"selected":""}>Tool Execution</option>
            <option value="tool_intercepted_hitl" ${i.eventType==="tool_intercepted_hitl"?"selected":""}>HITL Intercept</option>
            <option value="approval_granted" ${i.eventType==="approval_granted"?"selected":""}>Approval Granted</option>
            <option value="approval_rejected" ${i.eventType==="approval_rejected"?"selected":""}>Approval Rejected</option>
            <option value="approval_expired" ${i.eventType==="approval_expired"?"selected":""}>Approval Expired</option>
            <option value="policy_violation" ${i.eventType==="policy_violation"?"selected":""}>Policy Violation</option>
            <option value="config_mutation" ${i.eventType==="config_mutation"?"selected":""}>Config Mutation</option>
            <option value="sampling_call" ${i.eventType==="sampling_call"?"selected":""}>Sampling Call</option>
            <option value="resource_access" ${i.eventType==="resource_access"?"selected":""}>Resource Access</option>
          </select>
        </div>
        ...
        <div>
          ...
          >
            <option value="all" ${i.serverId==="all"?"selected":""}>All MCP Servers</option>
            ${f}
          </select>
        </div>
  ...
  `,q=`
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: rgba(18, 24, 38, 0.5); border-radius: var(--radius-md); border: 1px solid var(--border); margin-top: 16px;">
      <div style="font-size: 12px; color: var(--text-dim); display: flex; align-items: center; gap: 8px;">
        <span>Showing <strong style="color: var(--text-main);">${y}–${_}</strong> of <strong style="color: var(--text-main);">${n}</strong> events</span>
      ...
      <div style="display: flex; align-items: center; gap: 6px;">
        ...
        <button 
          class="btn btn-ghost" 
          style="padding: 4px 8px; font-size: 11px; height: 28px;"
          ${c>=v?'disabled style="opacity: 0.4; cursor: not-allowed;"':""}
  ...
  `,R="";if(t.length===0)R=`
    ...
    `;else R=t.map((m)=>{let M=new Date(Math.floor(m.timestamp_ns/1e6)).toLocaleString(),T='<span class="badge" style="background: rgba(34, 197, 94, 0.15); color: var(--green-400); font-weight: 600;">SUCCESS</span>';if(m.status==="denied")T='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">DENIED</span>';else if(m.status==="intercepted")T='<span class="badge" style="background: rgba(234, 179, 8, 0.15); color: var(--amber-300); font-weight: 600;">HITL INTERCEPT</span>';else if(m.status==="failed")T='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">FAILED</span>';else if(m.status==="cancelled")T='<span class="badge" style="background: rgba(148, 163, 184, 0.15); color: var(--text-muted); font-weight: 600;">CANCELLED</span>';let Y=m.sanitized_args?JSON.stringify(m.sanitized_args):"-",X=m.actor_id||m.operator_id||"anonymous",Z=m.server_id||"system",V=m.capability_id||m.event_type,H=m.execution_latency_us?`${(m.execution_latency_us/1000).toFixed(1)}ms`:"-";return`
        <div class="bento-card" style="margin-bottom: 12px; padding: 16px; border: 1px solid var(--border); transition: border-color 0.15s ease;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span style="font-family: var(--ff-mono); font-size: 11px; font-weight: 700; color: var(--text-dim);">${b(m.id)}</span>
              ${T}
              <span style="font-size: 12px; font-weight: 600; color: var(--text-main);">${b(V)}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 10px;">
              <div style="font-family: var(--ff-mono); font-size: 11px; color: var(--text-muted);">${b(M)}</div>
              <button 
                class="btn btn-ghost" 
                style="padding: 2px 8px; font-size: 11px; height: 24px;" 
                onclick="window.app.selectAuditEvent('${b(m.id)}')"
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; font-size: 11.5px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 8px;">
            ...
            <div><span style="color: var(--text-muted);">Trace:</span> <code style="color: var(--cyan-400); font-size: 10.5px;">${b(m.trace_id)}</code></div>
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 6px; font-size: 10.5px; font-family: var(--ff-mono); color: var(--text-muted);">
            <div><span style="color: var(--text-dim);">prev_hash:</span> ${b(m.prev_hash.slice(0,16))}...</div>
            <div><span style="color: var(--text-dim);">hash:</span> <span style="color: var(--green-400);">${b(m.hash.slice(0,16))}...</span></div>
          </div>
        </div>
      `}).join("");let z="";if(a){let m=new Date(Math.floor(a.timestamp_ns/1e6)).toISOString();z=`
        ...
        <div class="bento-card" style="width: 100%; max-width: 720px; max-height: 85vh; display: flex; flex-direction: column; overflow: hidden; background: #0f172a; border: 1px solid var(--border); box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <h2 style="font-size: 15px; font-weight: 700; color: var(--text-main); margin: 0;">Audit Event Details (${b(a.id)})</h2>
            </div>
          ...
          <div style="padding: 20px; overflow-y: auto; display: flex; flex-direction: column; gap: 14px; font-size: 12px;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm);">
              <div><span style="color: var(--text-muted);">Timestamp:</span> <strong style="color: var(--text-main); font-family: var(--ff-mono); font-size: 11px;">${b(m)}</strong></div>
              <div><span style="color: var(--text-muted);">Status:</span> <strong style="color: var(--text-main);">${b(a.status.toUpperCase())}</strong></div>
              <div><span style="color: var(--text-muted);">Event Type:</span> <strong style="color: var(--text-main);">${b(a.event_type)}</strong></div>
              <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--cyan-400);">${b(a.server_id||"system")}</strong></div>
              <div><span style="color: var(--text-muted);">Capability:</span> <strong style="color: var(--text-main);">${b(a.capability_id||"-")}</strong></div>
              <div><span style="color: var(--text-muted);">Actor / Operator:</span> <strong style="color: var(--text-main);">${b(a.actor_id||a.operator_id||"anonymous")}</strong></div>
              <div><span style="color: var(--text-muted);">Trace ID:</span> <code style="color: var(--cyan-400);">${b(a.trace_id)}</code></div>
              <div><span style="color: var(--text-muted);">Request ID:</span> <code style="color: var(--cyan-400);">${b(a.request_id||"-")}</code></div>
              <div><span style="color: var(--text-muted);">Client IP:</span> <span style="color: var(--text-main);">${b(a.client_ip||"-")}</span></div>
            ...
            ${a.error_message?`
              <div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: var(--radius-sm); padding: 10px 12px; color: var(--red-400);">
                <div style="font-weight: 700; margin-bottom: 2px;">Error (${b(a.error_code||"ERROR")}):</div>
                <div style="font-family: var(--ff-mono); font-size: 11px;">${b(a.error_message)}</div>
              </div>
            `:""}
            ...
            <div>
              ...
              <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${b(JSON.stringify(a.sanitized_args||{},null,2))}</pre>
            </div>
            ...
            ${a.sanitized_response?`
              <div>
                ...
                <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${b(JSON.stringify(a.sanitized_response,null,2))}</pre>
              </div>
            `:""}
            ...
            <div style="background: rgba(0,0,0,0.3); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
              ...
              <div style="margin-bottom: 6px;">
                ...
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--text-dim); word-break: break-all;">${b(a.prev_hash)}</div>
              </div>
              <div>
                <span style="color: var(--text-muted); font-size: 10.5px;">Record Hash Signature (hash):</span>
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--green-400); word-break: break-all;">${b(a.hash)}</div>
              </div>
            </div>
          </div>
    ...
    ${z}
  `}function b(e){if(!e)return"";return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function K(){let t=l.getState().config.policy||{},r=t.allow||[],o=t.deny||[],i=t.redact_keys||t.redactKeys||[],n=t.require_approval||t.requireApproval||[],a=r.length===0?`
  ...
  `:r.map((c,v)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--green-400);">✔ ${O(c)}</span>
  ...
  `:o.map((c,v)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--red-400);">✖ ${O(c)}</span>
  ...
  `:n.map((c,v)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
      <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--amber-400);">\uD83D\uDEE1️ ${O(c)}</span>
  ...
  `}function O(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function J(){let e=l.getState(),t=e.config,r=Object.entries(t.capabilityAliases||{}),o=Object.entries(t.resourceAliases||{}),i=Object.entries(t.promptAliases||{}),n="";if(r.length===0&&o.length===0&&i.length===0)n=`
    ...
    `;else{for(let[a,s]of r)n+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${S(s)}</span>
  ...
  `}function S(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function G(){let e=l.getState(),t=e.config,r=t.profiles||{},o=Object.entries(r),i=t.mcpServers||{},n=e.activeProfile,a="";if(o.length===0)a=`
      <div style="padding: 40px; text-align: center; color: var(--text-dim); background: var(--surface-card); border-radius: var(--radius-md); border: 1px dashed var(--border);">
    ...
    `;else a=o.map(([s,p])=>{let d=n===s,c=p.servers.map((y)=>{return`<span class="brand-badge" style="${i[y]?"color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.25); background: rgba(34, 211, 238, 0.05);":"color: var(--red-400); border-color: rgba(248, 113, 113, 0.3); background: rgba(248, 113, 113, 0.05);"}">${j(y)}</span>`}).join(" "),v=(e.capabilities||[]).filter((y)=>p.servers.includes(y.server)).length;return`
          ...
          <div style="display: flex; justify-content: space-between; align-items: flex-start;">
            <div>
              <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
                <span style="font-size: 16px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${j(s)}</span>
            ...
            <div style="display: flex; gap: 8px; align-items: center;">
              ...
              `:`
                <button class="btn btn-primary" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.setActiveProfile('${j(s)}')">
                  Activate in UI
                </button>
              `}
              <button class="btn btn-ghost" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.openEditProfileModal('${j(s)}')">
                ✏️ Edit
              </button>
              <button class="btn btn-danger" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.deleteProfile('${j(s)}')">
                Remove
              </button>
            </div>
          </div>
    ...
    ${a}
  `}function j(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var L=[{id:"github",name:"GitHub",category:"devtools",description:"Explore repositories, issues, pull requests, branches, and commit histories.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-github"],envFields:[{key:"GITHUB_PERSONAL_ACCESS_TOKEN",label:"GitHub Personal Access Token",placeholder:"ghp_...",required:!0,description:"Classic or fine-grained token with repo scope."}]},{id:"git",name:"Git (Local)",category:"devtools",description:"Read local Git repository status, diffs, log histories, and commit changes.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-git","--repository","."],argsPlaceholder:"mcp-server-git --repository /path/to/repo",envFields:[]},{id:"filesystem",name:"Filesystem",category:"devtools",description:"Secure, sandboxed access to local files and directories for AI workflows.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-filesystem","."],argsPlaceholder:"-y @modelcontextprotocol/server-filesystem /allowed/dir1 /allowed/dir2",envFields:[]},{id:"memory",name:"Memory Graph",category:"devtools",description:"Persistent knowledge-graph based memory for multi-turn agent learning.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-memory"],envFields:[]},{id:"chrome-devtools",name:"Chrome DevTools",category:"devtools",description:"Inspect live DOM, execute scripts, read console logs, and capture network traces in Chrome.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-puppeteer"],envFields:[]},{id:"sentry",name:"Sentry",category:"devtools",description:"Query production error events, stack traces, and issue frequencies directly from Sentry.",badge:"uvx / Telemetry",command:"uvx",defaultArgs:["mcp-server-sentry"],envFields:[{key:"SENTRY_AUTH_TOKEN",label:"Sentry Auth Token",placeholder:"sntrys_...",required:!0}]},{id:"playwright",name:"Playwright Browser",category:"browser",description:"Headless / headed browser automation for scraping, form filling, and UI interaction.",badge:"Popular #1 / npx",command:"npx",defaultArgs:["-y","@executeautomation/playwright-mcp-server"],envFields:[]},{id:"puppeteer",name:"Puppeteer",category:"browser",description:"Official browser automation server for web page scraping and screenshot capture.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-puppeteer"],envFields:[]},{id:"brave-search",name:"Brave Search",category:"browser",description:"Real-time privacy-preserving web search and local point-of-interest query engine.",badge:"Official / Search",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-brave-search"],envFields:[{key:"BRAVE_API_KEY",label:"Brave Search API Key",placeholder:"BSA...",required:!0}]},{id:"tavily",name:"Tavily Search",category:"browser",description:"AI-optimized web search engine structured specifically for LLM context injection.",badge:"Community / Stdio",command:"npx",defaultArgs:["-y","@tavily/mcp-server"],envFields:[{key:"TAVILY_API_KEY",label:"Tavily API Key",placeholder:"tvly-...",required:!0}]},{id:"fetch",name:"Fetch / Web Markdown",category:"browser",description:"Download web pages, strip clutter, and convert raw HTML to clean markdown text.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-fetch"],envFields:[]},{id:"postgres",name:"PostgreSQL",category:"database",description:"Read schemas, inspect tables, and execute SQL queries against PostgreSQL databases.",badge:"Official / Database",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-postgres","postgresql://user:pass@localhost:5432/mydb"],argsPlaceholder:"-y @modelcontextprotocol/server-postgres postgresql://user:pass@localhost:5432/dbname",envFields:[]},{id:"sqlite",name:"SQLite",category:"database",description:"Local embedded SQLite query runner and schema inspector.",badge:"Official / uvx",command:"uvx",defaultArgs:["mcp-server-sqlite","--db-path","./app.db"],argsPlaceholder:"mcp-server-sqlite --db-path /path/to/database.sqlite",envFields:[]},{id:"supabase",name:"Supabase",category:"database",description:"Query database tables, manage auth policies, and inspect storage in Supabase.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@supabase/mcp-server"],envFields:[{key:"SUPABASE_ACCESS_TOKEN",label:"Supabase Personal Access Token",placeholder:"sbp_...",required:!0},{key:"SUPABASE_PROJECT_REF",label:"Supabase Project Reference ID",placeholder:"abcdefghijklmnop",required:!1}]},{id:"redis",name:"Redis",category:"database",description:"Inspect cached keys, hash sets, lists, TTLs, and pub/sub channels in Redis.",badge:"uvx / Key-Value",command:"uvx",defaultArgs:["mcp-server-redis","--url","redis://localhost:6379"],argsPlaceholder:"mcp-server-redis --url redis://localhost:6379",envFields:[]},{id:"s3",name:"AWS S3 / Cloud Storage",category:"database",description:"Browse S3 buckets, fetch object metadata, and download files from cloud storage.",badge:"uvx / Cloud Storage",command:"uvx",defaultArgs:["mcp-server-s3","--bucket","my-bucket-name"],argsPlaceholder:"mcp-server-s3 --bucket bucket-name --region us-east-1",envFields:[{key:"AWS_ACCESS_KEY_ID",label:"AWS Access Key ID",placeholder:"AKIA...",required:!0},{key:"AWS_SECRET_ACCESS_KEY",label:"AWS Secret Access Key",placeholder:"...",required:!0},{key:"AWS_REGION",label:"AWS Region",placeholder:"us-east-1",required:!1}]},{id:"linear",name:"Linear",category:"productivity",description:"Search, create, and triage Linear issues, cycles, teams, and project roadmaps.",badge:"Productivity / Stdio",command:"npx",defaultArgs:["-y","mcp-linear"],envFields:[{key:"LINEAR_API_KEY",label:"Linear API Key",placeholder:"lin_api_...",required:!0}]},{id:"slack",name:"Slack",category:"productivity",description:"Read channels, post messages, inspect threads, and search team discussions.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-slack"],envFields:[{key:"SLACK_BOT_TOKEN",label:"Slack Bot User Token",placeholder:"xoxb-...",required:!0},{key:"SLACK_TEAM_ID",label:"Slack Team ID",placeholder:"T01234567",required:!0}]},{id:"notion",name:"Notion",category:"productivity",description:"Search Notion workspace pages, read nested blocks, and query database entries.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-notion"],envFields:[{key:"NOTION_API_KEY",label:"Notion Internal Integration Token",placeholder:"secret_...",required:!0}]},{id:"jira",name:"Jira / Atlassian",category:"productivity",description:"Manage Jira issues, search JQL, read sprint statuses, and inspect boards.",badge:"uvx / Atlassian",command:"uvx",defaultArgs:["mcp-server-jira","--url","https://your-domain.atlassian.net","--email","user@example.com"],argsPlaceholder:"mcp-server-jira --url https://org.atlassian.net --email me@org.com",envFields:[{key:"JIRA_API_TOKEN",label:"Atlassian API Token",placeholder:"ATATT3...",required:!0}]},{id:"google-drive",name:"Google Drive",category:"productivity",description:"Search, list, and read documents, spreadsheets, and drive files.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-gdrive"],envFields:[{key:"GOOGLE_APPLICATION_CREDENTIALS",label:"Google Credentials JSON Path",placeholder:"/path/to/credentials.json",required:!0}]},{id:"docker",name:"Docker",category:"cloud",description:"Inspect running containers, tail container logs, list images, and manage compose services.",badge:"uvx / DevOps",command:"uvx",defaultArgs:["mcp-server-docker"],envFields:[]},{id:"kubernetes",name:"Kubernetes (K8s)",category:"cloud",description:"Query cluster pods, services, deployment status, and inspect Kubernetes logs.",badge:"Official / Stdio",command:"npx",defaultArgs:["-y","@modelcontextprotocol/server-kubernetes"],envFields:[{key:"KUBECONFIG",label:"Kubeconfig File Path (Optional)",placeholder:"~/.kube/config",required:!1}]},{id:"cloudflare",name:"Cloudflare",category:"cloud",description:"Manage Cloudflare Workers, KV namespaces, D1 databases, Vectorize indexes, and DNS.",badge:"Official / Cloudflare",command:"npx",defaultArgs:["-y","@cloudflare/mcp-server-cloudflare"],envFields:[{key:"CLOUDFLARE_API_TOKEN",label:"Cloudflare API Token",placeholder:"...",required:!0},{key:"CLOUDFLARE_ACCOUNT_ID",label:"Cloudflare Account ID",placeholder:"...",required:!0}]},{id:"terraform",name:"Terraform",category:"cloud",description:"Inspect Terraform state files, resource dependency graphs, and plan previews.",badge:"uvx / IaC",command:"uvx",defaultArgs:["mcp-server-terraform"],envFields:[]}];class W{activeTemplateCategory="all";activeTemplateFilter="";selectedTemplate=null;async init(){let e=window.location.port?`:${window.location.port}`:"",t=document.getElementById("daemon-port-label");if(t)t.textContent=`Daemon ${e}`;await this.refreshData(),this.initSSE(),this.render(),l.subscribe(()=>{this.render()})}auditSearchTimeout=null;async refreshData(){try{let e=l.getState(),t=e.auditFilters,r=e.activeProfile||void 0,[o,i,n,a,s,p,d,c]=await Promise.all([u.getConfig(),u.listCapabilities(r),u.listResources(r),u.listPrompts(r),u.getCatalogEvents(),u.listApprovals(),u.listAuditEvents({server_id:t.serverId!=="all"?t.serverId:void 0,event_type:t.eventType!=="all"?t.eventType:void 0,status:t.status!=="all"?t.status:void 0,search:t.search.trim()?t.search.trim():void 0,limit:t.limit,offset:t.offset}),u.getAuditStats()]);if(o.ok)l.setState({configPath:o.config_path,config:o.config,serverStatuses:o.server_statuses||{},circuitBreakers:o.circuit_breakers||[],metrics:{totalCatalogRequests:o.metrics?.total_catalog_requests||0,totalEtagHits:o.metrics?.total_etag_hits||0,totalToolCalls:o.metrics?.total_tool_calls||0,totalToolDurationUs:o.metrics?.total_tool_duration_us||0}});if(i&&Array.isArray(i.capabilities))l.setState({capabilities:i.capabilities});if(n&&Array.isArray(n.resources))l.setState({resources:n.resources});if(a&&Array.isArray(a.prompts))l.setState({prompts:a.prompts});if(s&&Array.isArray(s.events))l.setState({catalogEvents:s.events});if(p&&Array.isArray(p.approvals))l.setState({approvals:p.approvals});if(d&&Array.isArray(d.events))l.setState({auditEvents:d.events,auditTotal:d.total??d.events.length});if(c&&c.ok)l.setState({auditStats:c})}catch(e){console.error("Failed to fetch daemon state:",e)}}async refreshAuditEvents(){try{let t=l.getState().auditFilters,[r,o]=await Promise.all([u.listAuditEvents({server_id:t.serverId!=="all"?t.serverId:void 0,event_type:t.eventType!=="all"?t.eventType:void 0,status:t.status!=="all"?t.status:void 0,search:t.search.trim()?t.search.trim():void 0,limit:t.limit,offset:t.offset}),u.getAuditStats()]);if(r&&Array.isArray(r.events))l.setState({auditEvents:r.events,auditTotal:r.total??r.events.length});if(o&&o.ok)l.setState({auditStats:o})}catch(e){console.error("Failed to refresh audit events:",e)}}handleAuditSearchInput(e){let r={...l.getState().auditFilters,search:e,offset:0};l.setState({auditFilters:r}),clearTimeout(this.auditSearchTimeout),this.auditSearchTimeout=setTimeout(()=>{this.refreshAuditEvents()},250)}handleAuditStatusFilter(e){let t=l.getState();l.setState({auditFilters:{...t.auditFilters,status:e,offset:0}}),this.refreshAuditEvents()}handleAuditEventTypeFilter(e){let t=l.getState();l.setState({auditFilters:{...t.auditFilters,eventType:e,offset:0}}),this.refreshAuditEvents()}handleAuditServerFilter(e){let t=l.getState();l.setState({auditFilters:{...t.auditFilters,serverId:e,offset:0}}),this.refreshAuditEvents()}handleAuditPageSize(e){let t=parseInt(e,10)||25,r=l.getState();l.setState({auditFilters:{...r.auditFilters,limit:t,offset:0}}),this.refreshAuditEvents()}clearAuditFilters(){let e=l.getState();l.setState({auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:e.auditFilters.limit||25,offset:0}}),this.refreshAuditEvents()}auditPrevPage(){let e=l.getState(),{limit:t,offset:r}=e.auditFilters,o=Math.max(0,r-t);if(o!==r)l.setState({auditFilters:{...e.auditFilters,offset:o}}),this.refreshAuditEvents()}auditNextPage(){let e=l.getState(),{limit:t,offset:r}=e.auditFilters,o=e.auditTotal;if(r+t<o)l.setState({auditFilters:{...e.auditFilters,offset:r+t}}),this.refreshAuditEvents()}auditGoToPage(e){let t=l.getState(),{limit:r}=t.auditFilters,o=Math.max(0,(e-1)*r);l.setState({auditFilters:{...t.auditFilters,offset:o}}),this.refreshAuditEvents()}selectAuditEvent(e){if(!e){l.setState({auditSelectedEvent:null});return}let r=l.getState().auditEvents.find((o)=>o.id===e)||null;l.setState({auditSelectedEvent:r})}async verifyAuditChain(){try{let e=await u.verifyAuditChain();if(e&&e.report)l.setState({auditVerification:e.report})}catch(e){console.error("Failed to verify audit chain:",e)}}async refreshApprovals(){try{let e=await u.listApprovals();if(e&&Array.isArray(e.approvals))l.setState({approvals:e.approvals})}catch(e){console.error("Failed to refresh approvals:",e)}}initSSE(){try{let e=new EventSource("/v1/resources/updates");e.onmessage=(t)=>{l.addEventLog("SSE","/v1/resources/updates","UPDATED","0.1ms"),this.refreshData()}}catch(e){console.warn("SSE connection unavailable")}}switchTab(e){l.setState({activeTab:e}),this.refreshData()}render(){let e=l.getState(),t=document.getElementById("app-main");if(!t)return;let r=e.approvals.filter((a)=>a.status==="pending").length,o=document.getElementById("nav-approvals-badge");if(o)o.textContent=r>0?`${r}`:"",o.style.display=r>0?"inline-block":"none";document.querySelectorAll(".nav-item").forEach((a)=>{if(a.getAttribute("data-tab")===e.activeTab)a.classList.add("active");else a.classList.remove("active")});let i=document.getElementById("top-title"),n={overview:"Overview Cockpit",servers:"Server Hub & Connections",playground:"MCP Capability Playground",approvals:"Human-in-the-Loop Review Queue",audit:"WORM Audit & Compliance Ledger",policy:"Security Governance & Redaction",aliases:"Facade & Alias Studio",profiles:"Server Constellation Profiles"};if(i)i.textContent=n[e.activeTab];switch(this.renderTopProfileSelector(),e.activeTab){case"overview":t.innerHTML=E();break;case"servers":t.innerHTML=U();break;case"playground":t.innerHTML=F();break;case"approvals":t.innerHTML=B(e);break;case"audit":t.innerHTML=I();break;case"policy":t.innerHTML=K();break;case"aliases":t.innerHTML=J();break;case"profiles":t.innerHTML=G();break}}async submitApproval(e){let t=document.getElementById(`appr-operator-${e}`),r=document.getElementById(`appr-args-${e}`),o=t?.value.trim()||"security-operator",i=void 0;if(r&&r.value.trim())try{i=JSON.parse(r.value.trim())}catch{alert("Invalid JSON in arguments editor");return}let n=await u.approveTicket(e,o,i);if(n.ok)await this.refreshApprovals();else alert(`Approval failed: ${n.error||"Unknown error"}`)}async promptReject(e){let t=prompt("Reason for rejection (will be returned to the calling agent):");if(t===null)return;let o=document.getElementById(`appr-operator-${e}`)?.value.trim()||"security-operator",i=await u.rejectTicket(e,o,t);if(i.ok)await this.refreshApprovals();else alert(`Rejection failed: ${i.error||"Unknown error"}`)}selectCapability(e){l.setState({selectedCapabilityId:e})}filterCapabilities(e){let t=e.toLowerCase().trim(),o=l.getState().capabilities.filter((n)=>n.id.toLowerCase().includes(t)||n.summary&&n.summary.toLowerCase().includes(t)||n.server&&n.server.toLowerCase().includes(t)),i=document.getElementById("pg-cap-list");if(i)if(o.length===0)i.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No capabilities match "${x(e)}"
          </div>
        `;else i.innerHTML=o.map((n)=>`
          <div class="cap-item ${n.id===l.getState().selectedCapabilityId?"active":""}" onclick="window.app.selectCapability('${x(n.id)}')">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${x(n.id)}</span>
              <span style="font-size: 10px; color: var(--green-400);">${x(n.mode||"read")}</span>
            </div>
            <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">server: ${x(n.server||"local")}</div>
          </div>
        `).join("")}async executePlaygroundTool(){let e=l.getState(),t=e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:null);if(!t)return;let r=document.getElementById("pg-args-input")?.value||"{}",o=document.getElementById("pg-context-input")?.value||void 0,i=document.getElementById("pg-jsonpath-input")?.value.trim()||void 0,n=document.getElementById("pg-limit-lines-input")?.value.trim()||void 0,a=document.getElementById("pg-truncate-bytes-input")?.value.trim()||void 0,s={};try{s=JSON.parse(r)}catch{alert("Invalid arguments JSON object");return}if(i)s._jsonpath=i;if(n&&!isNaN(Number(n)))s._limit_lines=Number(n);if(a&&!isNaN(Number(a)))s._truncate_bytes=Number(a);let p=`op-${Date.now()}`;l.setState({isExecuting:!0,activeRequestId:p});let d=e.activeProfile||void 0;try{let c=await u.callCapability({capability_id:t,args:s,request_id:p,context:{operation_id:o||p}},d);l.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:c.status,durationMs:c.durationMs,data:c.data}}),l.addEventLog("POST",`/v1/tools/call → ${t}`,c.status===200?"200 OK":`HTTP ${c.status}`,`${c.durationMs.toFixed(1)}ms`),u.getConfig().then((v)=>{if(v.ok&&v.circuit_breakers)l.setState({circuitBreakers:v.circuit_breakers})})}catch(c){l.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:500,durationMs:0,data:{error:c.toString()}}})}}async executeBatchPipeline(){let e=l.getState(),t=e.batchSteps||[],r=[];for(let i=0;i<t.length;i++){let n=t[i];if(!n.capability_id){alert(`Please select a capability for Step ${i+1}`);return}let a={};try{a=JSON.parse(n.argsJson||"{}")}catch{alert(`Invalid JSON in Step ${i+1} arguments`);return}r.push({id:n.id||`step_${i+1}`,capability_id:n.capability_id,args:a,continue_on_error:n.continue_on_error})}l.setState({isBatchModalOpen:!1});let o=e.activeProfile||void 0;try{let i=await u.batchCallCapabilities(r,o);l.setState({executionResult:{status:i.status,durationMs:i.durationMs,data:i.data}}),l.addEventLog("POST",`/v1/tools/batch_call (${t.length} steps)`,i.status===200?"200 OK":`HTTP ${i.status}`,`${i.durationMs.toFixed(1)}ms`)}catch(i){l.setState({executionResult:{status:500,durationMs:0,data:{error:i.toString()}}})}}async executeReadResource(){let e=l.getState(),t=e.selectedResourceId||(e.resources[0]?e.resources[0].id:null);if(!t)return;let r=document.getElementById("pg-res-jsonpath-input")?.value.trim()||void 0,o=document.getElementById("pg-res-lines-input")?.value.trim()||void 0,i=document.getElementById("pg-res-bytes-input")?.value.trim()||void 0,n={resource_id:t};if(r)n._jsonpath=r;if(o&&!isNaN(Number(o)))n._limit_lines=Number(o);if(i&&!isNaN(Number(i)))n._truncate_bytes=Number(i);let a=e.activeProfile||void 0;try{let s=await u.readResource({resource_id:t,input_responses:n},a);l.setState({resourceReadResult:{status:s.status,durationMs:s.durationMs,data:s.data}}),l.addEventLog("POST",`/v1/resources/read → ${t}`,s.status===200?"200 OK":`HTTP ${s.status}`,`${s.durationMs.toFixed(1)}ms`)}catch(s){l.setState({resourceReadResult:{status:500,durationMs:0,data:{error:s.toString()}}})}}async executeGetPrompt(){let e=l.getState(),t=e.selectedPromptId||(e.prompts[0]?e.prompts[0].id:null);if(!t)return;let r=document.querySelectorAll(".prompt-arg-input"),o={};r.forEach((n)=>{let a=n,s=a.getAttribute("data-arg-name");if(s&&a.value.trim())o[s]=a.value.trim()});let i=e.activeProfile||void 0;try{let n=await u.getPrompt({prompt_id:t,arguments:o},i);l.setState({promptGetResult:{status:n.status,durationMs:n.durationMs,data:n.data}}),l.addEventLog("POST",`/v1/prompts/get → ${t}`,n.status===200?"200 OK":`HTTP ${n.status}`,`${n.durationMs.toFixed(1)}ms`)}catch(n){l.setState({promptGetResult:{status:500,durationMs:0,data:{error:n.toString()}}})}}toggleBatchPlayground(){let e=document.getElementById("pg-args-input");if(!e)return;let t=[{id:"step_1",capability_id:"sqlite.read_query",args:{query:"SELECT * FROM users LIMIT 2"}},{id:"step_2",capability_id:"github.issues.search",args:{query:"label:bug"},continue_on_error:!0}];e.value=JSON.stringify(t,null,2)}async submitPolicyRule(e){let t=e==="allow"?"policy-new-allow":e==="deny"?"policy-new-deny":"policy-new-redact",r=document.getElementById(t);if(!r)return;let o=r.value.trim();if(!o)return;await this.addPolicyRule(e,o),r.value=""}async addPolicyRule(e,t){let r=(t||"").trim();if(!r)return;let i=l.getState().config.policy||{},n=[...i.allow||[]],a=[...i.deny||[]],s=[...i.redact_keys||i.redactKeys||[]];if(e==="allow"&&!n.includes(r))n.push(r);if(e==="deny"&&!a.includes(r))a.push(r);if(e==="redact"&&!s.includes(r))s.push(r);let p=await u.savePolicy({allow:n,deny:a,redact_keys:s,redactKeys:s});if(!p.ok)alert(`Failed to save policy rule: ${p.error||"Unknown error"}`);await this.refreshData()}async removePolicyRule(e,t){let o=l.getState().config.policy||{},i=[...o.allow||[]],n=[...o.deny||[]],a=[...o.redact_keys||o.redactKeys||[]];if(e==="allow")i.splice(t,1);if(e==="deny")n.splice(t,1);if(e==="redact")a.splice(t,1);let s=await u.savePolicy({allow:i,deny:n,redact_keys:a,redactKeys:a});if(!s.ok)alert(`Failed to update policy: ${s.error||"Unknown error"}`);await this.refreshData()}testPolicySandbox(e){let t=document.getElementById("policy-test-verdict");if(!t)return;let r=e.trim();if(!r){t.textContent="ENTER ID",t.style.color="var(--text-dim)";return}let i=l.getState().config.policy||{},n=i.deny||[],a=i.allow||[],s=(p,d)=>{if(p==="*")return!0;if(p.endsWith("*"))return d.startsWith(p.slice(0,-1));return p===d};if(n.some((p)=>s(p,r))){t.textContent="DENIED (Strict Block)",t.style.color="var(--red-400)";return}if(a.length>0&&!a.some((p)=>s(p,r))){t.textContent="DENIED (Not in Allow List)",t.style.color="var(--red-400)";return}t.textContent="ALLOWED",t.style.color="var(--green-400)"}async deleteServer(e){if(!confirm(`Are you sure you want to remove server '${e}' from config?`))return;await u.deleteServer(e),await this.refreshData()}openAddServerModal(){this.closeModals();let e=document.getElementById("modal-srv-title"),t=document.getElementById("modal-srv-template-banner"),r=document.getElementById("modal-srv-name"),o=document.getElementById("modal-srv-transport"),i=document.getElementById("modal-srv-command"),n=document.getElementById("modal-srv-url"),a=document.getElementById("modal-srv-ft"),s=document.getElementById("modal-srv-cd"),p=document.getElementById("modal-srv-autorestart"),d=document.getElementById("modal-srv-maxrestarts");if(e)e.textContent="Add Upstream MCP Server";if(t)t.style.display="flex";if(r)r.value="",r.disabled=!1;if(o)o.value="stdio";if(i)i.value="";if(n)n.value="";let c=document.getElementById("modal-group-cmd"),v=document.getElementById("modal-group-url");if(c)c.style.display="block";if(v)v.style.display="none";if(a)a.value="3";if(s)s.value="30000";if(p)p.value="true";if(d)d.value="5";let y=document.getElementById("modal-add-server");if(y)y.classList.add("active")}openEditServerModal(e){this.closeModals();let t=l.getState(),r=t.config.mcpServers?.[e];if(!r){alert(`Server '${e}' not found in configuration.`);return}let o=document.getElementById("modal-srv-title"),i=document.getElementById("modal-srv-template-banner"),n=document.getElementById("modal-srv-name"),a=document.getElementById("modal-srv-transport"),s=document.getElementById("modal-srv-command"),p=document.getElementById("modal-srv-url"),d=document.getElementById("modal-srv-ft"),c=document.getElementById("modal-srv-cd"),v=document.getElementById("modal-srv-autorestart"),y=document.getElementById("modal-srv-maxrestarts");if(o)o.textContent=`Edit Server '${e}'`;if(i)i.style.display="none";if(n)n.value=e,n.disabled=!0;let _=!!r.command;if(a)a.value=_?"stdio":"http";let h=document.getElementById("modal-group-cmd"),k=document.getElementById("modal-group-url");if(h)h.style.display=_?"block":"none";if(k)k.style.display=_?"none":"block";if(s)s.value=_?`${r.command} ${(r.args||[]).join(" ")}`.trim():"";if(p)p.value=r.url||"";let w=r.resilience||t.config.resilience;if(d)d.value=String(w?.failureThreshold??3);if(c)c.value=String(w?.cooldownMs??30000);if(v)v.value=w?.autoRestart===!1?"false":"true";if(y)y.value=String(w?.maxRestarts??5);let f=document.getElementById("modal-add-server");if(f)f.classList.add("active")}async submitAddServer(){let e=document.getElementById("modal-srv-name"),t=e?.value.trim(),r=document.getElementById("modal-srv-transport")?.value;if(!t){alert("Server name is required");return}if(e&&!e.disabled){if((l.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists in configuration. Do you want to overwrite it?`))return}}let o={};if(r==="stdio"){let c=(document.getElementById("modal-srv-command")?.value.trim()).split(/\s+/).filter(Boolean);if(c.length===0){alert("Command is required");return}o.command=c[0],o.args=c.slice(1)}else{let d=document.getElementById("modal-srv-url")?.value.trim();if(!d){alert("URL is required");return}o.url=d}let i=document.getElementById("modal-srv-ft")?.value.trim(),n=document.getElementById("modal-srv-cd")?.value.trim(),a=document.getElementById("modal-srv-autorestart")?.value,s=document.getElementById("modal-srv-maxrestarts")?.value.trim();if(i||n||a||s)o.resilience={failureThreshold:i?Number(i):3,cooldownMs:n?Number(n):30000,autoRestart:a!=="false",maxRestarts:s?Number(s):5};let p=await u.upsertServer(t,o);if(p.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${p.error}`)}openTemplateCatalog(){this.closeModals();let e=document.getElementById("modal-templates");if(e)e.classList.add("active");this.renderTemplateGrid()}setTemplateCategory(e){this.activeTemplateCategory=e,document.querySelectorAll(".tmpl-cat-btn").forEach((t)=>{if(t.getAttribute("data-category")===e)t.classList.add("active"),t.style.background="var(--surface-elevated)",t.style.color="var(--amber-400)";else t.classList.remove("active"),t.style.background="var(--surface-card)",t.style.color="var(--text-main)"}),this.renderTemplateGrid()}filterTemplates(e){this.activeTemplateFilter=e.toLowerCase().trim(),this.renderTemplateGrid()}renderTemplateGrid(){let e=document.getElementById("tmpl-grid");if(!e)return;let t=L.filter((i)=>{let n=this.activeTemplateCategory==="all"||i.category===this.activeTemplateCategory,a=!this.activeTemplateFilter||i.name.toLowerCase().includes(this.activeTemplateFilter)||i.id.toLowerCase().includes(this.activeTemplateFilter)||i.description.toLowerCase().includes(this.activeTemplateFilter)||i.command.toLowerCase().includes(this.activeTemplateFilter)||i.envFields.some((s)=>s.key.toLowerCase().includes(this.activeTemplateFilter));return n&&a});if(t.length===0){e.innerHTML=`
        <div style="grid-column: span 2; padding: 32px; text-align: center; color: var(--text-dim);">
          No matching MCP server templates found.
        </div>
      `;return}let o=l.getState().config.mcpServers||{};e.innerHTML=t.map((i)=>{let n=!!o[i.id],a=`${i.command} ${i.defaultArgs.join(" ")}`;return`
          ...
          <div>
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px;">
              <div style="display: flex; align-items: center; gap: 8px; min-width: 0;">
                <span style="font-weight: 700; font-size: 13.5px; color: var(--text-main); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${x(i.name)}</span>
                <span class="brand-badge" style="font-size: 9.5px; padding: 1px 6px; flex-shrink: 0;">${x(i.badge)}</span>
              </div>
              ${n?'<span style="font-size: 10px; color: var(--green-400); font-weight: 600; flex-shrink: 0;">CONNECTED</span>':""}
            </div>
            ...
            ${i.envFields.length>0?`
              <div style="font-size: 10.5px; color: var(--amber-400); margin-top: 6px; display: flex; align-items: center; gap: 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                <span>⚡ Needs:</span>
                <code style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${i.envFields.map((s)=>x(s.key)).join(", ")}</code>
              </div>
            `:""}
          </div>

          <div style="display: flex; justify-content: flex-end; margin-top: 12px; gap: 6px;">
            <button class="btn btn-primary" style="font-size: 11.5px; padding: 4px 10px;" onclick="window.app.selectTemplate('${x(i.id)}')">
              ${n?"Configure Another":"✨ 1-Click Setup"}
            </button>
          </div>
        </div>
      `}).join("")}selectTemplate(e){let t=L.find((p)=>p.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let r=document.getElementById("modal-configure-template");if(r)r.classList.add("active");let o=document.getElementById("cfg-tmpl-title"),i=document.getElementById("cfg-tmpl-desc"),n=document.getElementById("cfg-tmpl-form");if(o)o.textContent=`Configure ${t.name} Server`;if(i)i.textContent=t.description;let a=l.getState().config.mcpServers||{},s=t.id;if(a[s]){let p=2;while(a[`${t.id}-${p}`])p++;s=`${t.id}-${p}`}if(n){let p="";if(t.envFields.length>0)p=`
          ...
          ${t.envFields.map((d)=>`
            <div class="form-group">
              <label class="form-label">${x(d.label)} ${d.required?'<span style="color: var(--red-400);">*</span>':"(Optional)"}</label>
              <input type="password" class="form-input tmpl-env-input" data-key="${x(d.key)}" placeholder="${x(d.placeholder||"")}">
              ${d.description?`<div style="font-size: 10.5px; color: var(--text-dim); margin-top: 3px;">${x(d.description)}</div>`:""}
            </div>
          `).join("")}
        `;n.innerHTML=`
        <div class="form-group">
          <label class="form-label">Server Identifier (Name)</label>
          <input type="text" class="form-input" id="cfg-srv-id" value="${x(s)}">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-input" id="cfg-srv-args" value="${x(t.defaultArgs.join(" "))}" placeholder="${x(t.argsPlaceholder||"")}">
          <div style="font-size: 10.5px; color: var(--text-dim); margin-top: 3px;">Executable: <code>${x(t.command)}</code></div>
        </div>
        ${p}
      ...
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),r=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}if((l.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists. Do you want to overwrite its configuration?`))return}let n=r?r.split(/\s+/).filter(Boolean):[],a={},s=document.querySelectorAll(".tmpl-env-input");for(let h of Array.from(s)){let k=h.getAttribute("data-key"),w=h.value.trim(),f=e.envFields.find((A)=>A.key===k);if(f?.required&&!w){alert(`Required field '${f.label}' is missing.`);return}if(k&&w)a[k]=w}let p={command:e.command,args:n};if(Object.keys(a).length>0)p.env=a;let d=document.getElementById("cfg-srv-ft")?.value.trim(),c=document.getElementById("cfg-srv-cd")?.value.trim(),v=document.getElementById("cfg-srv-autorestart")?.value,y=document.getElementById("cfg-srv-maxrestarts")?.value.trim();if(d||c||v||y)p.resilience={failureThreshold:d?Number(d):3,cooldownMs:c?Number(c):30000,autoRestart:v!=="false",maxRestarts:y?Number(y):5};let _=await u.upsertServer(t,p);if(_.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${_.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let r=await u.getEcosystemSources();if(r.sources&&r.sources.length>0)t.innerHTML=r.sources.map((o)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await u.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let r=(e||"").trim().toLowerCase();if(r.length<2){t.style.display="none";return}let i=l.getState().capabilities.filter((n)=>n.id.toLowerCase().includes(r)||n.summary&&n.summary.toLowerCase().includes(r)||n.description&&n.description.toLowerCase().includes(r)||n.server&&n.server.toLowerCase().includes(r)).slice(0,8);if(i.length===0){t.style.display="none";return}t.innerHTML=i.map((n)=>`
...
Warnings:
${e.warnings.join(`
`)}`;alert(t)}else alert(`Hot-reload failed: ${e.error||"Unknown error"}`)}catch(e){alert(`Error reaching daemon: ${e.message}`)}await this.refreshData()}renderTopProfileSelector(){let e=document.getElementById("top-profile-selector");if(!e)return;let t=l.getState(),r=t.config.profiles||{},o=Object.keys(r),i=t.activeProfile,n='<option value="">All Servers (Unrestricted)</option>';for(let a of o){let s=i===a?"selected":"";n+=`<option value="${x(a)}" ${s}>Profile: ${x(a)}</option>`}e.innerHTML=n}async setActiveProfile(e){l.setState({activeProfile:e||null}),await this.refreshData()}openAddProfileModal(){let e=document.getElementById("modal-prof-title");if(e)e.textContent="Create Server Constellation Profile";let t=document.getElementById("modal-prof-name"),r=document.getElementById("modal-prof-desc"),o=document.getElementById("modal-prof-mode");if(t)t.value="",t.disabled=!1;if(r)r.value="";if(o)o.value="create";this.renderProfileServerCheckboxes([]);let i=document.getElementById("modal-add-profile");if(i)i.classList.add("active")}openEditProfileModal(e){let r=l.getState().config.profiles?.[e];if(!r)return;let o=document.getElementById("modal-prof-title");if(o)o.textContent=`Edit Profile: ${e}`;let i=document.getElementById("modal-prof-name"),n=document.getElementById("modal-prof-desc"),a=document.getElementById("modal-prof-mode");if(i)i.value=e,i.disabled=!0;if(n)n.value=r.description||"";if(a)a.value="edit";this.renderProfileServerCheckboxes(r.servers||[]);let s=document.getElementById("modal-add-profile");if(s)s.classList.add("active")}renderProfileServerCheckboxes(e){let t=document.getElementById("modal-prof-servers-list");if(!t)return;let r=l.getState(),o=Object.keys(r.config.mcpServers||{});if(o.length===0){t.innerHTML='<div style="font-size: 11.5px; color: var(--text-dim);">No MCP servers configured yet. Add servers first.</div>';return}t.innerHTML=o.map((i)=>{let n=e.includes(i)?"checked":"";return`
        <label style="display: flex; align-items: center; gap: 8px; font-size: 12px; cursor: pointer; padding: 4px 6px; border-radius: var(--radius-sm); transition: background 0.15s;" onmouseover="this.style.background='var(--surface-hover)'" onmouseout="this.style.background='transparent'">
          <input type="checkbox" class="prof-server-checkbox" value="${x(i)}" ${n} style="accent-color: var(--amber-400);">
          <span style="font-family: var(--ff-mono); font-weight: 600; color: var(--text-main);">${x(i)}</span>
        </label>
      `}).join("")}async saveProfile(){let e=document.getElementById("modal-prof-name"),t=document.getElementById("modal-prof-desc"),r=e?.value.trim(),o=t?.value.trim();if(!r){alert("Please enter a profile name");return}let i=document.querySelectorAll(".prof-server-checkbox:checked"),n=[];if(i.forEach((a)=>{n.push(a.value)}),n.length===0){alert("Please select at least one server to include in this constellation");return}try{let a=await u.upsertProfile(r,n,o||void 0);if(a.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save profile: ${a.error||"Unknown error"}`)}catch(a){alert(`Error saving profile: ${a.message}`)}}async deleteProfile(e){if(!confirm(`Are you sure you want to delete profile '${e}'?`))return;try{let t=await u.deleteProfile(e);if(t.ok){if(l.getState().activeProfile===e)l.setState({activeProfile:null});await this.refreshData()}else alert(`Failed to delete profile: ${t.error||"Unknown error"}`)}catch(t){alert(`Error deleting profile: ${t.message}`)}}closeModals(){document.querySelectorAll(".modal-backdrop").forEach((e)=>e.classList.remove("active"))}}function x(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var Q=new W;window.app=Q;window.addEventListener("DOMContentLoaded",()=>Q.init());
