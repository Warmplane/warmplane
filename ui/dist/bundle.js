class ee{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],clients:[],clientFilterCategory:"all",clientSearchQuery:"",secrets:[],clientsCollapsed:!1,capabilities:[],capabilitiesHiddenByPolicy:0,resources:[],resourcesHiddenByPolicy:0,prompts:[],promptsHiddenByPolicy:0,catalogEvents:[],tasks:[],selectedTaskId:null,taskFilterStatus:"all",approvals:[],auditEvents:[],auditTotal:0,auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:25,offset:0},auditSelectedEvent:null,auditStats:null,auditVerification:null,selectedCapabilityId:null,selectedResourceId:null,selectedPromptId:null,playgroundMode:"tools",playgroundArgs:{},isExecuting:!1,playgroundAsyncTask:!1,activeRequestId:null,isBatchModalOpen:!1,batchSteps:[{id:"step_1",capability_id:"",argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],activeTab:"overview",activeProfile:null,eventLogs:[],executionResult:null,resourceReadResult:null,promptGetResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,o,n){let s=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:o,latency:n},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:s})}}var c=new ee;class te{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/capabilities`,{headers:t})).json()}async listResources(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/resources`,{headers:t})).json()}async readResource(e,t){let o=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let a=await fetch(`${this.baseUrl}/v1/resources/read`,{method:"POST",headers:n,body:JSON.stringify(e)}),s=performance.now()-o,r=await a.json();return{status:a.status,durationMs:s,data:r}}async listPrompts(e){let t={};if(e)t["X-Warmplane-Profile"]=e;return(await fetch(`${this.baseUrl}/v1/prompts`,{headers:t})).json()}async getPrompt(e,t){let o=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let a=await fetch(`${this.baseUrl}/v1/prompts/get`,{method:"POST",headers:n,body:JSON.stringify(e)}),s=performance.now()-o,r=await a.json();return{status:a.status,durationMs:s,data:r}}async getCatalogEvents(e){let t=e?`?after=${encodeURIComponent(e)}`:"";return(await fetch(`${this.baseUrl}/v1/catalog/events${t}`)).json()}async callCapability(e,t){let o=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let a=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:n,body:JSON.stringify(e)}),s=performance.now()-o,r=await a.json();return{status:a.status,durationMs:s,data:r}}async batchCallCapabilities(e,t){let o=performance.now(),n={"Content-Type":"application/json"};if(t)n["X-Warmplane-Profile"]=t;let a=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:n,body:JSON.stringify({steps:e})}),s=performance.now()-o,r=await a.json();return{status:a.status,durationMs:s,data:r}}async cancelOperation(e){return(await fetch(`${this.baseUrl}/v1/operations/${encodeURIComponent(e)}/cancel`,{method:"POST"})).json()}async completeArgument(e){return(await fetch(`${this.baseUrl}/v1/completion/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async restartServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}/restart`,{method:"POST"})).json()}async upsertProfile(e,t,o,n){return(await fetch(`${this.baseUrl}/v1/config/profiles`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,servers:t,description:o,policy:n})})).json()}async deleteProfile(e){return(await fetch(`${this.baseUrl}/v1/config/profiles/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listTasks(){return(await fetch(`${this.baseUrl}/v1/tasks`)).json()}async getTask(e){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}`)).json()}async updateTask(e,t){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}/update`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({inputResponses:t})})).json()}async cancelTask(e,t){return(await fetch(`${this.baseUrl}/v1/tasks/${encodeURIComponent(e)}/cancel`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({reason:t})})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:o})})).json()}async rejectTicket(e,t,o){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:o})})).json()}async updateAlias(e,t,o){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:o})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")t.set("server_id",e.server_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")t.set("event_type",e.event_type);if(e?.status&&e.status!=="all")t.set("status",e.status);if(e?.trace_id)t.set("trace_id",e.trace_id);if(e?.request_id)t.set("request_id",e.request_id);if(e?.search)t.set("search",e.search);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset!==void 0)t.set("offset",String(e.offset));let o=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${o?`?${o}`:""}`)).json()}getAuditExportUrl(e,t="csv"){let o=new URLSearchParams;if(o.set("format",t),e?.actor_id)o.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")o.set("server_id",e.server_id);if(e?.capability_id)o.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")o.set("event_type",e.event_type);if(e?.status&&e.status!=="all")o.set("status",e.status);if(e?.trace_id)o.set("trace_id",e.trace_id);if(e?.request_id)o.set("request_id",e.request_id);if(e?.search)o.set("search",e.search);return`${this.baseUrl}/v1/audit/export?${o.toString()}`}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}async getClients(){return(await fetch(`${this.baseUrl}/v1/clients`)).json()}async attachClient(e,t){return(await fetch(`${this.baseUrl}/v1/clients/${encodeURIComponent(e)}/attach`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({profile:t||void 0})})).json()}async detachClient(e){return(await fetch(`${this.baseUrl}/v1/clients/${encodeURIComponent(e)}/detach`,{method:"POST",headers:{"Content-Type":"application/json"}})).json()}async testWebhook(e,t){return(await fetch(`${this.baseUrl}/v1/webhooks/test`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:e||void 0,format:t||void 0})})).json()}async getSecrets(){return(await fetch(`${this.baseUrl}/v1/secrets`)).json()}async saveSecret(e,t,o){return(await fetch(`${this.baseUrl}/v1/secrets`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:e,value:t,service:o})})).json()}async deleteSecret(e){return(await fetch(`${this.baseUrl}/v1/secrets/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}}var b=new te;function re(){let e=c.getState(),t=e.config.mcpServers||{},o=Object.keys(t),n=o.length,a="";if(o.length===0)a=`
    ...
    `;else a=o.map((S)=>{let O=t[S],U=O.command?"stdio":"http / sse",F=O.command?`${O.command} ${(O.args||[]).join(" ")}`:O.url,q=e.serverStatuses[S]||{status:"connected",protocol_version:"2026-07-28"},J=q.status==="degraded",X=q.status==="error"||q.status==="disconnected",W=J?"var(--amber-400)":X?"var(--red-400)":"var(--green-400)";return`
        <div class="bento-card col-4" style="background: var(--surface); border: 1px solid var(--border);">
          ...
          <div style="display: flex; justify-content: space-between; font-size: 11px; color: var(--text-muted); border-top: 1px solid var(--border); padding-top: 8px;">
            <span>Status: <strong style="color: ${W};">${P(q.status)}</strong></span>
            <span>Protocol: ${q.protocol_version}</span>
          </div>
        </div>
  ...
  `).join(""),r=e.metrics,i=r.totalCatalogRequests,l=r.totalEtagHits,p=i>0?`${(l/i*100).toFixed(1)}%`:"0.0%",u=i>0?`${l} of ${i} requests served via HTTP 304`:"Waiting for client requests",g=r.totalToolCalls,h=g>0?`${(r.totalToolDurationUs/g/1000).toFixed(1)}ms`:"0.0ms",d=g>0?`${g} tool executions processed`:"Local worker task queues warm",m=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,f=m>0?`${m*18}B / call`:"0B",v=m>0?`${m} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size",x=e.tasks||[],I=x.filter((S)=>S.status==="input_required").length,R=x.filter((S)=>S.status==="working"||S.status==="input_required").length,_=e.clients||[],w=_.filter((S)=>S.is_attached).length,E=_.filter((S)=>S.config_exists&&!S.is_attached).length,L=e.clientsCollapsed,M=w>0?`<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.3); background: rgba(52, 211, 153, 0.1);">⚡ ${w} Connected</span>`:E>0?`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.3); background: rgba(251, 191, 36, 0.1);">○ ${E} Ready to Connect</span>`:'<span class="brand-badge" style="color: var(--text-dim);">No Apps Detected</span>',V=Object.keys(e.config.profiles||{}),H=e.activeProfile,B=e.clientFilterCategory||"all",D=(e.clientSearchQuery||"").toLowerCase().trim(),G=_.filter((S)=>{if(D){let O=S.name.toLowerCase().includes(D),U=S.id.toLowerCase().includes(D),F=S.category.toLowerCase().includes(D);if(!O&&!U&&!F)return!1}if(B==="connected")return S.is_attached;if(B==="ready")return S.config_exists||S.app_installed;if(B==="ides")return S.category.toLowerCase().includes("ide")||S.category.toLowerCase().includes("extension");if(B==="agents")return S.category.toLowerCase().includes("agent")||S.category.toLowerCase().includes("cli")||S.category.toLowerCase().includes("platform");return!0}),ge=G.length===0?'<div style="padding: 16px; text-align: center; color: var(--text-dim); font-size: 11.5px; grid-column: 1 / -1;">No AI clients match current filter.</div>':G.map((S)=>{let{is_attached:O,config_exists:U,app_installed:F}=S,q="rgba(255, 255, 255, 0.2)",J="Not Found";if(O)q="var(--green-400)",J=S.attached_profile?`Connected (${S.attached_profile})`:"Connected (All Tools)";else if(U)q="var(--amber-300)",J="Ready to Attach";else if(F)q="var(--cyan-400)",J="Installed";let X=V.map((Q)=>`
      <option value="${P(Q)}" ${H===Q||S.attached_profile===Q?"selected":""}>${P(Q)}</option>
    `).join(""),W=O?`<button class="btn btn-ghost" style="padding: 2px 7px; font-size: 10px; color: var(--red-400);" onclick="event.stopPropagation(); window.app.detachClient('${P(S.id)}')">Detach</button>`:U||F?`
        <div style="display: flex; align-items: center; gap: 4px;" onclick="event.stopPropagation();">
          ${V.length>0?`
            <select id="overview-client-prof-${P(S.id)}" class="form-input" style="font-size: 10px; padding: 1px 4px; height: 22px; width: 85px;" title="Select constellation profile">
              <option value="" ${!H?"selected":""}>All Tools</option>
              ${X}
            </select>
          `:""}
      ...
      <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; display: flex; align-items: center; justify-content: space-between; gap: 8px;">
        <div style="display: flex; align-items: center; gap: 8px; overflow: hidden;">
          <span style="width: 7px; height: 7px; border-radius: 50%; background: ${q}; flex-shrink: 0;"></span>
    ...
    `}).join(""),ve=[{id:"all",label:"All"},{id:"ready",label:"Ready / Installed"},{id:"connected",label:"Connected"},{id:"ides",label:"IDEs"},{id:"agents",label:"Agents & CLIs"}].map((S)=>`<button class="btn btn-ghost" style="padding: 2px 8px; font-size: 10.5px; border-radius: 100px; ${B===S.id?"background: var(--amber-400); color: #000; font-weight: 700;":"background: var(--surface); color: var(--text-muted);"}" onclick="event.stopPropagation(); window.app.setClientCategoryFilter('${S.id}')">${S.label}</button>`).join(""),me=`
  ...
  `;return`
    <div class="bento-grid">
      ...
      <div class="bento-card col-3">
        ...
        <div class="stat-value" style="color: ${I>0?"var(--amber-400)":"var(--green-400)"};">${I>0?`${I} Action Req`:`${R} Active`}</div>
  ...
  `}function P(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function se(){let e=c.getState(),t=e.config.mcpServers||{},o=Object.keys(t),n=e.activeProfile,a=n?e.config.profiles?.[n]:void 0,s=!!a,r=a?.servers||[],i="";if(o.length===0)i=`
    ...
    `;else i=o.map((p)=>{let u=t[p],g=u.command?"stdio":"http / sse",h=u.command?`${u.command} ${(u.args||[]).join(" ")}`:u.url,d=e.serverStatuses[p]||{status:"connected",protocol_version:"2026-07-28"},m=!s||r.includes(p),f=u.env?Object.entries(u.env).map(([H,B])=>{if(B.startsWith("keychain://"))return`<span class="brand-badge" style="color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.3);">\uD83D\uDD12 ${T(H)} (Keychain)</span>`;if(B.startsWith("op://"))return`<span class="brand-badge" style="color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.3);">\uD83D\uDD12 ${T(H)} (1Password)</span>`;if(B.startsWith("env://"))return`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.3);">\uD83D\uDD12 ${T(H)} (Env)</span>`;return`<span style="color: var(--text-dim);">${T(H)}=***</span>`}).join(" "):"None",v=(e.circuitBreakers||[]).find((H)=>H.server_id===p),x='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(v){if(v.state==="open")x=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${v.consecutive_failures} failures)</span>`;else if(v.state==="half_open")x=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${v.consecutive_successes} probe)</span>`}let I=u.resilience||e.config.resilience,R=I?`FT: ${I.failureThreshold||3} · Cooldown: ${(I.cooldownMs||30000)/1000}s · AutoRestart: ${I.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience",_=d.status==="degraded",w=d.status==="error"||d.status==="disconnected",E=_?"var(--amber-400)":w?"var(--red-400)":"var(--green-400)",L=(_||w)&&d.error?`
      ...
      `:"",M=s?m?`<span class="brand-badge" style="color: var(--green-400); border-color: rgba(34, 197, 94, 0.3); background: rgba(34, 197, 94, 0.08); display: inline-flex; align-items: center; gap: 6px;">
              ✔ IN CONSTELLATION
        ...
        <div class="bento-card" style="${s&&!m?"margin-bottom: 12px; opacity: 0.65; border: 1px dashed rgba(245, 158, 11, 0.4); background: rgba(0, 0, 0, 0.2);":`margin-bottom: 12px; border-color: ${_?"rgba(251, 191, 36, 0.3)":w?"rgba(248, 113, 113, 0.3)":"var(--border)"};`}">
          <div style="display: flex; justify-content: space-between; align-items: center; gap: 16px; flex-wrap: wrap;">
            ...
            <div style="display: flex; gap: 8px; align-items: center; flex-shrink: 0;">
              <button class="btn btn-ghost" style="padding: 4px 10px; font-size: 11.5px; color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.3);" onclick="window.app.restartServer('${T(p)}')">⚡ Restart</button>
              <button class="btn btn-ghost" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.openServerDiagnosticsModal('${T(p)}')">\uD83D\uDD0D Diagnostics</button>
              <button class="btn btn-ghost" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.openEditServerModal('${T(p)}')">✏️ Edit</button>
              <button class="btn btn-danger" style="padding: 4px 10px; font-size: 11.5px;" onclick="window.app.deleteServer('${T(p)}')">${s?"Delete Globally":"Remove"}</button>
            </div>
          </div>
          ${L}
        </div>
      ...
      <div style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 260px;">
        ...
        <div>
          <div style="font-size: 13px; font-weight: 700; color: var(--amber-400); display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
            ...
            <span class="brand-badge" style="color: var(--text-main);">${r.length} of ${o.length} servers included</span>
          </div>
  ...
  `:"";return`
    ...
    ${fe()}
  `}function fe(){let e=c.getState(),t=e.clients||[],o=Object.keys(e.config.profiles||{}),n=e.clientsCollapsed,a=e.clientFilterCategory||"all",s=(e.clientSearchQuery||"").toLowerCase().trim();if(t.length===0)return"";let r=t.filter((d)=>d.is_attached).length,i=t.filter((d)=>d.config_exists&&!d.is_attached).length,l=t.filter((d)=>d.category.toLowerCase().includes("ide")||d.category.toLowerCase().includes("extension")).length,p=t.filter((d)=>d.category.toLowerCase().includes("agent")||d.category.toLowerCase().includes("cli")||d.category.toLowerCase().includes("platform")).length,u=t.filter((d)=>{if(s){let m=d.name.toLowerCase().includes(s),f=d.id.toLowerCase().includes(s),v=d.category.toLowerCase().includes(s),x=d.config_path.toLowerCase().includes(s);if(!m&&!f&&!v&&!x)return!1}if(a==="connected")return d.is_attached;if(a==="ready")return d.config_exists||d.app_installed;if(a==="ides")return d.category.toLowerCase().includes("ide")||d.category.toLowerCase().includes("extension");if(a==="agents")return d.category.toLowerCase().includes("agent")||d.category.toLowerCase().includes("cli")||d.category.toLowerCase().includes("platform");return!0}),g=[{id:"all",label:`All Ecosystems (${t.length})`},{id:"ready",label:`Ready / Installed (${i+r})`},{id:"connected",label:`⚡ Connected (${r})`},{id:"ides",label:`IDEs & Editors (${l})`},{id:"agents",label:`Agents & CLIs (${p})`}].map((d)=>`
    ...
    `).join(""),h=u.length===0?`<div style="padding: 24px; text-align: center; color: var(--text-dim); font-size: 12px;">No AI clients match the filter "${T(s||a)}".</div>`:u.map((d)=>{let{is_attached:m,config_exists:f,app_installed:v}=d,x='<span class="brand-badge" style="color: var(--text-dim); border-color: rgba(255, 255, 255, 0.1);">Not Found</span>';if(m){let w=d.attached_profile?` · ${d.attached_profile}`:"";x=`<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.3); background: rgba(52, 211, 153, 0.1);">⚡ Connected${T(w)}</span>`}else if(f)x='<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.3); background: rgba(251, 191, 36, 0.08);">○ Ready</span>';else if(v)x='<span class="brand-badge" style="color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.25);">○ Installed</span>';let I=e.activeProfile,R=o.map((w)=>`
          <option value="${T(w)}" ${I===w||d.attached_profile===w?"selected":""}>Profile: ${T(w)}</option>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; user-select: none;" onclick="window.app.toggleClientsCollapse()">
        <div>
          <div style="font-size: 14px; font-weight: 700; color: var(--text-main); display: flex; align-items: center; gap: 8px;">
            <span>⚡ 1-Click AI Client Integrations</span>
            <span class="brand-badge" style="color: var(--amber-400); border-color: rgba(245, 158, 11, 0.3);">${r>0?`${r} Connected`:`${t.length} Ecosystems Supported`}</span>
          </div>
        ...
        <div style="margin-top: 14px; padding-top: 12px; border-top: 1px solid var(--border-subtle);">
          <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 10px; margin-bottom: 12px;">
            ...
            <div style="position: relative;">
              <input type="text" class="form-input" style="font-size: 11px; padding: 4px 10px; width: 180px; height: 26px; border-radius: 100px;" placeholder="\uD83D\uDD0D Search clients..." value="${T(e.clientSearchQuery||"")}" oninput="window.app.setClientSearchQuery(this.value)">
            </div>
          </div>
    ...
    <div style="display: flex; gap: 8px; margin-bottom: 12px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
      <div style="display: inline-flex; padding: 3px; background: rgba(0,0,0,0.3); border: 1px solid var(--border); border-radius: var(--radius-sm); align-items: center;">
        ...
        >
          ...
          ${r>0?`<span class="badge" style="background: rgba(245, 158, 11, 0.2); color: var(--amber-300); font-size: 9.5px; padding: 1px 5px;" title="${r} resources hidden by constellation/policy">+${r} hidden</span>`:""}
        </button>
        <button 
      ...
      <div style="display: flex; align-items: center; gap: 12px;">
        ${t==="tools"&&s>0?`
          <div style="font-size: 11px; color: var(--amber-300); background: rgba(245, 158, 11, 0.1); border: 1px solid rgba(245, 158, 11, 0.25); padding: 3px 8px; border-radius: var(--radius-sm); display: flex; align-items: center; gap: 6px;">
            <span>\uD83D\uDEE1️ ${s} tool${s>1?"s":""} filtered ${u?`(Profile: ${k(l)})`:"by policy"}</span>
        ...
        `:t==="resources"&&r>0?`
          <div style="font-size: 11px; color: var(--amber-300); background: rgba(245, 158, 11, 0.1); border: 1px solid rgba(245, 158, 11, 0.25); padding: 3px 8px; border-radius: var(--radius-sm); display: flex; align-items: center; gap: 6px;">
            <span>\uD83D\uDEE1️ ${r} resource${r>1?"s":""} filtered ${u?`(Profile: ${k(l)})`:"by policy"}</span>
            <a href="javascript:void(0)" onclick="window.app.switchTab('policy')" style="color: var(--amber-400); text-decoration: underline; font-weight: 600;">View Policy</a>
            ${u?`<a href="javascript:void(0)" onclick="window.app.switchTab('servers')" style="color: var(--cyan-400); text-decoration: underline; font-weight: 600; margin-left: 4px;">Server Hub</a>`:""}
          </div>
        `:t==="prompts"&&i>0?`
  ...
  `}function Y(e,t=!1){if(!e||!e.properties)return{};let o=e.properties||{},n=Array.isArray(e.required)?e.required:[],a={};for(let[s,r]of Object.entries(o)){let i=n.includes(s);if(t&&!i)continue;if(r.default!==void 0)a[s]=r.default;else if(Array.isArray(r.enum)&&r.enum.length>0)a[s]=r.enum[0];else if(r.examples&&Array.isArray(r.examples)&&r.examples.length>0)a[s]=r.examples[0];else if(r.example!==void 0)a[s]=r.example;else switch(r.type||"string"){case"string":a[s]=i?`sample_${s}`:"";break;case"number":case"integer":a[s]=0;break;case"boolean":a[s]=!0;break;case"array":a[s]=[];break;case"object":a[s]={};break;default:a[s]=`sample_${s}`}}return a}function ye(e){let t=e.capabilities||[],o=e.selectedCapabilityId||(t.length>0?t[0].id:null),n=t.find((f)=>f.id===o),a=e.isExecutingCapability,s=e.capabilitiesHiddenByPolicy||0,r=e.activeProfile,i=!!(r&&e.config.profiles?.[r]),l="";if(t.length===0)l=`
    ...
    `;else l=t.map((f)=>`
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 8px; align-items: center;">
        ...
        ${h.map(([f,v])=>{let x=g.includes(f),I=v.type||(v.enum?"enum":"any"),R=x?"rgba(239, 68, 68, 0.15)":"rgba(148, 163, 184, 0.1)",_=x?"var(--red-400)":"var(--text-muted)",w=x?"rgba(239, 68, 68, 0.3)":"var(--border)",E=v.description?` - ${v.description}`:"";return`
            <button 
              type="button" 
              class="btn" 
              ...
              title="Click to insert '${f}' (${I}${E})" 
              onclick="window.app.insertPlaygroundArgKey('${k(f)}', '${k(I)}', ${k(JSON.stringify(v.default??null))})"
            >
              + ${k(f)} <span style="font-size: 9px; opacity: 0.7;">(${I}${x?" *":""})</span>
            </button>
          `}).join("")}
      </div>
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        ...
        ${s>0?`
          <div style="padding: 8px 12px; background: rgba(245, 158, 11, 0.08); border-top: 1px solid rgba(245, 158, 11, 0.2); font-size: 11px; color: var(--amber-300); display: flex; justify-content: space-between; align-items: center;">
            <span>\uD83D\uDEE1️ ${s} tool${s>1?"s":""} filtered ${i?`(${k(r)})`:""}</span>
  ...
  `}function be(e){let t=e.resources||[],o=e.resourcesHiddenByPolicy||0,n=e.selectedResourceId||(t.length>0?t[0].id:null),a=t.find((i)=>i.id===n),s=e.resourceReadResult,r="";if(t.length===0)r=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No resources exposed by connected MCP servers.
      </div>
    `;else r=t.map((i)=>{let l=i.id===n?"active":"",p=i.uri?i.uri.split(":")[0]:"res";return`
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
          ...
          <div style="padding: 16px; background: var(--bg-app); display: flex; flex-direction: column; overflow: hidden;">
            ...
            <pre style="flex: 1; background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 14px; color: var(--cyan-400); font-size: 11.5px; overflow-y: auto; margin: 0; white-space: pre-wrap; word-break: break-word;">${s?k(JSON.stringify(s.data,null,2)):'// Click "Read Resource Content" to inspect live payload'}</pre>
          </div>
        </div>
      </div>
    </div>
  `}function xe(e){let t=e.prompts||[],o=e.promptsHiddenByPolicy||0,n=e.selectedPromptId||(t.length>0?t[0].id:null),a=t.find((l)=>l.id===n),s=e.promptGetResult,r="";if(t.length===0)r=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No prompt templates registered by connected MCP servers.
      </div>
    `;else r=t.map((l)=>{let p=l.id===n?"active":"",u=l.arguments?l.arguments.length:0;return`
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 24px;" onclick="if(event.target === this) window.app.closeBatchModal()">
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); width: 840px; max-width: 95vw; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <div style="flex: 1; overflow-y: auto; padding: 20px;">
          ${o.map((a,s)=>{let r=t.find((d)=>d.id===a.capability_id),i=r?.input_schema,l=i?.properties||{},p=Array.isArray(i?.required)?i.required:[],u=Object.entries(l),g=t.map((d)=>`
  ...
  `}function k(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function oe(e){let t=e.tasks||[],o=e.taskFilterStatus||"all",n=t.filter((d)=>d.status==="input_required"),a=t.filter((d)=>d.status==="working"),s=t.filter((d)=>d.status==="completed"),r=t.filter((d)=>d.status==="cancelled"),i=t.filter((d)=>d.status==="failed"),l=o==="all"?t:t.filter((d)=>d.status===o),p=e.config.policy?.require_approval||e.config.policy?.requireApproval||[],u=n.length===0?`
  ...
  `:n.map((d)=>{let m=d.inputRequests||{},f=Object.keys(m),v=f.length>0,x=Math.floor(Date.now()/1000),I=d.expiresAtEpochSecs?Math.max(0,d.expiresAtEpochSecs-x):d.ttlMs?Math.max(0,Math.floor(d.ttlMs/1000)):d.ttlSeconds||300,R=d.createdAtEpochSecs?new Date(d.createdAtEpochSecs*1000).toLocaleTimeString():d.createdAt?new Date(d.createdAt).toLocaleTimeString():"—";return`
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
              ${f.map((_)=>{let w=m[_]||{},E=typeof w==="string"?w:w.prompt||w.description||w.title||_,L=w.type||"text",M=w.default!==void 0?JSON.stringify(w.default):w.value!==void 0?JSON.stringify(w.value):w.sanitized_args?JSON.stringify(w.sanitized_args,null,2):"";if(L==="approval_review")return`
                    <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 10px 12px;">
                      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
                        <label style="font-size: 11.5px; font-weight: 600; color: var(--amber-300); font-family: var(--ff-mono);">${A(_)}</label>
                      ...
                      <div style="margin-bottom: 8px;">
                        ...
                        <select id="task-input-${A(d.taskId)}-${A(_)}-decision" class="form-input" style="font-size: 11.5px; font-family: var(--ff-mono); padding: 4px 8px;">
                      ...
                      <div>
                        ...
                        <textarea id="task-input-${A(d.taskId)}-${A(_)}" class="form-textarea" rows="3" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px;">${A(M)}</textarea>
                      </div>
                    </div>
                  `;return`
                  <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 10px 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
                      <label style="font-size: 11.5px; font-weight: 600; color: var(--amber-300); font-family: var(--ff-mono);">${A(_)}</label>
                      <span class="brand-badge" style="font-size: 9.5px; padding: 1px 5px;">${A(L)}</span>
                    </div>
                    <div style="font-size: 11px; color: var(--text-dim); margin-bottom: 6px;">${A(E)}</div>
                    ${L==="confirmation"||L==="boolean"?`
                      <select id="task-input-${A(d.taskId)}-${A(_)}" class="form-input" style="font-size: 11.5px; font-family: var(--ff-mono); padding: 4px 8px;">
                    ...
                    `:w.sanitized_args||L==="object"||L==="json"?`
                      <textarea id="task-input-${A(d.taskId)}-${A(_)}" class="form-textarea" rows="3" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px;">${A(M)}</textarea>
                    `:`
                      <input id="task-input-${A(d.taskId)}-${A(_)}" type="text" class="form-input" value="${A(M)}" placeholder="Enter ${A(_)} response..." style="font-size: 11.5px; font-family: var(--ff-mono);">
                    `}
                  </div>
                `}).join("")}
            </div>
  ...
  `:l.map((d)=>{let m=d.status==="completed"?"background: rgba(52, 211, 153, 0.12); color: var(--green-400); border-color: rgba(52, 211, 153, 0.3);":d.status==="working"?"background: rgba(56, 189, 248, 0.15); color: var(--cyan-400); border-color: rgba(56, 189, 248, 0.4);":d.status==="input_required"?"background: rgba(245, 158, 11, 0.2); color: var(--amber-300); border-color: rgba(245, 158, 11, 0.5);":d.status==="cancelled"?"background: rgba(148, 163, 184, 0.15); color: var(--text-muted); border-color: rgba(148, 163, 184, 0.3);":"background: rgba(248, 113, 113, 0.12); color: var(--red-400); border-color: rgba(248, 113, 113, 0.3);",f=d.progress!==void 0?Math.round(d.progress*100):d.status==="completed"?100:d.status==="working"?50:0,v=d.createdAtEpochSecs?new Date(d.createdAtEpochSecs*1000).toLocaleTimeString():d.createdAt?new Date(d.createdAt).toLocaleTimeString():"—";return`
    ...
    <div class="bento-grid">
      ...
      <div class="bento-card col-3">
        ...
        <div class="stat-value" style="color: ${i.length>0?"var(--red-400)":"var(--text-muted)"};">${r.length+i.length}</div>
  ...
  `}function A(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ne(){let e=c.getState(),t=e.auditEvents||[],o=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},n=e.auditVerification,a=e.auditFilters,s=e.auditTotal??t.length,r=e.auditSelectedEvent,i=Object.keys(e.config?.mcpServers||{}),l=a.limit||25,p=a.offset||0,u=Math.floor(p/l)+1,g=Math.max(1,Math.ceil(s/l)),h=s===0?0:p+1,d=Math.min(p+l,s),m=b.getAuditExportUrl({actor_id:a.search?void 0:void 0,server_id:a.serverId!=="all"?a.serverId:void 0,event_type:a.eventType!=="all"?a.eventType:void 0,status:a.status!=="all"?a.status:void 0,search:a.search.trim()?a.search.trim():void 0},"csv"),f=b.getAuditExportUrl({server_id:a.serverId!=="all"?a.serverId:void 0,event_type:a.eventType!=="all"?a.eventType:void 0,status:a.status!=="all"?a.status:void 0,search:a.search.trim()?a.search.trim():void 0},"jsonl"),v=n?n.is_valid?`
  ...
  `,x=i.map((E)=>`<option value="${C(E)}" ${a.serverId===E?"selected":""}>${C(E)}</option>`).join(""),I=`
  ...
  `,R=`
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: rgba(18, 24, 38, 0.5); border-radius: var(--radius-md); border: 1px solid var(--border); margin-top: 16px;">
      <div style="font-size: 12px; color: var(--text-dim); display: flex; align-items: center; gap: 8px;">
        <span>Showing <strong style="color: var(--text-main);">${h}–${d}</strong> of <strong style="color: var(--text-main);">${s}</strong> events</span>
  ...
  `,_="";if(t.length===0)_=`
    ...
    `;else _=t.map((E)=>{let L=new Date(Math.floor(E.timestamp_ns/1e6)).toLocaleString(),M='<span class="badge" style="background: rgba(34, 197, 94, 0.15); color: var(--green-400); font-weight: 600;">SUCCESS</span>';if(E.status==="denied")M='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">DENIED</span>';else if(E.status==="intercepted")M='<span class="badge" style="background: rgba(234, 179, 8, 0.15); color: var(--amber-300); font-weight: 600;">HITL INTERCEPT</span>';else if(E.status==="failed")M='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">FAILED</span>';else if(E.status==="cancelled")M='<span class="badge" style="background: rgba(148, 163, 184, 0.15); color: var(--text-muted); font-weight: 600;">CANCELLED</span>';let V=E.sanitized_args?JSON.stringify(E.sanitized_args):"-",H=E.actor_id||E.operator_id||"anonymous",B=E.server_id||"system",D=E.capability_id||E.event_type,G=E.execution_latency_us?`${(E.execution_latency_us/1000).toFixed(1)}ms`:"-";return`
        <div class="bento-card" style="margin-bottom: 12px; padding: 16px; border: 1px solid var(--border); transition: border-color 0.15s ease;">
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; font-size: 11.5px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 8px;">
            <div><span style="color: var(--text-muted);">Actor:</span> <strong style="color: var(--text-main);">${C(H)}</strong></div>
            <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--cyan-400);">${C(B)}</strong></div>
      ...
      `}).join("");let w="";if(r){let E=new Date(Math.floor(r.timestamp_ns/1e6)).toISOString();w=`
        ...
        <div class="bento-card" style="width: 100%; max-width: 720px; max-height: 85vh; display: flex; flex-direction: column; overflow: hidden; background: #0f172a; border: 1px solid var(--border); box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; border-bottom: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <h2 style="font-size: 15px; font-weight: 700; color: var(--text-main); margin: 0;">Audit Event Details (${C(r.id)})</h2>
            </div>
          ...
          <div style="padding: 20px; overflow-y: auto; display: flex; flex-direction: column; gap: 14px; font-size: 12px;">
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; background: rgba(0,0,0,0.25); padding: 12px; border-radius: var(--radius-sm);">
              ...
              <div><span style="color: var(--text-muted);">Status:</span> <strong style="color: var(--text-main);">${C(r.status.toUpperCase())}</strong></div>
              <div><span style="color: var(--text-muted);">Event Type:</span> <strong style="color: var(--text-main);">${C(r.event_type)}</strong></div>
              <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--cyan-400);">${C(r.server_id||"system")}</strong></div>
              <div><span style="color: var(--text-muted);">Capability:</span> <strong style="color: var(--text-main);">${C(r.capability_id||"-")}</strong></div>
              <div><span style="color: var(--text-muted);">Actor / Operator:</span> <strong style="color: var(--text-main);">${C(r.actor_id||r.operator_id||"anonymous")}</strong></div>
              <div><span style="color: var(--text-muted);">Trace ID:</span> <code style="color: var(--cyan-400);">${C(r.trace_id)}</code></div>
              <div><span style="color: var(--text-muted);">Request ID:</span> <code style="color: var(--cyan-400);">${C(r.request_id||"-")}</code></div>
              <div><span style="color: var(--text-muted);">Client IP:</span> <span style="color: var(--text-main);">${C(r.client_ip||"-")}</span></div>
              <div><span style="color: var(--text-muted);">Latency:</span> <span style="color: var(--amber-300);">${r.execution_latency_us?`${(r.execution_latency_us/1000).toFixed(2)} ms`:"-"}</span></div>
            </div>
            ...
            ${r.error_message?`
              <div style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.3); border-radius: var(--radius-sm); padding: 10px 12px; color: var(--red-400);">
                <div style="font-weight: 700; margin-bottom: 2px;">Error (${C(r.error_code||"ERROR")}):</div>
                <div style="font-family: var(--ff-mono); font-size: 11px;">${C(r.error_message)}</div>
              </div>
            `:""}
            ...
            <div>
              ...
              <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${C(JSON.stringify(r.sanitized_args||{},null,2))}</pre>
            </div>
            ...
            ${r.sanitized_response?`
              <div>
                ...
                <pre style="background: rgba(0,0,0,0.4); padding: 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); font-family: var(--ff-mono); font-size: 11px; max-height: 140px; overflow: auto; margin: 0; color: #cbd5e1;">${C(JSON.stringify(r.sanitized_response,null,2))}</pre>
              </div>
            `:""}
            ...
            <div style="background: rgba(0,0,0,0.3); padding: 12px; border-radius: var(--radius-sm); border: 1px solid var(--border);">
              ...
              <div style="margin-bottom: 6px;">
                ...
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--text-dim); word-break: break-all;">${C(r.prev_hash)}</div>
              </div>
              <div>
                <span style="color: var(--text-muted); font-size: 10.5px;">Record Hash Signature (hash):</span>
                <div style="font-family: var(--ff-mono); font-size: 10.5px; color: var(--green-400); word-break: break-all;">${C(r.hash)}</div>
              </div>
            </div>
          </div>
    ...
    ${w}
  `}function C(e){if(!e)return"";return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function ie(){let e=c.getState(),t=e.activeProfile,o=t?e.config.profiles?.[t]:void 0,n=!!o,a=e.config.policy||{},s=o?.policy,r=n?s||{}:a,i=r.allow||[],l=r.deny||[],p=r.redact_keys||r.redactKeys||[],u=r.require_approval||r.requireApproval||[],g=i.length===0?`
  ...
  `,v=Object.keys(e.config.mcpServers||{}),x=o?.servers||[],I=n?v.filter((w)=>!x.includes(w)):[],R=n?`
      ...
      <div class="bento-card col-12" style="border-color: rgba(59, 130, 246, 0.3);">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 14px; margin-top: 14px;">
          <div>
            ...
            <input type="text" class="form-input" id="policy-webhook-url" placeholder="https://hooks.slack.com/services/... or Discord webhook URL" value="${z(typeof r.webhook==="object"&&r.webhook?r.webhook.url||"":"")}">
          </div>
          <div>
            <label class="form-label" style="font-size: 11px;">Payload Layout Format</label>
            <select class="form-input" id="policy-webhook-format">
              <option value="slack" ${typeof r.webhook==="object"&&r.webhook?.format==="slack"?"selected":""}>Slack Block Kit (Interactive)</option>
              <option value="discord" ${typeof r.webhook==="object"&&r.webhook?.format==="discord"?"selected":""}>Discord Embed &amp; Actions</option>
              <option value="teams" ${typeof r.webhook==="object"&&r.webhook?.format==="teams"?"selected":""}>Microsoft Teams Adaptive Cards</option>
              <option value="generic" ${typeof r.webhook==="object"&&r.webhook?.format==="generic"||!r.webhook?"selected":""}>Generic JSON (Standard)</option>
            </select>
          </div>
          <div>
            <label class="form-label" style="font-size: 11px;">HMAC Secret (or Env Var)</label>
            <input type="text" class="form-input" id="policy-webhook-secret" placeholder="e.g. WARMPLANE_WEBHOOK_SECRET" value="${z(typeof r.webhook==="object"&&r.webhook?r.webhook.secret_env||r.webhook.secretEnv||r.webhook.secret||"":"")}">
          </div>
        </div>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 14px; padding-top: 12px; border-top: 1px solid var(--border-subtle);">
          ...
          <div id="policy-webhook-status" style="font-size: 11px; font-family: var(--ff-mono); color: var(--text-dim);">
            ${typeof r.webhook==="object"&&r.webhook?.url?`Active Target: ${z(r.webhook.url)}`:"No webhook configured"}
          </div>
        </div>
      </div>
  ...
  `}function z(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function le(){let e=c.getState(),t=e.config,o=Object.entries(t.capabilityAliases||{}),n=Object.entries(t.resourceAliases||{}),a=Object.entries(t.promptAliases||{}),s="";if(o.length===0&&n.length===0&&a.length===0)s=`
      <div style="padding: 24px; text-align: center; color: var(--text-dim);">
        No facade aliases configured in ${N(e.configPath)}. Add short names to prune token payload sizes.
      </div>
    `;else{for(let[r,i]of o)s+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          <span style="color: var(--cyan-400);">Tool</span>
          <span style="font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${N(r)}</span>
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${N(i)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('tool', '${N(r)}')">✕</button>
          </div>
        </div>
      `;for(let[r,i]of n)s+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${N(i)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('resource', '${N(r)}')">✕</button>
          </div>
        </div>
      `;for(let[r,i]of a)s+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${N(i)}</span>
          <div style="text-align: right;">
            <button class="btn btn-ghost" style="padding: 2px 6px; color: var(--red-400);" onclick="window.app.deleteAlias('prompt', '${N(r)}')">✕</button>
          </div>
        </div>
      `}return`
    <!-- Sub-header -->
  ...
  `}function N(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function de(){let e=c.getState(),t=e.config,o=t.profiles||{},n=Object.entries(o),a=t.mcpServers||{},s=e.activeProfile,r="";if(n.length===0)r=`
      <div style="padding: 40px; text-align: center; color: var(--text-dim); background: var(--surface-card); border-radius: var(--radius-md); border: 1px dashed var(--border);">
    ...
    `;else r=n.map(([i,l])=>{let p=s===i,u=l.servers.map((x)=>`<span class="brand-badge" style="${a[x]?"color: var(--cyan-400); border-color: rgba(34, 211, 238, 0.25); background: rgba(34, 211, 238, 0.05);":"color: var(--red-400); border-color: rgba(248, 113, 113, 0.3); background: rgba(248, 113, 113, 0.05);"}">${K(x)}</span>`).join(" "),g=(e.capabilities||[]).filter((x)=>l.servers.includes(x.server)).length,h=!!l.policy,d=l.policy?.allow?.length||0,m=l.policy?.deny?.length||0,f=(l.policy?.require_approval||l.policy?.requireApproval||[]).length,v=(l.policy?.redact_keys||l.policy?.redactKeys||[]).length;return`
    ...
    ${r}
  `}function K(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ce(){let t=c.getState().secrets||[],o=t.length,n=t.filter((r)=>r.is_vault).length,a=o-n,s=t.length===0?`
  ...
  `:t.map((r)=>{let i='<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Plaintext (Unsecured)</span>',l=r.is_vault&&r.exists===!1;if(l)i=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(245, 158, 11, 0.4); background: rgba(245, 158, 11, 0.1);">⚠️ Missing from ${j(r.backend)}</span>`;else if(r.is_vault)i=`<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.3); background: rgba(52, 211, 153, 0.1);">\uD83D\uDD12 ${j(r.backend)}</span>`;return`
      <div style="display: grid; grid-template-columns: 140px 180px 1fr 180px auto; padding: 10px 16px; border-bottom: 1px solid var(--border-subtle); align-items: center; font-size: 12px;">
        <span style="font-weight: 700; color: var(--text-main);">${j(r.server)}</span>
        <span style="font-family: var(--ff-mono); color: ${l?"var(--amber-300)":"var(--amber-300)"};">${j(r.key)}</span>
        <span style="font-family: var(--ff-mono); font-size: 11px; color: ${l?"var(--red-400)":"var(--text-muted)"}; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${j(r.display)}</span>
        <div>${i}</div>
        <div style="display: flex; gap: 6px; justify-content: flex-end;">
          ${l?`
            <button class="btn btn-primary" style="padding: 2px 8px; font-size: 11px;" onclick="window.app.quickVaultEnv('${j(r.server)}', '${j(r.key)}')">➕ Re-add Key</button>
            <button class="btn btn-ghost" style="padding: 2px 8px; font-size: 11px; color: var(--red-400);" onclick="window.app.removeSecretFromConfig('${j(r.server)}', '${j(r.key)}')">Remove from Config</button>
          `:!r.is_vault?`
            <button class="btn btn-primary" style="padding: 2px 8px; font-size: 11px;" onclick="window.app.quickVaultEnv('${j(r.server)}', '${j(r.key)}')">\uD83D\uDD12 Move to Keychain</button>
          `:`
            <button class="btn btn-ghost" style="padding: 2px 8px; font-size: 11px; color: var(--red-400);" onclick="window.app.deleteVaultSecret('${j(r.key)}', '${j(r.server)}')">Delete Key</button>
          `}
        </div>
      </div>
    `}).join("");return`
...
Reference: ${r.uri}`),e)e.value="";if(t)t.value="";await this.refreshData()}else alert(`Failed to save secret: ${r.error}`)}catch(r){alert(`Error saving secret: ${r.message}`)}}async deleteVaultSecret(e,t){let o=t?`Are you sure you want to remove secret '${e}' from OS Keychain and server '${t}'?`:`Are you sure you want to remove secret '${e}' from OS Keychain?`;if(!confirm(o))return;try{let n=await b.deleteSecret(e);if(n.ok||n.error?.includes("not found")){if(t){let r=(c.getState().config.mcpServers||{})[t];if(r&&r.env&&r.env[e]){let i={...r.env};delete i[e];let l={...r,env:i};await b.upsertServer(t,l)}}await this.refreshData()}else alert(`Failed to delete secret: ${n.error}`)}catch(n){alert(`Error deleting secret: ${n.message}`)}}async removeSecretFromConfig(e,t){if(!confirm(`Remove environment variable '${t}' from '${e}' configuration?`))return;try{let a=(c.getState().config.mcpServers||{})[e];if(a&&a.env&&a.env[t]){let s={...a.env};delete s[t];let r={...a,env:s},i=await b.upsertServer(e,r);if(i.ok)await this.refreshData();else alert(`Failed to update server config: ${i.error}`)}}catch(o){alert(`Error removing secret from config: ${o.message}`)}}async quickVaultEnv(e,t){let o=prompt(`Enter secret value to store in OS Keychain for ${e}.${t}:`);if(!o)return;try{let n=await b.saveSecret(t,o,"warmplane");if(!n.ok){alert(`Failed to save to Keychain: ${n.error}`);return}let r=(c.getState().config.mcpServers||{})[e];if(r){let i={...r.env||{},[t]:`keychain://warmplane/${t}`},l={...r,env:i},p=await b.upsertServer(e,l);if(p.ok)await this.refreshData(),alert(`Successfully configured ${e}.${t} in OS Keychain!`);else alert(`Failed to update server config: ${p.error}`)}}catch(n){alert(`Error during migration: ${n.message}`)}}async refreshTasks(){try{let e=await b.listTasks();if(e&&Array.isArray(e.tasks))c.setState({tasks:e.tasks})}catch(e){console.error("Failed to refresh tasks:",e)}}filterTasksByStatus(e){c.setState({taskFilterStatus:e})}togglePlaygroundAsyncTask(e){c.setState({playgroundAsyncTask:e})}async submitTaskInputResponses(e){let o=c.getState().tasks.find((s)=>s.taskId===e)?.inputRequests||{},n=Object.keys(o),a={};if(n.length>0)for(let s of n){let r=o[s];if(r&&r.type==="approval_review"){let i=document.getElementById(`task-input-${e}-${s}-decision`),l=document.getElementById(`task-input-${e}-${s}`),p=i?i.value==="true":!0,u=void 0;if(l&&l.value.trim())try{u=JSON.parse(l.value.trim())}catch{alert("Invalid JSON in parameters editor");return}a[s]={approved:p,modified_args:u,reason:p?void 0:"Operator rejected execution via Tasks review"}}else{let i=document.getElementById(`task-input-${e}-${s}`);if(i){let l=i.value.trim();try{a[s]=JSON.parse(l)}catch{a[s]=l}}}}else{let s=document.getElementById(`task-raw-input-${e}`);if(s&&s.value.trim())try{Object.assign(a,JSON.parse(s.value.trim()))}catch{alert("Invalid JSON in raw input responses");return}}try{let s=await b.updateTask(e,a);if(s.ok)await this.refreshTasks();else alert(`Task update failed: ${s.error?.message||s.error||"Unknown error"}`)}catch(s){alert(`Error updating task: ${s.message}`)}}async promptCancelTask(e){let t=prompt("Reason for cancelling task:");if(t===null)return;try{let o=await b.cancelTask(e,t||void 0);if(o.ok)await this.refreshTasks();else alert(`Task cancellation failed: ${o.error?.message||o.error||"Unknown error"}`)}catch(o){alert(`Error cancelling task: ${o.message}`)}}async openTaskInspectorModal(e){this.closeModals();let t=document.getElementById("modal-task-inspector");if(!t)return;let o=document.getElementById("modal-task-title"),n=document.getElementById("modal-task-body"),a=document.getElementById("modal-task-footer");if(o)o.textContent=`Task Inspector: ${e}`;if(n)n.innerHTML=`
      ...
      `;t.classList.add("active");try{let s=await b.getTask(e);if(!s.ok||!s.task){if(n)n.innerHTML=`
            <div style="background: rgba(248, 113, 113, 0.12); border: 1px solid rgba(248, 113, 113, 0.3); border-radius: var(--radius-sm); padding: 16px; color: var(--red-400);">
              ...
              <div style="font-family: var(--ff-mono); font-size: 11.5px;">${y(s.error?.message||"Task not found in runtime registry")}</div>
            </div>
          `;return}let r=s.task,i=r.progress!==void 0?Math.round(r.progress*100):r.status==="completed"?100:r.status==="working"?50:0,l=Math.floor(Date.now()/1000),p=r.expiresAtEpochSecs?Math.max(0,r.expiresAtEpochSecs-l):r.ttlSeconds||300,u=r.status==="completed"||r.status==="cancelled"||r.status==="failed",g=r.status==="completed"?"var(--green-400)":r.status==="working"?"var(--cyan-400)":r.status==="input_required"?"var(--amber-300)":r.status==="cancelled"?"var(--text-muted)":"var(--red-400)",h=r.status==="completed"?"rgba(52, 211, 153, 0.15)":r.status==="working"?"rgba(56, 189, 248, 0.15)":r.status==="input_required"?"rgba(245, 158, 11, 0.18)":r.status==="cancelled"?"rgba(148, 163, 184, 0.15)":"rgba(248, 113, 113, 0.15)",d=!!r.error,m=r.result!==void 0&&r.result!==null,f=r.inputRequests&&Object.keys(r.inputRequests).length>0;if(n)n.innerHTML=`
            ...
            <div>
              <div style="display: flex; align-items: center; gap: 8px;">
                <span class="brand-badge" style="background: ${h}; color: ${g}; border-color: ${g}; font-size: 11px;">
                  ${y(r.status.toUpperCase())}
                </span>
                <span style="font-family: var(--ff-mono); font-size: 13px; font-weight: 700; color: var(--text-main);">
                  ${y(r.capabilityId||"Tool Execution")}
                </span>
                ${r.serverId?`<span style="font-size: 11px; color: var(--text-dim);">via <code style="color: var(--cyan-400);">${y(r.serverId)}</code></span>`:""}
              </div>
              <div style="font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim); margin-top: 4px;">
                Task ID: <span style="color: var(--text-muted);">${y(r.taskId)}</span>
              </div>
            </div>
            <div style="text-align: right; font-family: var(--ff-mono); font-size: 11px;">
              <div style="color: var(--text-dim);">Created: <span style="color: var(--text-muted);">${r.createdAtEpochSecs?new Date(r.createdAtEpochSecs*1000).toLocaleString():r.createdAt?new Date(r.createdAt).toLocaleString():"—"}</span></div>
          ...
          <div style="margin-bottom: 16px;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px; font-family: var(--ff-mono); font-size: 11px;">
              ...
              <span style="color: ${g}; font-weight: 700;">${i}% ${r.total?`(step ${Math.round((r.progress||0)*r.total)} of ${r.total})`:""}</span>
            </div>
          ...
          ${r.context?`
            <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; font-family: var(--ff-mono); font-size: 11px; display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 14px; color: var(--text-muted);">
              ${r.context.actor_id?`<div><span style="color: var(--text-dim);">Actor:</span> <span style="color: var(--cyan-400);">${y(r.context.actor_id)}</span></div>`:""}
              ${r.context.operation_id?`<div><span style="color: var(--text-dim);">Operation:</span> <span style="color: var(--text-main);">${y(r.context.operation_id)}</span></div>`:""}
              ${r.context.grant_id?`<div><span style="color: var(--text-dim);">Grant:</span> <span style="color: var(--text-main);">${y(r.context.grant_id)}</span></div>`:""}
            </div>
          `:""}
          ...
          ${d?`
            <div style="background: rgba(248, 113, 113, 0.1); border: 1px solid rgba(248, 113, 113, 0.3); border-radius: var(--radius-sm); padding: 12px; margin-bottom: 14px;">
              ...
              <pre style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--red-300); white-space: pre-wrap; word-break: break-word; margin: 0;">${y(typeof r.error==="string"?r.error:JSON.stringify(r.error,null,2))}</pre>
            </div>
          `:""}
          ...
          ${f?`
            <div style="margin-bottom: 14px;">
              ...
              <pre style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 12px; font-family: var(--ff-mono); font-size: 11.5px; color: var(--amber-300); white-space: pre-wrap; word-break: break-word; max-height: 180px; overflow-y: auto; margin: 0;">${y(JSON.stringify(r.inputRequests,null,2))}</pre>
            </div>
          `:""}
          ...
          <div style="margin-bottom: 8px;">
            ...
            <pre style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 12px; font-family: var(--ff-mono); font-size: 11.5px; color: var(--text-main); white-space: pre-wrap; word-break: break-word; max-height: 220px; overflow-y: auto; margin: 0;">${y(m?JSON.stringify(r.result,null,2):r.status==="working"?"Task execution is currently in-flight in background worker pool.":"No output payload recorded.")}</pre>
          </div>
        `;if(a)a.innerHTML=`
          <div>
            ${!u?`
              <button class="btn btn-danger" style="font-size: 11.5px;" onclick="window.app.promptCancelTask('${y(r.taskId)}'); window.app.closeModals();">
                ⛔ Cancel Task
              </button>
            `:`
              <span style="font-family: var(--ff-mono); font-size: 11px; color: var(--text-dim);">Task is terminal (${y(r.status)})</span>
            `}
          </div>
          <div style="display: flex; gap: 8px;">
            <button class="btn btn-ghost" style="font-size: 11.5px;" onclick="navigator.clipboard.writeText('${y(r.taskId)}'); alert('Task ID copied to clipboard');">
              \uD83D\uDCCB Copy Task ID
            </button>
        ...
        `}catch(s){if(n)n.innerHTML=`
          <div style="color: var(--red-400); font-family: var(--ff-mono); font-size: 11.5px;">
            Failed to inspect task: ${y(s.message)}
          </div>
        `}}async submitApproval(e){let t=document.getElementById(`appr-operator-${e}`),o=document.getElementById(`appr-args-${e}`),n=t?.value.trim()||"security-operator",a=void 0;if(o&&o.value.trim())try{a=JSON.parse(o.value.trim())}catch{alert("Invalid JSON in arguments editor");return}let s=await b.approveTicket(e,n,a);if(s.ok)await this.refreshApprovals(),await this.refreshTasks();else alert(`Approval failed: ${s.error||"Unknown error"}`)}async promptReject(e){let t=prompt("Reason for rejection (will be returned to the calling agent):");if(t===null)return;let n=document.getElementById(`appr-operator-${e}`)?.value.trim()||"security-operator",a=await b.rejectTicket(e,n,t);if(a.ok)await this.refreshApprovals(),await this.refreshTasks();else alert(`Rejection failed: ${a.error||"Unknown error"}`)}setPlaygroundMode(e){c.setState({playgroundMode:e})}selectCapability(e){c.setState({selectedCapabilityId:e});let t=c.getState().capabilities.find((n)=>n.id===e),o=document.getElementById("pg-args-input");if(t){let n=Y(t.input_schema,!1),a=JSON.stringify(n,null,2);if(o)o.value=a;let s={...c.getState().playgroundArgs||{}};s[e]=a,c.getState().playgroundArgs=s}}selectResource(e){c.setState({selectedResourceId:e})}selectPrompt(e){c.setState({selectedPromptId:e})}filterResources(e){let t=e.toLowerCase().trim(),n=(c.getState().resources||[]).filter((s)=>s.id.toLowerCase().includes(t)||s.name&&s.name.toLowerCase().includes(t)||s.uri&&s.uri.toLowerCase().includes(t)||s.server&&s.server.toLowerCase().includes(t)),a=document.getElementById("pg-res-list");if(a)if(n.length===0)a.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No resources match "${y(e)}"
          </div>
        `;else a.innerHTML=n.map((s)=>{let r=s.id===c.getState().selectedResourceId?"active":"",i=s.uri?s.uri.split(":")[0]:"res";return`
            <div class="cap-item ${r}" onclick="window.app.selectResource('${y(s.id)}')">
              <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          `}).join("")}filterPrompts(e){let t=e.toLowerCase().trim(),n=(c.getState().prompts||[]).filter((s)=>s.id.toLowerCase().includes(t)||s.name&&s.name.toLowerCase().includes(t)||s.description&&s.description.toLowerCase().includes(t)||s.server&&s.server.toLowerCase().includes(t)),a=document.getElementById("pg-prompt-list");if(a)if(n.length===0)a.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No prompts match "${y(e)}"
          </div>
        `;else a.innerHTML=n.map((s)=>{let r=s.id===c.getState().selectedPromptId?"active":"",i=s.arguments?s.arguments.length:0;return`
            <div class="cap-item ${r}" onclick="window.app.selectPrompt('${y(s.id)}')">
              <div style="display: flex; justify-content: space-between; align-items: center;">
                <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${y(s.name||s.id)}</span>
          ...
          `}).join("")}updatePlaygroundArgs(e){let t=c.getState(),o=t.selectedCapabilityId||(t.capabilities[0]?t.capabilities[0].id:null);if(!o)return;let n={...t.playgroundArgs||{}};n[o]=e,t.playgroundArgs=n}fillPlaygroundSampleArgs(e=!1){let t=c.getState(),o=t.selectedCapabilityId||(t.capabilities[0]?t.capabilities[0].id:null),n=t.capabilities.find((i)=>i.id===o),a=document.getElementById("pg-args-input");if(!a)return;if(!n||!n.input_schema){if(a.value="{}",o){let i={...t.playgroundArgs||{}};i[o]="{}",t.playgroundArgs=i}return}let s=Y(n.input_schema,e),r=JSON.stringify(s,null,2);if(a.value=r,o){let i={...t.playgroundArgs||{}};i[o]=r,t.playgroundArgs=i}}formatPlaygroundArgs(){let e=c.getState(),t=e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:null),o=document.getElementById("pg-args-input");if(o)try{let n=JSON.parse(o.value||"{}"),a=JSON.stringify(n,null,2);if(o.value=a,t){let s={...e.playgroundArgs||{}};s[t]=a,e.playgroundArgs=s}}catch(n){alert(`Cannot format JSON: ${n.message}`)}}insertPlaygroundArgKey(e,t,o){let n=c.getState(),a=n.selectedCapabilityId||(n.capabilities[0]?n.capabilities[0].id:null),s=document.getElementById("pg-args-input");if(s){let r={};try{r=JSON.parse(s.value||"{}")}catch{r={}}if(r[e]===void 0)if(o!==null&&o!==void 0)r[e]=o;else switch(t){case"string":r[e]=`sample_${e}`;break;case"number":case"integer":r[e]=0;break;case"boolean":r[e]=!0;break;case"array":r[e]=[];break;case"object":r[e]={};break;default:r[e]=`sample_${e}`}let i=JSON.stringify(r,null,2);if(s.value=i,a){let l={...n.playgroundArgs||{}};l[a]=i,n.playgroundArgs=l}}}fillBatchStepSampleArgs(e){let t=c.getState(),o=[...t.batchSteps||[]],n=o[e];if(!n||!n.capability_id)return;let a=t.capabilities.find((l)=>l.id===n.capability_id);if(!a||!a.input_schema)return;let s=a.input_schema.properties||{},r={};for(let[l,p]of Object.entries(s))if(p.default!==void 0)r[l]=p.default;else if(Array.isArray(p.enum)&&p.enum.length>0)r[l]=p.enum[0];else switch(p.type||"string"){case"string":r[l]=`sample_${l}`;break;case"number":case"integer":r[l]=0;break;case"boolean":r[l]=!0;break;case"array":r[l]=[];break;case"object":r[l]={};break;default:r[l]=`sample_${l}`}let i=JSON.stringify(r,null,2);o[e]={...o[e],argsJson:i},c.setState({batchSteps:o})}filterCapabilities(e){let t=e.toLowerCase().trim(),n=c.getState().capabilities.filter((s)=>s.id.toLowerCase().includes(t)||s.summary&&s.summary.toLowerCase().includes(t)||s.server&&s.server.toLowerCase().includes(t)),a=document.getElementById("pg-cap-list");if(a)if(n.length===0)a.innerHTML=`
          <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
            No capabilities match "${y(e)}"
          </div>
        `;else a.innerHTML=n.map((s)=>`
          <div class="cap-item ${s.id===c.getState().selectedCapabilityId?"active":""}" onclick="window.app.selectCapability('${y(s.id)}')">
            <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        `).join("")}async executePlaygroundTool(){let e=c.getState(),t=e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:null);if(!t)return;let o=document.getElementById("pg-args-input")?.value||"{}",n=document.getElementById("pg-context-input")?.value||void 0,a=document.getElementById("pg-jsonpath-input")?.value.trim()||void 0,s=document.getElementById("pg-limit-lines-input")?.value.trim()||void 0,r=document.getElementById("pg-truncate-bytes-input")?.value.trim()||void 0,i={};try{i=JSON.parse(o)}catch{alert("Invalid arguments JSON object");return}if(a)i._jsonpath=a;if(s&&!isNaN(Number(s)))i._limit_lines=Number(s);if(r&&!isNaN(Number(r)))i._truncate_bytes=Number(r);let l=`op-${Date.now()}`;c.setState({isExecuting:!0,activeRequestId:l});let p=e.activeProfile||void 0,u=e.playgroundAsyncTask||!1;try{let g=await b.callCapability({capability_id:t,args:i,request_id:l,async_task:u?!0:void 0,context:{operation_id:n||l}},p);if(c.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:g.status,durationMs:g.durationMs,data:g.data}}),g.status===202||g.data?.resultType==="task")this.refreshTasks();c.addEventLog("POST",`/v1/tools/call → ${t}`,g.status===200?"200 OK":`HTTP ${g.status}`,`${g.durationMs.toFixed(1)}ms`),b.getConfig().then((h)=>{if(h.ok&&h.circuit_breakers)c.setState({circuitBreakers:h.circuit_breakers})})}catch(g){c.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:500,durationMs:0,data:{error:g.toString()}}})}}async cancelActiveOperation(){let t=c.getState().activeRequestId;if(t)try{await b.cancelOperation(t)}catch(o){console.warn("Failed to send cancel signal:",o)}c.setState({isExecuting:!1,activeRequestId:null,executionResult:{status:499,durationMs:0,data:{ok:!1,error:{code:"CANCELLED",message:"Operation cancelled by operator"}}}})}openBatchModal(){let e=c.getState(),t=e.batchSteps;if(!t||t.length===0)t=[{id:"step_1",capability_id:e.selectedCapabilityId||(e.capabilities[0]?e.capabilities[0].id:""),argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],c.setState({batchSteps:t});c.setState({isBatchModalOpen:!0})}closeBatchModal(){c.setState({isBatchModalOpen:!1})}addBatchStep(){let t=[...c.getState().batchSteps||[]],o=t.length+1;t.push({id:`step_${o}`,capability_id:"",argsJson:"{}",continue_on_error:!1}),c.setState({batchSteps:t})}removeBatchStep(e){let o=[...c.getState().batchSteps||[]];if(o.length<=1){alert("Pipeline must contain at least one execution step.");return}o.splice(e,1);let n=o.map((a,s)=>({...a,id:`step_${s+1}`}));c.setState({batchSteps:n})}updateBatchStepCapability(e,t){let n=[...c.getState().batchSteps||[]];if(n[e])n[e]={...n[e],capability_id:t},c.setState({batchSteps:n})}updateBatchStepContinueOnError(e,t){let n=[...c.getState().batchSteps||[]];if(n[e])n[e]={...n[e],continue_on_error:t},c.setState({batchSteps:n})}updateBatchStepArgs(e,t){let o=c.getState(),n=[...o.batchSteps||[]];if(n[e])n[e]={...n[e],argsJson:t},o.batchSteps[e].argsJson=t}appendBatchVariable(e,t){let n=[...c.getState().batchSteps||[]],a=document.getElementById(`batch-step-args-${e}`);if(a){let s=a.value,r=a.selectionStart||s.length,i=a.selectionEnd||s.length,l=s.substring(0,r)+t+s.substring(i);if(a.value=l,n[e])n[e]={...n[e],argsJson:l},c.setState({batchSteps:n})}}async executeBatchPipeline(){let e=c.getState(),t=e.batchSteps||[],o=[];for(let a=0;a<t.length;a++){let s=t[a];if(!s.capability_id){alert(`Please select a capability for Step ${a+1}`);return}let r={};try{r=JSON.parse(s.argsJson||"{}")}catch{alert(`Invalid JSON in Step ${a+1} arguments`);return}o.push({id:s.id||`step_${a+1}`,capability_id:s.capability_id,args:r,continue_on_error:s.continue_on_error})}c.setState({isBatchModalOpen:!1});let n=e.activeProfile||void 0;try{let a=await b.batchCallCapabilities(o,n);c.setState({executionResult:{status:a.status,durationMs:a.durationMs,data:a.data}}),c.addEventLog("POST",`/v1/tools/batch_call (${t.length} steps)`,a.status===200?"200 OK":`HTTP ${a.status}`,`${a.durationMs.toFixed(1)}ms`)}catch(a){c.setState({executionResult:{status:500,durationMs:0,data:{error:a.toString()}}})}}async executeReadResource(){let e=c.getState(),t=e.selectedResourceId||(e.resources[0]?e.resources[0].id:null);if(!t)return;let o=document.getElementById("pg-res-jsonpath-input")?.value.trim()||void 0,n=document.getElementById("pg-res-lines-input")?.value.trim()||void 0,a=document.getElementById("pg-res-bytes-input")?.value.trim()||void 0,s={resource_id:t};if(o)s._jsonpath=o;if(n&&!isNaN(Number(n)))s._limit_lines=Number(n);if(a&&!isNaN(Number(a)))s._truncate_bytes=Number(a);let r=e.activeProfile||void 0;try{let i=await b.readResource({resource_id:t,input_responses:s},r);c.setState({resourceReadResult:{status:i.status,durationMs:i.durationMs,data:i.data}}),c.addEventLog("POST",`/v1/resources/read → ${t}`,i.status===200?"200 OK":`HTTP ${i.status}`,`${i.durationMs.toFixed(1)}ms`)}catch(i){c.setState({resourceReadResult:{status:500,durationMs:0,data:{error:i.toString()}}})}}async executeGetPrompt(){let e=c.getState(),t=e.selectedPromptId||(e.prompts[0]?e.prompts[0].id:null);if(!t)return;let o=document.querySelectorAll(".prompt-arg-input"),n={};o.forEach((s)=>{let r=s,i=r.getAttribute("data-arg-name");if(i&&r.value.trim())n[i]=r.value.trim()});let a=e.activeProfile||void 0;try{let s=await b.getPrompt({prompt_id:t,arguments:n},a);c.setState({promptGetResult:{status:s.status,durationMs:s.durationMs,data:s.data}}),c.addEventLog("POST",`/v1/prompts/get → ${t}`,s.status===200?"200 OK":`HTTP ${s.status}`,`${s.durationMs.toFixed(1)}ms`)}catch(s){c.setState({promptGetResult:{status:500,durationMs:0,data:{error:s.toString()}}})}}toggleBatchPlayground(){let e=document.getElementById("pg-args-input");if(!e)return;let t=[{id:"step_1",capability_id:"sqlite.read_query",args:{query:"SELECT * FROM users LIMIT 2"}},{id:"step_2",capability_id:"github.issues.search",args:{query:"label:bug"},continue_on_error:!0}];e.value=JSON.stringify(t,null,2)}async submitPolicyRule(e){let t=e==="allow"?"policy-new-allow":e==="deny"?"policy-new-deny":e==="redact"?"policy-new-redact":"policy-new-requireApproval",o=document.getElementById(t);if(!o)return;let n=o.value.trim();if(!n)return;await this.addPolicyRule(e,n),o.value=""}async addPolicyRule(e,t){let o=(t||"").trim();if(!o)return;let n=c.getState(),a=n.activeProfile,s=a?n.config.profiles?.[a]:void 0;if(s&&a){let r=s.policy||{},i=[...r.allow||[]],l=[...r.deny||[]],p=[...r.redact_keys||r.redactKeys||[]],u=[...r.require_approval||r.requireApproval||[]];if(e==="allow"&&!i.includes(o))i.push(o);if(e==="deny"&&!l.includes(o))l.push(o);if(e==="redact"&&!p.includes(o))p.push(o);if(e==="requireApproval"&&!u.includes(o))u.push(o);let g={...r,allow:i,deny:l,redactKeys:p,requireApproval:u},h=await b.upsertProfile(a,s.servers,s.description,g);if(!h.ok)alert(`Failed to save profile policy rule: ${h.error||"Unknown error"}`)}else{let r=n.config.policy||{},i=[...r.allow||[]],l=[...r.deny||[]],p=[...r.redact_keys||r.redactKeys||[]],u=[...r.require_approval||r.requireApproval||[]];if(e==="allow"&&!i.includes(o))i.push(o);if(e==="deny"&&!l.includes(o))l.push(o);if(e==="redact"&&!p.includes(o))p.push(o);if(e==="requireApproval"&&!u.includes(o))u.push(o);let g=await b.savePolicy({...r,allow:i,deny:l,redact_keys:p,redactKeys:p,require_approval:u,requireApproval:u});if(!g.ok)alert(`Failed to save policy rule: ${g.error||"Unknown error"}`)}await this.refreshData()}async removePolicyRule(e,t){let o=c.getState(),n=o.activeProfile,a=n?o.config.profiles?.[n]:void 0;if(a&&n){let s=a.policy||{},r=[...s.allow||[]],i=[...s.deny||[]],l=[...s.redact_keys||s.redactKeys||[]],p=[...s.require_approval||s.requireApproval||[]];if(e==="allow")r.splice(t,1);if(e==="deny")i.splice(t,1);if(e==="redact")l.splice(t,1);if(e==="requireApproval")p.splice(t,1);let u={...s,allow:r,deny:i,redactKeys:l,requireApproval:p},g=await b.upsertProfile(n,a.servers,a.description,u);if(!g.ok)alert(`Failed to update profile policy: ${g.error||"Unknown error"}`)}else{let s=o.config.policy||{},r=[...s.allow||[]],i=[...s.deny||[]],l=[...s.redact_keys||s.redactKeys||[]],p=[...s.require_approval||s.requireApproval||[]];if(e==="allow")r.splice(t,1);if(e==="deny")i.splice(t,1);if(e==="redact")l.splice(t,1);if(e==="requireApproval")p.splice(t,1);let u=await b.savePolicy({...s,allow:r,deny:i,redact_keys:l,redactKeys:l,require_approval:p,requireApproval:p});if(!u.ok)alert(`Failed to update policy: ${u.error||"Unknown error"}`)}await this.refreshData()}async saveWebhookConfig(){let e=document.getElementById("policy-webhook-url"),t=document.getElementById("policy-webhook-format"),o=document.getElementById("policy-webhook-secret"),n=e?e.value.trim():"",a=t?t.value:"generic",s=o?o.value.trim():"",i=c.getState().config.policy||{},l=n?{url:n,format:a,secret:s&&!s.startsWith("WARMPLANE_")&&!s.includes("_")?s:void 0,secret_env:s&&(s.startsWith("WARMPLANE_")||s.includes("_"))?s:void 0,events:["approval.requested","circuit_breaker.tripped","policy.violation"]}:void 0,p=await b.savePolicy({...i,webhook:l});if(p.ok)alert("Webhook settings saved successfully");else alert(`Failed to save webhook settings: ${p.error||"Unknown error"}`);await this.refreshData()}async testWebhook(){let e=document.getElementById("policy-webhook-url"),t=document.getElementById("policy-webhook-format"),o=e?e.value.trim():void 0,n=t?t.value:void 0,a=document.getElementById("policy-webhook-status");if(a)a.textContent="Sending test event...",a.style.color="var(--cyan-400)";try{let s=await b.testWebhook(o,n);if(s.ok){if(alert(`Test webhook sent successfully! (${s.message})`),a)a.textContent=`✔ Test sent (HTTP ${s.status_code||200})`,a.style.color="var(--green-400)"}else if(alert(`Test webhook failed: ${s.error||"Unknown error"}`),a)a.textContent=`✖ Failed: ${s.error}`,a.style.color="var(--red-400)"}catch(s){alert(`Error sending test webhook: ${s.message}`)}}testPolicySandbox(e){let t=document.getElementById("policy-test-verdict");if(!t)return;let o=e.trim();if(!o){t.textContent="ENTER ID",t.style.color="var(--text-dim)";return}let n=c.getState(),a=n.activeProfile,s=a?n.config.profiles?.[a]:void 0,r=n.config.policy||{},i=s?.policy,l=r.deny||[],p=i?.deny||[],u=Array.from(new Set([...l,...p])),g=r.require_approval||r.requireApproval||[],h=i?.require_approval||i?.requireApproval||[],d=Array.from(new Set([...g,...h])),m=i&&i.allow&&i.allow.length>0?i.allow:r.allow||[],f=(v,x)=>{if(v==="*")return!0;if(v.endsWith("*"))return x.startsWith(v.slice(0,-1));return v===x};if(u.some((v)=>f(v,o))){t.textContent="DENIED (Strict Block)",t.style.color="var(--red-400)";return}if(m.length>0&&!m.some((v)=>f(v,o))){t.textContent="DENIED (Not in Allow List)",t.style.color="var(--red-400)";return}if(d.some((v)=>f(v,o))){t.textContent="REQUIRE APPROVAL (HITL Gate)",t.style.color="var(--amber-400)";return}t.textContent="ALLOWED",t.style.color="var(--green-400)"}async deleteServer(e){let t=c.getState().activeProfile,o=t?`Permanently delete server '${e}' globally from warmplane configuration? (This will also unbind it from profile '${t}')`:`Are you sure you want to permanently remove server '${e}' from configuration?`;if(!confirm(o))return;try{let n=await b.deleteServer(e);if(n.ok)await this.refreshData();else alert(`Failed to remove server '${e}': ${n.error||"Unknown error"}`)}catch(n){alert(`Error removing server '${e}': ${n.message}`)}}async restartServer(e){try{let t=await b.restartServer(e);if(t.ok)await this.refreshData();else alert(`Failed to restart server '${e}': ${t.error||"Unknown error"}`)}catch(t){alert(`Error restarting server '${e}': ${t.message}`)}}openServerDiagnosticsModal(e){this.closeModals();let t=c.getState(),o=t.config.mcpServers?.[e],n=t.serverStatuses?.[e],a=(t.circuitBreakers||[]).find((l)=>l.server_id===e),s=document.getElementById("modal-server-diagnostics");if(!s)return;let r=document.getElementById("modal-diag-title"),i=document.getElementById("modal-diag-body");if(r)r.textContent=`Live Diagnostics: ${e}`;if(i){let l=n?.status==="degraded",p=l?"var(--amber-400)":n?.status==="connected"?"var(--green-400)":"var(--red-400)",u=n?.error||"No active crash or error reported. Server is healthy.";i.innerHTML=`
      ...
      `}s.classList.add("active")}openAddServerModal(){this.closeModals();let e=document.getElementById("modal-srv-title"),t=document.getElementById("modal-srv-template-banner"),o=document.getElementById("modal-srv-name"),n=document.getElementById("modal-srv-transport"),a=document.getElementById("modal-srv-command"),s=document.getElementById("modal-srv-url"),r=document.getElementById("modal-srv-ft"),i=document.getElementById("modal-srv-cd"),l=document.getElementById("modal-srv-autorestart"),p=document.getElementById("modal-srv-maxrestarts");if(e)e.textContent="Add Upstream MCP Server";if(t)t.style.display="flex";if(o)o.value="",o.disabled=!1;if(n)n.value="stdio";if(a)a.value="";if(s)s.value="";let u=document.getElementById("modal-group-cmd"),g=document.getElementById("modal-group-url");if(u)u.style.display="block";if(g)g.style.display="none";if(r)r.value="3";if(i)i.value="30000";if(l)l.value="true";if(p)p.value="5";let h=document.getElementById("modal-add-server");if(h)h.classList.add("active")}openEditServerModal(e){this.closeModals();let t=c.getState(),o=t.config.mcpServers?.[e];if(!o){alert(`Server '${e}' not found in configuration.`);return}let n=document.getElementById("modal-srv-title"),a=document.getElementById("modal-srv-template-banner"),s=document.getElementById("modal-srv-name"),r=document.getElementById("modal-srv-transport"),i=document.getElementById("modal-srv-command"),l=document.getElementById("modal-srv-url"),p=document.getElementById("modal-srv-ft"),u=document.getElementById("modal-srv-cd"),g=document.getElementById("modal-srv-autorestart"),h=document.getElementById("modal-srv-maxrestarts");if(n)n.textContent=`Edit Server '${e}'`;if(a)a.style.display="none";if(s)s.value=e,s.disabled=!0;let d=!!o.command;if(r)r.value=d?"stdio":"http";let m=document.getElementById("modal-group-cmd"),f=document.getElementById("modal-group-url");if(m)m.style.display=d?"block":"none";if(f)f.style.display=d?"none":"block";if(i)i.value=d?`${o.command} ${(o.args||[]).join(" ")}`.trim():"";if(l)l.value=o.url||"";let v=o.resilience||t.config.resilience;if(p)p.value=String(v?.failureThreshold??3);if(u)u.value=String(v?.cooldownMs??30000);if(g)g.value=v?.autoRestart===!1?"false":"true";if(h)h.value=String(v?.maxRestarts??5);let x=document.getElementById("modal-add-server");if(x)x.classList.add("active")}async submitAddServer(){let e=document.getElementById("modal-srv-name"),t=e?.value.trim(),o=document.getElementById("modal-srv-transport")?.value;if(!t){alert("Server name is required");return}if(e&&!e.disabled){if((c.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists in configuration. Do you want to overwrite it?`))return}}let n={};if(o==="stdio"){let u=(document.getElementById("modal-srv-command")?.value.trim()).split(/\s+/).filter(Boolean);if(u.length===0){alert("Command is required");return}n.command=u[0],n.args=u.slice(1)}else{let p=document.getElementById("modal-srv-url")?.value.trim();if(!p){alert("URL is required");return}n.url=p}let a=document.getElementById("modal-srv-ft")?.value.trim(),s=document.getElementById("modal-srv-cd")?.value.trim(),r=document.getElementById("modal-srv-autorestart")?.value,i=document.getElementById("modal-srv-maxrestarts")?.value.trim();if(a||s||r||i)n.resilience={failureThreshold:a?Number(a):3,cooldownMs:s?Number(s):30000,autoRestart:r!=="false",maxRestarts:i?Number(i):5};let l=await b.upsertServer(t,n);if(l.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${l.error}`)}openTemplateCatalog(){this.closeModals();let e=document.getElementById("modal-templates");if(e)e.classList.add("active");this.renderTemplateGrid()}setTemplateCategory(e){this.activeTemplateCategory=e,document.querySelectorAll(".tmpl-cat-btn").forEach((t)=>{if(t.getAttribute("data-category")===e)t.classList.add("active"),t.style.background="var(--surface-elevated)",t.style.color="var(--amber-400)";else t.classList.remove("active"),t.style.background="var(--surface-card)",t.style.color="var(--text-main)"}),this.renderTemplateGrid()}filterTemplates(e){this.activeTemplateFilter=e.toLowerCase().trim(),this.renderTemplateGrid()}renderTemplateGrid(){let e=document.getElementById("tmpl-grid");if(!e)return;let t=Z.filter((a)=>{let s=this.activeTemplateCategory==="all"||a.category===this.activeTemplateCategory,r=!this.activeTemplateFilter||a.name.toLowerCase().includes(this.activeTemplateFilter)||a.id.toLowerCase().includes(this.activeTemplateFilter)||a.description.toLowerCase().includes(this.activeTemplateFilter)||a.command.toLowerCase().includes(this.activeTemplateFilter)||a.envFields.some((i)=>i.key.toLowerCase().includes(this.activeTemplateFilter));return s&&r});if(t.length===0){e.innerHTML=`
        <div style="grid-column: span 2; padding: 32px; text-align: center; color: var(--text-dim);">
          No matching MCP server templates found.
        </div>
      `;return}let n=c.getState().config.mcpServers||{};e.innerHTML=t.map((a)=>{let s=!!n[a.id],r=`${a.command} ${a.defaultArgs.join(" ")}`;return`
      ...
      `}).join("")}selectTemplate(e){let t=Z.find((l)=>l.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let o=document.getElementById("modal-configure-template");if(o)o.classList.add("active");let n=document.getElementById("cfg-tmpl-title"),a=document.getElementById("cfg-tmpl-desc"),s=document.getElementById("cfg-tmpl-form");if(n)n.textContent=`Configure ${t.name} Server`;if(a)a.textContent=t.description;let r=c.getState().config.mcpServers||{},i=t.id;if(r[i]){let l=2;while(r[`${t.id}-${l}`])l++;i=`${t.id}-${l}`}if(s){let l="";if(t.envFields.length>0)l=`
      ...
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),o=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}if((c.getState().config.mcpServers||{})[t]){if(!confirm(`Server '${t}' already exists. Do you want to overwrite its configuration?`))return}let s=o?o.split(/\s+/).filter(Boolean):[],r={},i=document.querySelectorAll(".tmpl-env-input");for(let m of Array.from(i)){let f=m.getAttribute("data-key"),v=m.value.trim(),x=e.envFields.find((I)=>I.key===f);if(x?.required&&!v){alert(`Required field '${x.label}' is missing.`);return}if(f&&v)r[f]=v}let l={command:e.command,args:s};if(Object.keys(r).length>0)l.env=r;let p=document.getElementById("cfg-srv-ft")?.value.trim(),u=document.getElementById("cfg-srv-cd")?.value.trim(),g=document.getElementById("cfg-srv-autorestart")?.value,h=document.getElementById("cfg-srv-maxrestarts")?.value.trim();if(p||u||g||h)l.resilience={failureThreshold:p?Number(p):3,cooldownMs:u?Number(u):30000,autoRestart:g!=="false",maxRestarts:h?Number(h):5};let d=await b.upsertServer(t,l);if(d.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${d.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let o=await b.getEcosystemSources();if(o.sources&&o.sources.length>0)t.innerHTML=o.sources.map((n)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await b.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}async refreshClients(){try{let e=await b.getClients();if(e.ok&&Array.isArray(e.clients))c.setState({clients:e.clients})}catch(e){console.error("Failed to scan clients:",e)}}setClientCategoryFilter(e){c.setState({clientFilterCategory:e})}setClientSearchQuery(e){c.setState({clientSearchQuery:e})}async attachClient(e,t){let o=t;if(!o){let a=document.getElementById(`client-prof-${e}`)||document.getElementById(`overview-client-prof-${e}`);if(a)o=a.value||void 0;else o=c.getState().activeProfile||void 0}let n=await b.attachClient(e,o);if(!n.ok)alert(`Failed to attach client: ${n.error||n.message||"Unknown error"}`);else await this.refreshData()}async detachClient(e){if(!confirm("Disconnect Warmplane from this client?"))return;let t=await b.detachClient(e);if(!t.ok)alert(`Failed to detach client: ${t.error||t.message||"Unknown error"}`);else await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let o=(e||"").trim().toLowerCase();if(o.length<2){t.style.display="none";return}let a=c.getState().capabilities.filter((s)=>s.id.toLowerCase().includes(o)||s.summary&&s.summary.toLowerCase().includes(o)||s.description&&s.description.toLowerCase().includes(o)||s.server&&s.server.toLowerCase().includes(o)).slice(0,8);if(a.length===0){t.style.display="none";return}t.innerHTML=a.map((s)=>`
...
Warnings:
${e.warnings.join(`
`)}`;alert(t)}else alert(`Hot-reload failed: ${e.error||"Unknown error"}`)}catch(e){alert(`Error reaching daemon: ${e.message}`)}await this.refreshData()}renderTopProfileSelector(){let e=document.getElementById("top-profile-selector");if(!e)return;let t=c.getState(),o=t.config.profiles||{},n=Object.keys(o),a=t.activeProfile,s='<option value="">All Servers (Unrestricted)</option>';for(let r of n){let i=a===r?"selected":"";s+=`<option value="${y(r)}" ${i}>Profile: ${y(r)}</option>`}e.innerHTML=s}async setActiveProfile(e){c.setState({activeProfile:e||null}),await this.refreshData()}openAddProfileModal(){let e=document.getElementById("modal-prof-title");if(e)e.textContent="Create Server Constellation Profile";let t=document.getElementById("modal-prof-name"),o=document.getElementById("modal-prof-desc"),n=document.getElementById("modal-prof-mode");if(t)t.value="",t.disabled=!1;if(o)o.value="";if(n)n.value="create";let a=document.getElementById("modal-prof-allow"),s=document.getElementById("modal-prof-deny"),r=document.getElementById("modal-prof-hitl"),i=document.getElementById("modal-prof-redact");if(a)a.value="";if(s)s.value="";if(r)r.value="";if(i)i.value="";this.renderProfileServerCheckboxes([]);let l=document.getElementById("modal-add-profile");if(l)l.classList.add("active")}openEditProfileModal(e){let o=c.getState().config.profiles?.[e];if(!o)return;let n=document.getElementById("modal-prof-title");if(n)n.textContent=`Edit Profile: ${e}`;let a=document.getElementById("modal-prof-name"),s=document.getElementById("modal-prof-desc"),r=document.getElementById("modal-prof-mode");if(a)a.value=e,a.disabled=!0;if(s)s.value=o.description||"";if(r)r.value="edit";let i=document.getElementById("modal-prof-allow"),l=document.getElementById("modal-prof-deny"),p=document.getElementById("modal-prof-hitl"),u=document.getElementById("modal-prof-redact"),g=o.policy;if(i)i.value=(g?.allow||[]).join(", ");if(l)l.value=(g?.deny||[]).join(", ");if(p)p.value=(g?.require_approval||g?.requireApproval||[]).join(", ");if(u)u.value=(g?.redact_keys||g?.redactKeys||[]).join(", ");this.renderProfileServerCheckboxes(o.servers||[]);let h=document.getElementById("modal-add-profile");if(h)h.classList.add("active")}renderProfileServerCheckboxes(e){let t=document.getElementById("modal-prof-servers-list");if(!t)return;let o=c.getState(),n=Object.keys(o.config.mcpServers||{});if(n.length===0){t.innerHTML='<div style="font-size: 11.5px; color: var(--text-dim);">No MCP servers configured yet. Add servers first.</div>';return}t.innerHTML=n.map((a)=>{let s=e.includes(a)?"checked":"";return`
        <label style="display: flex; align-items: center; gap: 8px; font-size: 12px; cursor: pointer; padding: 4px 6px; border-radius: var(--radius-sm); transition: background 0.15s;" onmouseover="this.style.background='var(--surface-hover)'" onmouseout="this.style.background='transparent'">
          <input type="checkbox" class="prof-server-checkbox" value="${y(a)}" ${s} style="accent-color: var(--amber-400);">
          <span style="font-family: var(--ff-mono); font-weight: 600; color: var(--text-main);">${y(a)}</span>
        </label>
      `}).join("")}async saveProfile(){let e=document.getElementById("modal-prof-name"),t=document.getElementById("modal-prof-desc"),o=e?.value.trim(),n=t?.value.trim();if(!o){alert("Please enter a profile name");return}let a=document.querySelectorAll(".prof-server-checkbox:checked"),s=[];if(a.forEach((v)=>{s.push(v.value)}),s.length===0){alert("Please select at least one server to include in this constellation");return}let r=(v)=>{if(!v)return[];return v.split(",").map((x)=>x.trim()).filter((x)=>x.length>0)},i=document.getElementById("modal-prof-allow"),l=document.getElementById("modal-prof-deny"),p=document.getElementById("modal-prof-hitl"),u=document.getElementById("modal-prof-redact"),g=r(i?.value),h=r(l?.value),d=r(p?.value),m=r(u?.value),f=void 0;if(g.length>0||h.length>0||d.length>0||m.length>0)f={allow:g,deny:h,requireApproval:d,redactKeys:m};try{let v=await b.upsertProfile(o,s,n||void 0,f);if(v.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save profile: ${v.error||"Unknown error"}`)}catch(v){alert(`Error saving profile: ${v.message}`)}}async deleteProfile(e){if(!confirm(`Are you sure you want to delete profile '${e}'?`))return;try{let t=await b.deleteProfile(e);if(t.ok){if(c.getState().activeProfile===e)c.setState({activeProfile:null});await this.refreshData()}else alert(`Failed to delete profile: ${t.error||"Unknown error"}`)}catch(t){alert(`Error deleting profile: ${t.message}`)}}async toggleServerInProfile(e,t,o){let a=c.getState().config.profiles?.[e];if(!a)return;let s=[...a.servers||[]];if(o){if(!s.includes(t))s.push(t)}else if(s=s.filter((r)=>r!==t),s.length===0){alert("A profile must contain at least one server. To remove the profile, delete it in the Profiles tab.");return}try{let r=await b.upsertProfile(e,s,a.description,a.policy);if(r.ok)await this.refreshData();else alert(`Failed to update profile constellation: ${r.error||"Unknown error"}`)}catch(r){alert(`Error updating profile constellation: ${r.message}`)}}closeModals(){document.querySelectorAll(".modal-backdrop").forEach((e)=>e.classList.remove("active"))}}function y(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var ue=new pe;window.app=ue;window.addEventListener("DOMContentLoaded",()=>ue.init());
