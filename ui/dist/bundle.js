class N{state={configPath:"mcp_servers.json",config:{mcpServers:{}},serverStatuses:{},circuitBreakers:[],capabilities:[],resources:[],prompts:[],catalogEvents:[],approvals:[],auditEvents:[],auditTotal:0,auditFilters:{search:"",status:"all",eventType:"all",serverId:"all",limit:25,offset:0},auditSelectedEvent:null,auditStats:null,auditVerification:null,selectedCapabilityId:null,selectedResourceId:null,selectedPromptId:null,playgroundMode:"tools",isExecuting:!1,activeRequestId:null,isBatchModalOpen:!1,batchSteps:[{id:"step_1",capability_id:"",argsJson:"{}",continue_on_error:!1},{id:"step_2",capability_id:"",argsJson:"{}",continue_on_error:!0}],activeTab:"overview",eventLogs:[],executionResult:null,resourceReadResult:null,promptGetResult:null,metrics:{totalCatalogRequests:0,totalEtagHits:0,totalToolCalls:0,totalToolDurationUs:0}};listeners=[];getState(){return this.state}setState(e){this.state={...this.state,...e},this.listeners.forEach((t)=>t(this.state))}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter((t)=>t!==e)}}addEventLog(e,t,i,r){let a=[{time:new Date().toLocaleTimeString(),method:e,target:t,status:i,latency:r},...this.state.eventLogs].slice(0,50);this.setState({eventLogs:a})}}var s=new N;class D{baseUrl;constructor(e=""){this.baseUrl=e}async getConfig(){return(await fetch(`${this.baseUrl}/v1/config`)).json()}async listCapabilities(){return(await fetch(`${this.baseUrl}/v1/capabilities`)).json()}async listResources(){return(await fetch(`${this.baseUrl}/v1/resources`)).json()}async readResource(e){let t=performance.now(),i=await fetch(`${this.baseUrl}/v1/resources/read`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),r=performance.now()-t,o=await i.json();return{status:i.status,durationMs:r,data:o}}async listPrompts(){return(await fetch(`${this.baseUrl}/v1/prompts`)).json()}async getPrompt(e){let t=performance.now(),i=await fetch(`${this.baseUrl}/v1/prompts/get`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),r=performance.now()-t,o=await i.json();return{status:i.status,durationMs:r,data:o}}async getCatalogEvents(e){let t=e?`?after=${encodeURIComponent(e)}`:"";return(await fetch(`${this.baseUrl}/v1/catalog/events${t}`)).json()}async callCapability(e){let t=performance.now(),i=await fetch(`${this.baseUrl}/v1/tools/call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),r=performance.now()-t,o=await i.json();return{status:i.status,durationMs:r,data:o}}async batchCallCapabilities(e){let t=performance.now(),i=await fetch(`${this.baseUrl}/v1/tools/batch_call`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({steps:e})}),r=performance.now()-t,o=await i.json();return{status:i.status,durationMs:r,data:o}}async cancelOperation(e){return(await fetch(`${this.baseUrl}/v1/operations/${encodeURIComponent(e)}/cancel`,{method:"POST"})).json()}async completeArgument(e){return(await fetch(`${this.baseUrl}/v1/completion/complete`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async upsertServer(e,t){return(await fetch(`${this.baseUrl}/v1/config/servers`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e,server:t})})).json()}async deleteServer(e){return(await fetch(`${this.baseUrl}/v1/config/servers/${encodeURIComponent(e)}`,{method:"DELETE"})).json()}async getEcosystemSources(){return(await fetch(`${this.baseUrl}/v1/config/ecosystem`)).json()}async importConfig(e,t=!1){return(await fetch(`${this.baseUrl}/v1/config/import`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({source_path:e,overwrite:t})})).json()}async savePolicy(e){let t={allow:e.allow||[],deny:e.deny||[],redactKeys:e.redact_keys||e.redactKeys||[],requireApproval:e.require_approval||e.requireApproval||[],approvalTimeoutSecs:e.approvalTimeoutSecs||e.approval_timeout_secs||300,webhook:e.webhook};return(await fetch(`${this.baseUrl}/v1/config/policy`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})).json()}async listApprovals(){return(await fetch(`${this.baseUrl}/v1/approvals`)).json()}async approveTicket(e,t,i){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,modified_args:i})})).json()}async rejectTicket(e,t,i){return(await fetch(`${this.baseUrl}/v1/approvals/${encodeURIComponent(e)}/reject`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({operator:t,reason:i})})).json()}async updateAlias(e,t,i){return(await fetch(`${this.baseUrl}/v1/config/alias`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({kind:e,alias:t,target:i})})).json()}async reloadConfig(){return(await fetch(`${this.baseUrl}/v1/config/reload`,{method:"POST"})).json()}async listAuditEvents(e){let t=new URLSearchParams;if(e?.actor_id)t.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")t.set("server_id",e.server_id);if(e?.capability_id)t.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")t.set("event_type",e.event_type);if(e?.status&&e.status!=="all")t.set("status",e.status);if(e?.trace_id)t.set("trace_id",e.trace_id);if(e?.request_id)t.set("request_id",e.request_id);if(e?.search)t.set("search",e.search);if(e?.limit)t.set("limit",String(e.limit));if(e?.offset!==void 0)t.set("offset",String(e.offset));let i=t.toString();return(await fetch(`${this.baseUrl}/v1/audit/events${i?`?${i}`:""}`)).json()}getAuditExportUrl(e,t="csv"){let i=new URLSearchParams;if(i.set("format",t),e?.actor_id)i.set("actor_id",e.actor_id);if(e?.server_id&&e.server_id!=="all")i.set("server_id",e.server_id);if(e?.capability_id)i.set("capability_id",e.capability_id);if(e?.event_type&&e.event_type!=="all")i.set("event_type",e.event_type);if(e?.status&&e.status!=="all")i.set("status",e.status);if(e?.trace_id)i.set("trace_id",e.trace_id);if(e?.request_id)i.set("request_id",e.request_id);if(e?.search)i.set("search",e.search);return`${this.baseUrl}/v1/audit/export?${i.toString()}`}async verifyAuditChain(){return(await fetch(`${this.baseUrl}/v1/audit/verify`)).json()}async getAuditStats(){return(await fetch(`${this.baseUrl}/v1/audit/stats`)).json()}}var u=new D;function q(){let e=s.getState(),t=e.config.mcpServers||{},i=Object.keys(t),r=i.length,o="";if(i.length===0)o=`
  ...
  `).join(""),n=e.metrics,l=n.totalCatalogRequests,p=n.totalEtagHits,d=l>0?`${(p/l*100).toFixed(1)}%`:"0.0%",g=l>0?`${p} of ${l} requests served via HTTP 304`:"Waiting for client requests",m=n.totalToolCalls,f=m>0?`${(n.totalToolDurationUs/m/1000).toFixed(1)}ms`:"0.0ms",_=m>0?`${m} tool executions processed`:"Local worker task queues warm",h=Object.keys(e.config.capabilityAliases||{}).length+Object.keys(e.config.resourceAliases||{}).length+Object.keys(e.config.promptAliases||{}).length,k=h>0?`${h*18}B / call`:"0B",$=h>0?`${h} active facade aliases pruning prompt size`:"Configure aliases in Studio to reduce prompt size";return`
  ...
  `}function A(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function E(){let e=s.getState(),t=e.config.mcpServers||{},i=Object.keys(t),r="";if(i.length===0)r=`
    ...
    `;else r=i.map((o)=>{let a=t[o],n=a.command?"stdio":"http / sse",l=a.command?`${a.command} ${(a.args||[]).join(" ")}`:a.url,p=e.serverStatuses[o]||{status:"connected",protocol_version:"2026-07-28"},d=a.env?Object.keys(a.env).map((x)=>`${x}=***`).join(", "):"None",g=(e.circuitBreakers||[]).find((x)=>x.server_id===o),m='<span class="brand-badge" style="color: var(--green-400); border-color: rgba(52, 211, 153, 0.25);">Circuit: CLOSED</span>';if(g){if(g.state==="open")m=`<span class="brand-badge" style="color: var(--red-400); border-color: rgba(248, 113, 113, 0.4); background: rgba(248, 113, 113, 0.1);">Circuit: OPEN (${g.consecutive_failures} failures)</span>`;else if(g.state==="half_open")m=`<span class="brand-badge" style="color: var(--amber-300); border-color: rgba(251, 191, 36, 0.4); background: rgba(251, 191, 36, 0.1);">Circuit: HALF-OPEN (${g.consecutive_successes} probe)</span>`}let f=a.resilience||e.config.resilience,_=f?`FT: ${f.failureThreshold||3} · Cooldown: ${(f.cooldownMs||30000)/1000}s · AutoRestart: ${f.autoRestart!==!1?"ON":"OFF"}`:"Default Resilience",h=p.status==="degraded",k=p.status==="error"||p.status==="disconnected",$=h?"var(--amber-400)":k?"var(--red-400)":"var(--green-400)";return`
    ...
    ${r}
  `}function C(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function U(){let e=s.getState(),t=e.playgroundMode||"tools",i=e.capabilities||[],r=e.resources||[],o=e.prompts||[],a=`
  ...
  `}function V(e){let t=e.capabilities||[],i=e.selectedCapabilityId||(t.length>0?t[0].id:null),r=t.find((l)=>l.id===i),o=!!e.isExecuting,a="";if(t.length===0)a=`
    ...
    `;else a=t.map((l)=>{return`
        <div class="cap-item ${l.id===i?"active":""}" onclick="window.app.selectCapability('${c(l.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${c(l.id)}</span>
            <span style="font-size: 10px; color: var(--green-400);">${c(l.mode||"read")}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">server: ${c(l.server||"local")}</div>
        </div>
      `}).join("");let n=r&&r.input_schema?JSON.stringify(r.input_schema.properties||{},null,2):"{}";return`
      ...
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); display: flex; flex-direction: column; overflow: hidden;">
        ...
        <div style="flex: 1; display: grid; grid-template-columns: 1fr 1fr; overflow: hidden;">
          ...
          <div style="padding: 16px; border-right: 1px solid var(--border); overflow-y: auto;">
            ...
            <textarea class="form-textarea" rows="7" id="pg-args-input">${c(n)}</textarea>
  ...
  `}function H(e){let t=e.resources||[],i=e.selectedResourceId||(t.length>0?t[0].id:null),r=t.find((n)=>n.id===i),o=e.resourceReadResult,a="";if(t.length===0)a=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No resources exposed by connected MCP servers.
      </div>
    `;else a=t.map((n)=>{let l=n.id===i?"active":"",p=n.uri?n.uri.split(":")[0]:"res";return`
        <div class="cap-item ${l}" onclick="window.app.selectResource('${c(n.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${c(n.name||n.id)}</span>
            <span class="badge" style="font-size: 9.5px; background: rgba(56, 189, 248, 0.15); color: var(--cyan-400);">${c(p)}</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${c(n.uri)}</div>
          <div style="display: flex; justify-content: space-between; font-size: 10px; color: var(--text-muted); margin-top: 4px;">
            <span>server: ${c(n.server||"local")}</span>
            <span>${c(n.mime_type||"text/plain")}</span>
          </div>
        </div>
      `}).join("");return`
  ...
  `}function ee(e){let t=e.prompts||[],i=e.selectedPromptId||(t.length>0?t[0].id:null),r=t.find((l)=>l.id===i),o=e.promptGetResult,a="";if(t.length===0)a=`
      <div style="padding: 24px 16px; text-align: center; color: var(--text-dim); font-size: 11.5px;">
        No prompt templates registered by connected MCP servers.
      </div>
    `;else a=t.map((l)=>{let p=l.id===i?"active":"",d=l.arguments?l.arguments.length:0;return`
        <div class="cap-item ${p}" onclick="window.app.selectPrompt('${c(l.id)}')">
          <div style="display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: 600; color: var(--text-main); font-family: var(--ff-mono); font-size: 12px;">${c(l.name||l.id)}</span>
            <span class="badge" style="font-size: 9.5px; background: rgba(168, 85, 247, 0.15); color: var(--purple-400);">${d} args</span>
          </div>
          <div style="font-size: 11px; color: var(--text-dim); margin-top: 2px;">${c(l.description||l.title||"Prompt template")}</div>
          <div style="font-size: 10px; color: var(--text-muted); margin-top: 4px;">server: ${c(l.server||"local")}</div>
        </div>
      `}).join("");let n="";if(r&&r.arguments&&r.arguments.length>0)n=r.arguments.map((l)=>`
      <div class="form-group" style="margin-bottom: 12px;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 4px;">
          <label class="form-label" style="margin: 0; font-family: var(--ff-mono);">${c(l.name)}</label>
        ...
        ${l.description?`<div style="font-size: 11px; color: var(--text-dim); margin-bottom: 4px;">${c(l.description)}</div>`:""}
        <input type="text" class="form-input prompt-arg-input" data-arg-name="${c(l.name)}" placeholder="Enter ${c(l.name)}..." />
      </div>
    `).join("");else if(r)n=`
    ...
    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.75); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 24px;">
      <div style="background: var(--surface-card); border: 1px solid var(--border); border-radius: var(--radius-md); width: 840px; max-width: 95vw; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5);">
        ...
        <div style="flex: 1; overflow-y: auto; padding: 20px;">
          ${i.map((o,a)=>{let n=t.map((l)=>`
      <option value="${c(l.id)}" ${l.id===o.capability_id?"selected":""}>
        ${c(l.id)} (${c(l.server||"local")})
      </option>
    `).join("");return`
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 10px;">
          ...
          <div style="display: flex; align-items: flex-end; padding-bottom: 6px;">
            <label style="display: flex; align-items: center; gap: 6px; font-size: 11.5px; color: var(--text-muted); cursor: pointer;">
              <input type="checkbox" ${o.continue_on_error?"checked":""} onchange="window.app.updateBatchStepContinueOnError(${a}, this.checked)" />
  ...
  `}function c(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function F(e){let t=e.approvals.filter((d)=>d.status==="pending"),i=e.approvals.filter((d)=>d.status!=="pending"),r=e.approvals.filter((d)=>d.status==="approved").length,o=e.approvals.filter((d)=>d.status==="rejected").length,a=e.config.policy?.require_approval||e.config.policy?.requireApproval||[],n=t.length===0?`
    ...
    <div class="bento-card" style="border: 1px solid rgba(245, 158, 11, 0.35); background: var(--surface-card); margin-bottom: 14px; padding: 18px;">
      <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
        <div>
          <div style="display: flex; align-items: center; gap: 8px;">
            ...
            <span style="font-family: var(--ff-mono); font-size: 12px; color: var(--text-muted);">${w(d.id)}</span>
          </div>
          <div style="margin-top: 6px; display: flex; align-items: center; gap: 8px;">
            <span style="font-size: 14.5px; font-weight: 700; color: var(--text-main); font-family: var(--ff-mono);">${w(d.capability_id)}</span>
            <span style="font-size: 11px; color: var(--text-dim);">via <span style="color: var(--cyan-400); font-family: var(--ff-mono);">${w(d.server_id)}</span></span>
          </div>
        </div>
      ...
      ${d.context||d.request_id?`
        <div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 8px 12px; font-family: var(--ff-mono); font-size: 11px; display: flex; flex-wrap: wrap; gap: 16px; margin-bottom: 12px; color: var(--text-muted);">
          ${d.request_id?`<div><span style="color: var(--text-dim);">Request:</span> <span style="color: var(--text-main);">${w(d.request_id)}</span></div>`:""}
          ${d.context?.actor_id?`<div><span style="color: var(--text-dim);">Actor:</span> <span style="color: var(--cyan-400);">${w(d.context.actor_id)}</span></div>`:""}
          ${d.context?.operation_id?`<div><span style="color: var(--text-dim);">Operation:</span> <span style="color: var(--text-main);">${w(d.context.operation_id)}</span></div>`:""}
          ${d.context?.work_item_id?`<div><span style="color: var(--text-dim);">Work Item:</span> <span style="color: var(--text-main);">${w(d.context.work_item_id)}</span></div>`:""}
        </div>
      `:""}
      ...
      <div style="margin-bottom: 14px;">
        ...
        <textarea id="appr-args-${d.id}" class="form-textarea" rows="4" style="color: var(--green-400); font-family: var(--ff-mono); font-size: 11.5px; line-height: 1.4;">${w(JSON.stringify(d.sanitized_args,null,2))}</textarea>
      </div>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; border-top: 1px solid var(--border); padding-top: 12px;">
        ...
        <div style="display: flex; align-items: center; gap: 8px;">
          <button class="btn btn-danger" onclick="window.app.promptReject('${w(d.id)}')">
            ✕ Reject
          </button>
          <button class="btn btn-primary" onclick="window.app.submitApproval('${w(d.id)}')">
            ✓ Approve &amp; Execute
          </button>
        </div>
      </div>
  ...
  `:a.map((d)=>`
    <div style="display: flex; justify-content: space-between; align-items: center; background: var(--surface); padding: 8px 10px; border-radius: var(--radius-sm); border: 1px solid var(--border); margin-bottom: 6px;">
      <span style="font-family: var(--ff-mono); font-size: 11.5px; color: var(--amber-300); font-weight: 500;">\uD83D\uDEE1️ ${w(d)}</span>
        ...
        <tbody>
          ${i.map((d)=>`
            <tr style="border-bottom: 1px solid rgba(255,255,255,0.03); transition: background 0.15s;" onmouseover="this.style.background='var(--surface-hover)'" onmouseout="this.style.background='transparent'">
              ...
              <td style="padding: 10px 14px; font-weight: 600; color: var(--text-main);">${w(d.capability_id)}</td>
              <td style="padding: 10px 14px; color: var(--text-dim); font-size: 10.5px;">${w(d.id)}</td>
              <td style="padding: 10px 14px; color: var(--text-muted);">${w(d.operator||"system")}</td>
              <td style="padding: 10px 14px; color: ${d.reason?"var(--red-400)":"var(--text-dim)"};">${d.reason?`"${w(d.reason)}"`:"—"}</td>
  ...
  `}function w(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function B(){let e=s.getState(),t=e.auditEvents||[],i=e.auditStats||{total_events:0,by_status:{success:0,failed:0,denied:0,intercepted:0}},r=e.auditVerification,o=e.auditFilters,a=e.auditTotal??t.length,n=e.auditSelectedEvent,l=Object.keys(e.config?.mcpServers||{}),p=o.limit||25,d=o.offset||0,g=Math.floor(d/p)+1,m=Math.max(1,Math.ceil(a/p)),f=a===0?0:d+1,_=Math.min(d+p,a),h=u.getAuditExportUrl({actor_id:o.search?void 0:void 0,server_id:o.serverId!=="all"?o.serverId:void 0,event_type:o.eventType!=="all"?o.eventType:void 0,status:o.status!=="all"?o.status:void 0,search:o.search.trim()?o.search.trim():void 0},"csv"),k=u.getAuditExportUrl({server_id:o.serverId!=="all"?o.serverId:void 0,event_type:o.eventType!=="all"?o.eventType:void 0,status:o.status!=="all"?o.status:void 0,search:o.search.trim()?o.search.trim():void 0},"jsonl"),$=r?r.is_valid?`
  ...
  `,x=l.map((y)=>`<option value="${b(y)}" ${o.serverId===y?"selected":""}>${b(y)}</option>`).join(""),z=`
  ...
  `,O=`
    <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 16px; background: rgba(18, 24, 38, 0.5); border-radius: var(--radius-md); border: 1px solid var(--border); margin-top: 16px;">
      <div style="font-size: 12px; color: var(--text-dim); display: flex; align-items: center; gap: 8px;">
        <span>Showing <strong style="color: var(--text-main);">${f}–${_}</strong> of <strong style="color: var(--text-main);">${a}</strong> events</span>
  ...
  `,R="";if(t.length===0)R=`
    ...
    `;else R=t.map((y)=>{let L=new Date(Math.floor(y.timestamp_ns/1e6)).toLocaleString(),T='<span class="badge" style="background: rgba(34, 197, 94, 0.15); color: var(--green-400); font-weight: 600;">SUCCESS</span>';if(y.status==="denied")T='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">DENIED</span>';else if(y.status==="intercepted")T='<span class="badge" style="background: rgba(234, 179, 8, 0.15); color: var(--amber-300); font-weight: 600;">HITL INTERCEPT</span>';else if(y.status==="failed")T='<span class="badge" style="background: rgba(239, 68, 68, 0.15); color: var(--red-400); font-weight: 600;">FAILED</span>';else if(y.status==="cancelled")T='<span class="badge" style="background: rgba(148, 163, 184, 0.15); color: var(--text-muted); font-weight: 600;">CANCELLED</span>';let Q=y.sanitized_args?JSON.stringify(y.sanitized_args):"-",W=y.actor_id||y.operator_id||"anonymous",Y=y.server_id||"system",X=y.capability_id||y.event_type,Z=y.execution_latency_us?`${(y.execution_latency_us/1000).toFixed(1)}ms`:"-";return`
        <div class="bento-card" style="margin-bottom: 12px; padding: 16px; border: 1px solid var(--border); transition: border-color 0.15s ease;">
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 8px; font-size: 11.5px; background: rgba(0,0,0,0.2); padding: 8px 12px; border-radius: var(--radius-sm); margin-bottom: 8px;">
            <div><span style="color: var(--text-muted);">Actor:</span> <strong style="color: var(--text-main);">${b(W)}</strong></div>
            <div><span style="color: var(--text-muted);">Server:</span> <strong style="color: var(--cyan-400);">${b(Y)}</strong></div>
    ...
    ${P}
  `}function b(e){if(!e)return"";return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function I(){let t=s.getState().config.policy||{},i=t.allow||[],r=t.deny||[],o=t.redact_keys||t.redactKeys||[],a=t.require_approval||t.requireApproval||[],n=i.length===0?`
  ...
  `}function j(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function K(){let e=s.getState(),t=e.config,i=Object.entries(t.capabilityAliases||{}),r=Object.entries(t.resourceAliases||{}),o=Object.entries(t.promptAliases||{}),a="";if(i.length===0&&r.length===0&&o.length===0)a=`
    ...
    `;else{for(let[n,l]of i)a+=`
        <div class="feed-row" style="grid-template-columns: 90px 180px 1fr 80px;">
          ...
          <span style="color: var(--text-dim); font-family: var(--ff-mono);">${S(l)}</span>
  ...
  "ref_id": "\${steps[0].result.id}"
        ...
        <div class="bento-card" style="display: flex; flex-direction: column; justify-content: space-between; padding: 14px; background: var(--surface); border: 1px solid var(--border); transition: transform 0.15s, border-color 0.15s;">
          <div>
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 6px;">
              ...
              ${a?'<span style="font-size: 10px; color: var(--green-400); font-weight: 600;">CONNECTED</span>':""}
            </div>
            ...
            ${o.envFields.length>0?`
              <div style="font-size: 10.5px; color: var(--amber-400); margin-top: 6px; display: flex; align-items: center; gap: 4px;">
                <span>⚡ Needs:</span>
                <code>${o.envFields.map((l)=>v(l.key)).join(", ")}</code>
              </div>
            `:""}
          </div>
      ...
      `}).join("")}selectTemplate(e){let t=M.find((n)=>n.id===e);if(!t)return;this.selectedTemplate=t,this.closeModals();let i=document.getElementById("modal-configure-template");if(i)i.classList.add("active");let r=document.getElementById("cfg-tmpl-title"),o=document.getElementById("cfg-tmpl-desc"),a=document.getElementById("cfg-tmpl-form");if(r)r.textContent=`Configure ${t.name} Server`;if(o)o.textContent=t.description;if(a){let n="";if(t.envFields.length>0)n=`
          ...
          ${t.envFields.map((l)=>`
            <div class="form-group">
              <label class="form-label">${v(l.label)} ${l.required?'<span style="color: var(--red-400);">*</span>':"(Optional)"}</label>
              <input type="password" class="form-input tmpl-env-input" data-key="${v(l.key)}" placeholder="${v(l.placeholder||"")}">
              ${l.description?`<div style="font-size: 10.5px; color: var(--text-dim); margin-top: 3px;">${v(l.description)}</div>`:""}
            </div>
          `).join("")}
        `;a.innerHTML=`
        <div class="form-group">
      ...
      `}}async submitTemplateServer(){if(!this.selectedTemplate)return;let e=this.selectedTemplate,t=document.getElementById("cfg-srv-id")?.value.trim(),i=document.getElementById("cfg-srv-args")?.value.trim();if(!t){alert("Server identifier is required");return}let r=i?i.split(/\s+/).filter(Boolean):[],o={},a=document.querySelectorAll(".tmpl-env-input");for(let f of Array.from(a)){let _=f.getAttribute("data-key"),h=f.value.trim(),k=e.envFields.find(($)=>$.key===_);if(k?.required&&!h){alert(`Required field '${k.label}' is missing.`);return}if(_&&h)o[_]=h}let n={command:e.command,args:r};if(Object.keys(o).length>0)n.env=o;let l=document.getElementById("cfg-srv-ft")?.value.trim(),p=document.getElementById("cfg-srv-cd")?.value.trim(),d=document.getElementById("cfg-srv-autorestart")?.value,g=document.getElementById("cfg-srv-maxrestarts")?.value.trim();if(l||p||d||g)n.resilience={failureThreshold:l?Number(l):3,cooldownMs:p?Number(p):30000,autoRestart:d!=="false",maxRestarts:g?Number(g):5};let m=await u.upsertServer(t,n);if(m.ok)this.closeModals(),await this.refreshData();else alert(`Failed to save server: ${m.error}`)}async openImportModal(){this.closeModals();let e=document.getElementById("modal-import");if(e)e.classList.add("active");let t=document.getElementById("modal-eco-list");if(!t)return;t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">Scanning IDE configs...</div>';try{let i=await u.getEcosystemSources();if(i.sources&&i.sources.length>0)t.innerHTML=i.sources.map((r)=>`
        ...
        `).join("");else t.innerHTML='<div style="color: var(--text-dim); padding: 12px; text-align: center;">No external MCP configuration files found on this system.</div>'}catch{t.innerHTML='<div style="color: var(--red-400); padding: 12px; text-align: center;">Failed to scan ecosystem sources.</div>'}}async submitImport(){let e=document.querySelectorAll(".eco-checkbox:checked");if(e.length===0){alert("No sources selected");return}for(let t of Array.from(e))await u.importConfig(t.value,!1);this.closeModals(),await this.refreshData()}handleAliasTargetInput(e){let t=document.getElementById("alias-suggestions-dropdown");if(!t)return;let i=(e||"").trim().toLowerCase();if(i.length<2){t.style.display="none";return}let o=s.getState().capabilities.filter((a)=>a.id.toLowerCase().includes(i)||a.summary&&a.summary.toLowerCase().includes(i)||a.description&&a.description.toLowerCase().includes(i)||a.server&&a.server.toLowerCase().includes(i)).slice(0,8);if(o.length===0){t.style.display="none";return}t.innerHTML=o.map((a)=>`
      <div style="padding: 8px 12px; cursor: pointer; border-bottom: 1px solid var(--border-subtle); display: flex; justify-content: space-between; align-items: center; transition: background 0.1s;"
           ...
           onmousedown="window.app.selectAliasSuggestion('${v(a.id)}')">
        <div>
          <div style="font-weight: 700; color: var(--text-main);">${v(a.id)}</div>
          <div style="font-size: 10.5px; color: var(--text-dim); margin-top: 2px;">${v(a.summary||a.description||"")}</div>
        </div>
        <span style="font-size: 10px; color: var(--cyan-400);">${v(a.server||"local")}</span>
      </div>
